...
b||e.splice(c,1))}else this._callbacks[e]&&delete this._callbacks[e];else this._callbacks=null;return this},fire:function(e,a,b,c,d,f,g,h,n){if(!e||!this._callbacks||!this._callbacks[e])return this;var l;this._callbackActive||(this._callbackActive={});this._callbackActive[e]?(this._callbackActive[e]===this._callbacks[e]&&(this._callbackActive[e]=this._callbackActive[e].slice()),l=this._callbacks[e].slice()):this._callbackActive[e]=this._callbacks[e];for(var m=0;(l||this._callbackActive[e])&&m<(l||
...
!1}};pc.extend(pc,function(){var e=function(b){this._index={};this._key=b||null};e.prototype={addItem:function(b){for(var a=b.tags._list,d=0;d<a.length;d++)this.add(a[d],b)},removeItem:function(b){for(var a=b.tags._list,d=0;d<a.length;d++)this.remove(a[d],b)},add:function(b,a){this._index[b]&&-1!==this._index[b].list.indexOf(a)||(this._index[b]||(this._index[b]={list:[]},this._key&&(this._index[b].keys={})),this._index[b].list.push(a),this._key&&(this._index[b].keys[a[this._key]]=a))},remove:function(a,
c){if(this._index[a]&&(!this._key||this._index[a].keys[c[this._key]])){var b=this._index[a].indexOf(c);-1!==b&&(this._index[a].list.splice(b,1),this._key&&delete this._index[a].keys[c[this._key]],0===this._index[a].list.length&&delete this._index[a])}},find:function(a){var b=this,d={},f=[],g,h,e,l,m,k=function(a,d){return b._index[a].list.length-b._index[d].list.length};for(g=0;g<a.length;g++){l=a[g];if(l instanceof Array){if(0===l.length)continue;if(1===l.length)l=l[0];else{e=!1;for(h=0;h<l.length;h++)if(!this._index[l[h]]){e=
!0;break}if(e)continue;l=l.slice(0).sort(k);m=l.slice(1);1===m.length&&(m=m[0]);for(h=0;h<this._index[l[0]].list.length;h++)e=this._index[l[0]].list[h],(this._key?!d[e[this._key]]:-1===f.indexOf(e))&&e.tags.has(m)&&(this._key&&(d[e[this._key]]=!0),f.push(e));continue}}if(l&&"string"===typeof l&&this._index[l])for(h=0;h<this._index[l].list.length;h++)e=this._index[l].list[h],this._key?d[e[this._key]]||(d[e[this._key]]=!0,f.push(e)):-1===f.indexOf(e)&&f.push(e)}return f}};var a=function(a){this._index=
...
9!==b?", ":"";return a+"]"},transpose:function(){var a=this.data,b;b=a[1];a[1]=a[3];a[3]=b;b=a[2];a[2]=a[6];a[6]=b;b=a[5];a[5]=a[7];a[7]=b;return this}};Object.defineProperty(e,"IDENTITY",{get:function(){var a=new e;return function(){return a}}()});Object.defineProperty(e,"ZERO",{get:function(){var a=new e(0,0,0,0,0,0,0,0,0);return function(){return a}}()});return{Mat3:e}}());pc.extend(pc,function(){var e=function(a,b,c,d,f,g,h,e,l,m,k,r,p,q,t,w){a&&16===a.length?this.data=new Float32Array(a):(this.data=new Float32Array(16),"number"===typeof a?(this.data[0]=a,this.data[1]=b,this.data[2]=c,this.data[3]=d,this.data[4]=f,this.data[5]=g,this.data[6]=h,this.data[7]=e,this.data[8]=l,this.data[9]=m,this.data[10]=k,this.data[11]=r,this.data[12]=p,this.data[13]=q,this.data[14]=t,this.data[15]=w):this.setIdentity())};e.prototype={add2:function(a,b){var c=a.data,d=b.data,f=this.data;
...
1===a[10]&&0===a[11]&&0===a[12]&&0===a[13]&&0===a[14]&&1===a[15]},mul2:function(a,b){var c,d,f,g,h,e,l,m,k,r,p,q,t,w,y,x,u,v,A,B;x=a.data;var D=b.data,z=this.data;c=x[0];d=x[1];f=x[2];g=x[3];h=x[4];e=x[5];l=x[6];m=x[7];k=x[8];r=x[9];p=x[10];q=x[11];t=x[12];w=x[13];y=x[14];x=x[15];u=D[0];v=D[1];A=D[2];B=D[3];z[0]=c*u+h*v+k*A+t*B;z[1]=d*u+e*v+r*A+w*B;z[2]=f*u+l*v+p*A+y*B;z[3]=g*u+m*v+q*A+x*B;u=D[4];v=D[5];A=D[6];B=D[7];z[4]=c*u+h*v+k*A+t*B;z[5]=d*u+e*v+r*A+w*B;z[6]=f*u+l*v+p*A+y*B;z[7]=g*u+m*v+q*A+
x*B;u=D[8];v=D[9];A=D[10];B=D[11];z[8]=c*u+h*v+k*A+t*B;z[9]=d*u+e*v+r*A+w*B;z[10]=f*u+l*v+p*A+y*B;z[11]=g*u+m*v+q*A+x*B;u=D[12];v=D[13];A=D[14];B=D[15];z[12]=c*u+h*v+k*A+t*B;z[13]=d*u+e*v+r*A+w*B;z[14]=f*u+l*v+p*A+y*B;z[15]=g*u+m*v+q*A+x*B;return this},mul:function(a){return this.mul2(this,a)},transformPoint:function(a,b){var c=this.data,d=a.data;b=void 0===b?new pc.Vec3:b;return b.set(d[0]*c[0]+d[1]*c[4]+d[2]*c[8]+c[12],d[0]*c[1]+d[1]*c[5]+d[2]*c[9]+c[13],d[0]*c[2]+d[1]*c[6]+d[2]*c[10]+c[14])},transformVector:function(a,
...
f,g){c.sub2(d,f).normalize();b.copy(g).normalize();a.cross(b,c).normalize();b.cross(c,a);f=this.data;f[0]=a.x;f[1]=a.y;f[2]=a.z;f[3]=0;f[4]=b.x;f[5]=b.y;f[6]=b.z;f[7]=0;f[8]=c.x;f[9]=c.y;f[10]=c.z;f[11]=0;f[12]=d.x;f[13]=d.y;f[14]=d.z;f[15]=1;return this}}(),setFrustum:function(a,b,c,d,f,g){var h,e,l,m,k;h=2*f;e=b-a;l=d-c;m=g-f;k=this.data;k[0]=h/e;k[1]=0;k[2]=0;k[3]=0;k[4]=0;k[5]=h/l;k[6]=0;k[7]=0;k[8]=(b+a)/e;k[9]=(d+c)/l;k[10]=(-g-f)/m;k[11]=-1;k[12]=0;k[13]=0;k[14]=-h*g/m;k[15]=0;return this},
setPerspective:function(a,b,c,d,f){f?(a=c*Math.tan(a*Math.PI/360),f=a/b):(f=c*Math.tan(a*Math.PI/360),a=f*b);return this.setFrustum(-a,a,-f,f,c,d)},setOrtho:function(a,b,c,d,f,g){var h=this.data;h[0]=2/(b-a);h[1]=0;h[2]=0;h[3]=0;h[4]=0;h[5]=2/(d-c);h[6]=0;h[7]=0;h[8]=0;h[9]=0;h[10]=-2/(g-f);h[11]=0;h[12]=-(b+a)/(b-a);h[13]=-(d+c)/(d-c);h[14]=-(g+f)/(g-f);h[15]=1;return this},setFromAxisAngle:function(a,b){var c,d,f,g,h,e,l,m,k;b*=pc.math.DEG_TO_RAD;c=a.x;d=a.y;f=a.z;g=Math.cos(b);h=Math.sin(b);e=
1-g;l=e*c;m=e*d;k=this.data;k[0]=l*c+g;k[1]=l*d+h*f;k[2]=l*f-h*d;k[3]=0;k[4]=l*d-h*f;k[5]=m*d+g;k[6]=m*f+h*c;k[7]=0;k[8]=l*f+h*d;k[9]=m*f-c*h;k[10]=e*f*f+g;k[11]=0;k[12]=0;k[13]=0;k[14]=0;k[15]=1;return this},setTranslate:function(a,b,c){var d=this.data;d[0]=1;d[1]=0;d[2]=0;d[3]=0;d[4]=0;d[5]=1;d[6]=0;d[7]=0;d[8]=0;d[9]=0;d[10]=1;d[11]=0;d[12]=a;d[13]=b;d[14]=c;d[15]=1;return this},setScale:function(a,b,c){var d=this.data;d[0]=a;d[1]=0;d[2]=0;d[3]=0;d[4]=0;d[5]=b;d[6]=0;d[7]=0;d[8]=0;d[9]=0;d[10]=
c;d[11]=0;d[12]=0;d[13]=0;d[14]=0;d[15]=1;return this},invert:function(){var a,b,c,d,f,g,h,e,l,m,k,r,p,q,t,w,y,x,u,v,A,B,D,z,E,I,G,H,C,F;F=this.data;a=F[0];b=F[1];c=F[2];d=F[3];f=F[4];g=F[5];h=F[6];e=F[7];l=F[8];m=F[9];k=F[10];r=F[11];p=F[12];q=F[13];t=F[14];w=F[15];y=a*g-b*f;x=a*h-c*f;u=a*e-d*f;v=b*h-c*g;A=b*e-d*g;B=c*e-d*h;D=l*q-m*p;z=l*t-k*p;E=l*w-r*p;I=m*t-k*q;G=m*w-r*q;H=k*w-r*t;C=y*H-x*G+u*I+v*E-A*z+B*D;0===C?this.setIdentity():(C=1/C,F[0]=(g*H-h*G+e*I)*C,F[1]=(-b*H+c*G-d*I)*C,F[2]=(q*B-t*A+
w*v)*C,F[3]=(-m*B+k*A-r*v)*C,F[4]=(-f*H+h*E-e*z)*C,F[5]=(a*H-c*E+d*z)*C,F[6]=(-p*B+t*u-w*x)*C,F[7]=(l*B-k*u+r*x)*C,F[8]=(f*G-g*E+e*D)*C,F[9]=(-a*G+b*E-d*D)*C,F[10]=(p*A-q*u+w*y)*C,F[11]=(-l*A+m*u-r*y)*C,F[12]=(-f*I+g*z-h*D)*C,F[13]=(a*I-b*z+c*D)*C,F[14]=(-p*v+q*x-t*y)*C,F[15]=(l*v-m*x+k*y)*C);return this},set:function(a){var b=this.data;b[0]=a[0];b[1]=a[1];b[2]=a[2];b[3]=a[3];b[4]=a[4];b[5]=a[5];b[6]=a[6];b[7]=a[7];b[8]=a[8];b[9]=a[9];b[10]=a[10];b[11]=a[11];b[12]=a[12];b[13]=a[13];b[14]=a[14];b[15]=
a[15];return this},setIdentity:function(){var a=this.data;a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return this},setTRS:function(a,b,c){var d,f,g,h,e,l,m,k,r,p,q,t,w;d=a.x;f=a.y;a=a.z;g=b.x;h=b.y;e=b.z;l=b.w;b=c.x;m=c.y;c=c.z;k=g+g;r=h+h;p=e+e;q=g*k;t=g*r;g*=p;w=h*r;h*=p;e*=p;k*=l;r*=l;l*=p;p=this.data;p[0]=(1-(w+e))*b;p[1]=(t+l)*b;p[2]=(g-r)*b;p[3]=0;p[4]=(t-l)*m;p[5]=(1-(q+e))*m;p[6]=(h+k)*m;p[7]=0;p[8]=(g+r)*c;p[9]=(h-
k)*c;p[10]=(1-(q+w))*c;p[11]=0;p[12]=d;p[13]=f;p[14]=a;p[15]=1;return this},transpose:function(){var a,b=this.data;a=b[1];b[1]=b[4];b[4]=a;a=b[2];b[2]=b[8];b[8]=a;a=b[3];b[3]=b[12];b[12]=a;a=b[6];b[6]=b[9];b[9]=a;a=b[7];b[7]=b[13];b[13]=a;a=b[11];b[11]=b[14];b[14]=a;return this},invertTo3x3:function(a){var b,c,d,f;b=this.data;a=a.data;var g=b[0],h=b[1],e=b[2],l=b[4],m=b[5],k=b[6],r=b[8],p=b[9],q=b[10];b=q*m-k*p;c=-q*l+k*r;d=p*l-m*r;f=g*b+h*c+e*d;if(0===f)return this;f=1/f;a[0]=f*b;a[1]=f*(-q*h+e*
p);a[2]=f*(k*h-e*m);a[3]=f*c;a[4]=f*(q*g-e*r);a[5]=f*(-k*g+e*l);a[6]=f*d;a[7]=f*(-p*g+h*r);a[8]=f*(m*g-h*l);return this},getTranslation:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[12],this.data[13],this.data[14])},getX:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[0],this.data[1],this.data[2])},getY:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[4],this.data[5],this.data[6])},getZ:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[8],this.data[9],
...
pc.PIXELFORMAT_DXT1?8:16)*f:g+c*d*f*a[this._format],c=Math.max(.5*c,1),d=Math.max(.5*d,1),f=Math.max(.5*f,1);this._cubemap&&(g*=6);return g}});Object.defineProperty(e.prototype,"volume",{get:function(){return this._volume}});Object.defineProperty(e.prototype,"flipY",{get:function(){return this._flipY},set:function(a){this._flipY!==a&&(this._flipY=a,this._needsUpload=!0)}});pc.extend(e.prototype,{destroy:function(){var a=this.device,c=a.textures.indexOf(this);-1!==c&&a.textures.splice(c,1);this._glTextureId&&
...
a.getProgramInfoLog(this.program)),b=!1);a.deleteShader(this.vshader);a.deleteShader(this.fshader);this.attributes=[];this.uniforms=[];this.samplers=[];var f=0,n={};n[a.BOOL]=pc.UNIFORMTYPE_BOOL;n[a.INT]=pc.UNIFORMTYPE_INT;n[a.FLOAT]=pc.UNIFORMTYPE_FLOAT;n[a.FLOAT_VEC2]=pc.UNIFORMTYPE_VEC2;n[a.FLOAT_VEC3]=pc.UNIFORMTYPE_VEC3;n[a.FLOAT_VEC4]=pc.UNIFORMTYPE_VEC4;n[a.INT_VEC2]=pc.UNIFORMTYPE_IVEC2;n[a.INT_VEC3]=pc.UNIFORMTYPE_IVEC3;n[a.INT_VEC4]=pc.UNIFORMTYPE_IVEC4;n[a.BOOL_VEC2]=pc.UNIFORMTYPE_BVEC2;
n[a.BOOL_VEC3]=pc.UNIFORMTYPE_BVEC3;n[a.BOOL_VEC4]=pc.UNIFORMTYPE_BVEC4;n[a.FLOAT_MAT2]=pc.UNIFORMTYPE_MAT2;n[a.FLOAT_MAT3]=pc.UNIFORMTYPE_MAT3;n[a.FLOAT_MAT4]=pc.UNIFORMTYPE_MAT4;n[a.SAMPLER_2D]=pc.UNIFORMTYPE_TEXTURE2D;n[a.SAMPLER_CUBE]=pc.UNIFORMTYPE_TEXTURECUBE;this.device.webgl2&&(n[a.SAMPLER_2D_SHADOW]=pc.UNIFORMTYPE_TEXTURE2D_SHADOW,n[a.SAMPLER_CUBE_SHADOW]=pc.UNIFORMTYPE_TEXTURECUBE_SHADOW,n[a.SAMPLER_3D]=pc.UNIFORMTYPE_TEXTURE3D);for(var l=a.getProgramParameter(this.program,a.ACTIVE_ATTRIBUTES);f<
l;)g=a.getActiveAttrib(this.program,f++),h=a.getAttribLocation(this.program,g.name),void 0===this.definition.attributes[g.name]&&console.error('Vertex shader attribute "'+g.name+'" is not mapped to a semantic in shader definition.'),this.attributes.push(new pc.ShaderInput(this.device,this.definition.attributes[g.name],n[g.type],h));f=0;for(l=a.getProgramParameter(this.program,a.ACTIVE_UNIFORMS);f<l;)g=a.getActiveUniform(this.program,f++),h=a.getUniformLocation(this.program,g.name),g.type===a.SAMPLER_2D||
g.type===a.SAMPLER_CUBE||this.device.webgl2&&(g.type===a.SAMPLER_2D_SHADOW||g.type===a.SAMPLER_CUBE_SHADOW||g.type===a.SAMPLER_3D)?this.samplers.push(new pc.ShaderInput(this.device,g.name,n[g.type],h)):this.uniforms.push(new pc.ShaderInput(this.device,g.name,n[g.type],h));this.ready=!0;return b},destroy:function(){var a=this.device,b=a.shaders.indexOf(this);-1!==b&&a.shaders.splice(b,1);this.program&&(a.gl.deleteProgram(this.program),this.program=null,this.device.removeShaderFromCache(this))}};return{Shader:b}}());pc.extend(pc,function(){var e=function(a){this._device=a;this._cache={};this._generators={};this._isClearingCache=!1};e.prototype.register=function(a,b){this.isRegistered(a)||(this._generators[a]=b)};e.prototype.unregister=function(a){this.isRegistered(a)&&delete this._generators[a]};e.prototype.isRegistered=function(a){return void 0!==this._generators[a]};e.prototype.getProgram=function(a,b){var c=this._generators[a];if(void 0===c)return null;var d=this._device,f=c.generateKey(d,b),g=this._cache[f];
g||(c=c.createShaderDefinition(d,b),g=this._cache[f]=new pc.Shader(d,c));return g};e.prototype.clearCache=function(){var a=this._cache;this._isClearingCache=!0;for(var b in a)a.hasOwnProperty(b)&&a[b].destroy();this._cache={};this._isClearingCache=!1};e.prototype.removeFromCache=function(a){if(!this._isClearingCache){var b=this._cache,c;for(c in b)if(b.hasOwnProperty(c)&&b[c]===a){delete b[c];break}}};return{ProgramLibrary:e}}());pc.extend(pc,function(){function e(a,b){var d=a.createTexture();a.bindTexture(a.TEXTURE_2D,d);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.NEAREST);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MAG_FILTER,a.NEAREST);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE);a.texImage2D(a.TEXTURE_2D,0,a.RGBA,2,2,0,a.RGBA,b,null);var c=a.createFramebuffer();a.bindFramebuffer(a.FRAMEBUFFER,c);a.framebufferTexture2D(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0,
a.TEXTURE_2D,d,0);a.bindTexture(a.TEXTURE_2D,null);if(a.checkFramebufferStatus(a.FRAMEBUFFER)!==a.FRAMEBUFFER_COMPLETE)return a.deleteTexture(d),!1;a.deleteTexture(d);a.bindFramebuffer(a.FRAMEBUFFER,null);return!0}function a(a){var b=new ArrayBuffer(16),d=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,d);a.bufferData(a.ARRAY_BUFFER,b,a.STATIC_DRAW);a.getError();a.vertexAttribPointer(0,4,a.UNSIGNED_BYTE,!1,4,0);b=0===a.getError();a.deleteBuffer(d);return b}var b=function(a,b){var d=a.width,c=a.height;
if(d>b||c>b){var f=b/Math.max(d,c),e=Math.floor(d*f),f=Math.floor(c*f);console.warn("Image dimensions larger than max supported texture size of "+b+". Resizing from "+d+", "+c+" to "+e+", "+f+".");var m=document.createElement("canvas");m.width=e;m.height=f;m.getContext("2d").drawImage(a,0,0,d,c,0,0,e,f);return m}return a},c=function(b,c){var d;this.canvas=b;this.indexBuffer=this.shader=null;this.vertexBuffers=[];this.vbOffsets=[];this._enableAutoInstancing=!1;this.autoInstancingMaxObjects=16384;this.attributesInvalidated=
!0;this.boundBuffer=null;this.instancedAttribs={};this.enabledAttributes={};this.activeFramebuffer=this.transformFeedbackBuffer=null;this.activeTexture=0;this.textureUnits=[];this._maxPixelRatio=1;this.feedback=this.renderTarget=null;this._height=this._width=0;this.updateClientRect();this.shaders=[];this.buffers=[];this.textures=[];this.targets=[];this.contextLost=!1;b.addEventListener("webglcontextlost",function(a){a.preventDefault();this.contextLost=!0;this.fire("devicelost")}.bind(this),!1);b.addEventListener("webglcontextrestored",
function(){this.initializeContext();this.contextLost=!1;this.fire("devicerestored")}.bind(this),!1);var f=c&&void 0!==c.preferWebGl2?c.preferWebGl2:!0,n=f?["webgl2","experimental-webgl2","webgl","experimental-webgl"]:["webgl","experimental-webgl"],l=null;c=c||{};c.stencil=!0;for(d=0;d<n.length;d++){try{l=b.getContext(n[d],c)}catch(m){}if(l){this.webgl2=f&&2>d;break}}if(!l)throw Error("WebGL not supported");this.gl=l;this.initializeExtensions();this.initializeCapabilities();this.initializeRenderState();
(function(){this.defaultClearOptions={color:[0,0,0,1],depth:1,stencil:0,flags:pc.CLEARFLAG_COLOR|pc.CLEARFLAG_DEPTH};this.glAddress=[l.REPEAT,l.CLAMP_TO_EDGE,l.MIRRORED_REPEAT];this.glBlendEquation=[l.FUNC_ADD,l.FUNC_SUBTRACT,l.FUNC_REVERSE_SUBTRACT,this.webgl2?l.MIN:this.extBlendMinmax?this.extBlendMinmax.MIN_EXT:l.FUNC_ADD,this.webgl2?l.MAX:this.extBlendMinmax?this.extBlendMinmax.MAX_EXT:l.FUNC_ADD];this.glBlendFunction=[l.ZERO,l.ONE,l.SRC_COLOR,l.ONE_MINUS_SRC_COLOR,l.DST_COLOR,l.ONE_MINUS_DST_COLOR,
l.SRC_ALPHA,l.SRC_ALPHA_SATURATE,l.ONE_MINUS_SRC_ALPHA,l.DST_ALPHA,l.ONE_MINUS_DST_ALPHA];this.glComparison=[l.NEVER,l.LESS,l.EQUAL,l.LEQUAL,l.GREATER,l.NOTEQUAL,l.GEQUAL,l.ALWAYS];this.glStencilOp=[l.KEEP,l.ZERO,l.REPLACE,l.INCR,l.INCR_WRAP,l.DECR,l.DECR_WRAP,l.INVERT];this.glClearFlag=[0,l.COLOR_BUFFER_BIT,l.DEPTH_BUFFER_BIT,l.COLOR_BUFFER_BIT|l.DEPTH_BUFFER_BIT,l.STENCIL_BUFFER_BIT,l.STENCIL_BUFFER_BIT|l.COLOR_BUFFER_BIT,l.STENCIL_BUFFER_BIT|l.DEPTH_BUFFER_BIT,l.STENCIL_BUFFER_BIT|l.COLOR_BUFFER_BIT|
l.DEPTH_BUFFER_BIT];this.glCull=[0,l.BACK,l.FRONT,l.FRONT_AND_BACK];this.glFilter=[l.NEAREST,l.LINEAR,l.NEAREST_MIPMAP_NEAREST,l.NEAREST_MIPMAP_LINEAR,l.LINEAR_MIPMAP_NEAREST,l.LINEAR_MIPMAP_LINEAR];this.glPrimitive=[l.POINTS,l.LINES,l.LINE_LOOP,l.LINE_STRIP,l.TRIANGLES,l.TRIANGLE_STRIP,l.TRIANGLE_FAN];this.glType=[l.BYTE,l.UNSIGNED_BYTE,l.SHORT,l.UNSIGNED_SHORT,l.INT,l.UNSIGNED_INT,l.FLOAT];var b,c,f,g,h;this.commitFunction=[];this.commitFunction[pc.UNIFORMTYPE_BOOL]=function(a,b){a.value!==b&&(l.uniform1i(a.locationId,
b),a.value=b)};this.commitFunction[pc.UNIFORMTYPE_INT]=this.commitFunction[pc.UNIFORMTYPE_BOOL];this.commitFunction[pc.UNIFORMTYPE_FLOAT]=function(a,b){a.value!==b&&(l.uniform1f(a.locationId,b),a.value=b)};this.commitFunction[pc.UNIFORMTYPE_VEC2]=function(a,d){h=a.value;b=d[0];c=d[1];if(h[0]!==b||h[1]!==c)l.uniform2fv(a.locationId,d),h[0]=b,h[1]=c};this.commitFunction[pc.UNIFORMTYPE_VEC3]=function(a,d){h=a.value;b=d[0];c=d[1];f=d[2];if(h[0]!==b||h[1]!==c||h[2]!==f)l.uniform3fv(a.locationId,d),h[0]=
b,h[1]=c,h[2]=f};this.commitFunction[pc.UNIFORMTYPE_VEC4]=function(a,d){h=a.value;b=d[0];c=d[1];f=d[2];g=d[3];if(h[0]!==b||h[1]!==c||h[2]!==f||h[3]!==g)l.uniform4fv(a.locationId,d),h[0]=b,h[1]=c,h[2]=f,h[3]=g};this.commitFunction[pc.UNIFORMTYPE_IVEC2]=function(a,d){h=a.value;b=d[0];c=d[1];if(h[0]!==b||h[1]!==c)l.uniform2iv(a.locationId,d),h[0]=b,h[1]=c};this.commitFunction[pc.UNIFORMTYPE_BVEC2]=this.commitFunction[pc.UNIFORMTYPE_IVEC2];this.commitFunction[pc.UNIFORMTYPE_IVEC3]=function(a,d){h=a.value;
...
this.webgl2?this.extColorBufferFloat:e(l,l.FLOAT));this.extTextureHalfFloat&&(this.extTextureHalfFloatRenderable=this.webgl2?this.extColorBufferFloat:e(l,this.extTextureHalfFloat.HALF_FLOAT_OES));if(this.extTextureFloatRenderable){n=pc.shaderChunks;var w=n.createShaderFromCode(this,n.fullscreenQuadVS,n.precisionTestPS,"ptest1"),y=n.createShaderFromCode(this,n.fullscreenQuadVS,n.precisionTest2PS,"ptest2");n=new pc.Texture(this,{format:pc.PIXELFORMAT_RGBA32F,width:1,height:1,mipmaps:!1,minFilter:pc.FILTER_NEAREST,
magFilter:pc.FILTER_NEAREST});var x=new pc.RenderTarget(this,n,{depth:!1});pc.drawQuadWithShader(this,x,w);var w=new pc.Texture(this,{format:pc.PIXELFORMAT_R8_G8_B8_A8,width:1,height:1,mipmaps:!1,minFilter:pc.FILTER_NEAREST,magFilter:pc.FILTER_NEAREST}),u=new pc.RenderTarget(this,w,{depth:!1});this.constantTexSource.setValue(n);pc.drawQuadWithShader(this,u,y);y=new Uint8Array(4);l.bindFramebuffer(l.FRAMEBUFFER,u._glFrameBuffer);l.readPixels(0,0,1,1,l.RGBA,l.UNSIGNED_BYTE,y);this.extTextureFloatHighPrecision=
0===y[0]/255/16777216+y[1]/255/65536+y[2]/255/256+y[3]/255;n.destroy();x.destroy();w.destroy();u.destroy();pc.destroyPostEffectQuad();l.bindFramebuffer(l.FRAMEBUFFER,null)}pc.extTextureFloatRenderable=this.extTextureFloatRenderable;pc.extTextureHalfFloatRenderable=this.extTextureHalfFloatRenderable;pc.extTextureFloatHighPrecision=this.extTextureFloatHighPrecision;pc._benchmarked=!0}}).call(this)};c.prototype={getPrecision:function(){var a=this.gl,b="highp";if(a.getShaderPrecisionFormat){var c=a.getShaderPrecisionFormat(a.VERTEX_SHADER,
a.HIGH_FLOAT),h=a.getShaderPrecisionFormat(a.VERTEX_SHADER,a.MEDIUM_FLOAT),e=a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,a.HIGH_FLOAT),a=a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,a.MEDIUM_FLOAT),h=0<h.precision&&0<a.precision;0<c.precision&&0<e.precision||(b=h?"mediump":"lowp")}return b},initializeExtensions:function(){var a=this.gl;this.webgl2?this.extUintElement=this.extTextureLod=this.extTextureHalfFloatLinear=this.extTextureHalfFloat=this.extTextureFloat=this.extStandardDerivatives=this.extInstancing=
this.extDrawBuffers=this.extBlendMinmax=!0:(this.extBlendMinmax=a.getExtension("EXT_blend_minmax"),this.extDrawBuffers=a.getExtension("EXT_draw_buffers"),this.extInstancing=a.getExtension("ANGLE_instanced_arrays"),this.extStandardDerivatives=a.getExtension("OES_standard_derivatives"),this.extTextureFloat=a.getExtension("OES_texture_float"),this.extTextureHalfFloat=a.getExtension("OES_texture_half_float"),this.extTextureHalfFloatLinear=a.getExtension("OES_texture_half_float_linear"),this.extTextureLod=
...
a._needsMipmapsUpload=!1},draw:function(a,b){var c=this.gl,d,f,e,m,k,r,p,q;d=this.shader;q=d.samplers;var t=d.uniforms;1<b&&(this.boundBuffer=null,this.attributesInvalidated=!0);if(this.attributesInvalidated){k=d.attributes;d=0;for(e=k.length;d<e;d++)r=k[d],f=r.scopeId.value,null!==f&&(p=this.vertexBuffers[f.stream],m=this.vbOffsets[f.stream]||0,p=p.bufferId,this.boundBuffer!==p&&(c.bindBuffer(c.ARRAY_BUFFER,p),this.boundBuffer=p),r=r.locationId,this.enabledAttributes[r]||(c.enableVertexAttribArray(r),
...
d);return new pc.Shader(a,{attributes:b,vshader:c,fshader:d,useTransformFeedback:f})};e.createShaderFromCode=function(a,c,d,f,g){var b=a.programLib._cache,e=b[f];if(void 0!==e)return e;d=pc.programlib.precisionCode(a)+"\n"+(d||pc.programlib.dummyFragmentCode());e=this.collectAttribs(c);a.webgl2&&(c=pc.programlib.versionCode(a)+this.gles3VS+c,d=pc.programlib.versionCode(a)+this.gles3PS+d);b[f]=new pc.Shader(a,{attributes:e,vshader:c,fshader:d,useTransformFeedback:g});return b[f]};return{shaderChunks:e}}());pc.extend(pc,function(){var e=null,a={type:pc.PRIMITIVE_TRISTRIP,base:0,count:4,indexed:!1};return{drawQuadWithShader:function(b,c,d,f,g,h){if(null===e){var n=new pc.VertexFormat(b,[{semantic:pc.SEMANTIC_POSITION,components:2,type:pc.TYPE_FLOAT32}]);e=new pc.VertexBuffer(b,n,4);n=new pc.VertexIterator(e);n.element[pc.SEMANTIC_POSITION].set(-1,-1);n.next();n.element[pc.SEMANTIC_POSITION].set(1,-1);n.next();n.element[pc.SEMANTIC_POSITION].set(-1,1);n.next();n.element[pc.SEMANTIC_POSITION].set(1,1);
n.end()}n=b.renderTarget;b.setRenderTarget(c);b.updateBegin();var l,m,k,r,p;f?(c=f.x,l=f.y,m=f.z,f=f.w):(m=c?c.width:b.width,f=c?c.height:b.height,l=c=0);g?(k=g.x,r=g.y,p=g.z,g=g.w):(k=c,r=l,p=m,g=f);b.setViewport(c,l,m,f);b.setScissor(k,r,p,g);g=b.getDepthTest();m=b.getDepthWrite();c=b.getCullMode();b.setDepthTest(!1);b.setDepthWrite(!1);b.setCullMode(pc.CULLFACE_NONE);h||b.setBlending(!1);b.setVertexBuffer(e,0);b.setShader(d);b.draw(a);b.setDepthTest(g);b.setDepthWrite(m);b.setCullMode(c);b.updateEnd();
b.setRenderTarget(n);b.updateBegin()},destroyPostEffectQuad:function(){e=null}}}());pc.extend(pc,function(){function e(a,c,d){var b=c._colorBuffer;if(b.format==pc.PIXELFORMAT_R8_G8_B8_A8){var g=new Uint8Array(b.width*b.height*4),h=a.gl;a.setFramebuffer(c._glFrameBuffer);h.readPixels(0,0,b.width,b.height,h.RGBA,h.UNSIGNED_BYTE,g);b._levels||(b._levels=[]);b._levels[0]||(b._levels[0]=[]);b._levels[0][d]=g}}function a(a,c){return Math.atan2(a*c,Math.sqrt(a*a+c*c+1))}return{prefilterCubemap:function(a){var b=a.device,d=a.sourceCubemap,f=a.method,g=a.samples,h=a.cpuSync;if(h&&!d._levels[0])console.error("ERROR: prefilter: cubemap must have _levels");
else{var n=pc.shaderChunks,l=d.rgbm,g=n.createShaderFromCode(b,n.fullscreenQuadVS,n.rgbmPS+n.prefilterCubemapPS.replace(/\$METHOD/g,0===f?"cos":"phong").replace(/\$NUMSAMPLES/g,g).replace(/\$textureCube/g,l?"textureCubeRGBM":"textureCube"),"prefilter"+f+""+g+""+l),m=n.createShaderFromCode(b,n.fullscreenQuadVS,n.outputCubemapPS,"outputCubemap"),k=b.scope.resolve("source"),r=b.scope.resolve("params"),p=new pc.Vec4,q=d.width,n=d.format,t=[[],a.filteredFixed,a.filteredRgbm,a.filteredFixedRgbm],w=0===
f?[.9,.85,.7,.4,.25]:[512,128,32,8,2],y=[64,32,16,8,4],x,u,v;u=n===pc.PIXELFORMAT_R8_G8_B8;x=!1;var A;h&&(x=d._levels[0][0]instanceof HTMLImageElement);if((u||x)&&h){n=pc.PIXELFORMAT_R8_G8_B8_A8;A=new pc.gfx.Texture(b,{cubemap:!0,rgbm:l,format:n,width:q,height:q,mipmaps:!1});for(v=0;6>v;v++)x=new pc.RenderTarget(b,A,{face:v,depth:!1}),p.x=v,p.y=0,k.setValue(d),r.setValue(p.data),pc.drawQuadWithShader(b,x,m),e(b,x,v);d=A}if(128<q){var B=Math.round(Math.log2(q))-Math.round(Math.log2(128));for(u=0;u<
B;u++){var q=.5*d.width,D=0===f?1:Math.pow(2,Math.round(Math.log2(w[0])+2*(B-u)));A=new pc.gfx.Texture(b,{cubemap:!0,rgbm:l,format:n,width:q,height:q,mipmaps:!1});for(v=0;6>v;v++)x=new pc.RenderTarget(b,A,{face:v,depth:!1}),p.x=v,p.y=D,p.z=q,p.w=l?3:0,k.setValue(d),r.setValue(p.data),pc.drawQuadWithShader(b,x,m),u===B-1&&h&&e(b,x,v);d=A}}a.sourceCubemap=d;A=null;if(!l&&a.filteredFixedRgbm)for(A=new pc.gfx.Texture(b,{cubemap:!0,rgbm:!0,format:pc.PIXELFORMAT_R8_G8_B8_A8,width:q,height:q,mipmaps:!1}),
v=0;6>v;v++)x=new pc.RenderTarget(b,A,{face:v,depth:!1}),p.x=v,p.w=2,k.setValue(d),r.setValue(p.data),pc.drawQuadWithShader(b,x,m),e(b,x,v);q=0===f?1:2048;x=0===f?0:-1;t[x]=[];for(u=0;5>u;u++)for(m=x;m<t.length;m++)null!=t[m]&&(t[m][u]=new pc.gfx.Texture(b,{cubemap:!0,rgbm:2>m?l:!0,format:2>m?n:pc.PIXELFORMAT_R8_G8_B8_A8,fixCubemapSeams:1===m||3===m,width:y[u],height:y[u],mipmaps:!1}));for(m=x;m<t.length;m++)if(null!=t[m])if(1<m&&l)t[m]=t[m-2];else for(u=0;5>u;u++)for(v=0;6>v;v++)x=new pc.RenderTarget(b,
t[m][u],{face:v,depth:!1}),p.x=v,p.y=0>m?q:w[u],p.z=y[u],p.w=l?3:m,k.setValue(0===u?d:0===f?t[0][u-1]:t[-1][u-1]),r.setValue(p.data),pc.drawQuadWithShader(b,x,g),h&&e(b,x,v);a.filtered=t[0];if(h&&a.singleFilteredFixed){d=[d,a.filteredFixed[0],a.filteredFixed[1],a.filteredFixed[2],a.filteredFixed[3],a.filteredFixed[4],a.filteredFixed[5]];l=new pc.gfx.Texture(b,{cubemap:!0,rgbm:l,fixCubemapSeams:!0,format:n,width:128,height:128,addressU:pc.ADDRESS_CLAMP_TO_EDGE,addressV:pc.ADDRESS_CLAMP_TO_EDGE});for(u=
0;6>u;u++)l._levels[u]=d[u]._levels[0];l.upload();l._prefilteredMips=!0;a.singleFilteredFixed=l}if(h&&a.singleFilteredFixedRgbm&&a.filteredFixedRgbm){d=[A,a.filteredFixedRgbm[0],a.filteredFixedRgbm[1],a.filteredFixedRgbm[2],a.filteredFixedRgbm[3],a.filteredFixedRgbm[4],a.filteredFixedRgbm[5]];l=new pc.gfx.Texture(b,{cubemap:!0,rgbm:!0,fixCubemapSeams:!0,format:pc.PIXELFORMAT_R8_G8_B8_A8,width:128,height:128,addressU:pc.ADDRESS_CLAMP_TO_EDGE,addressV:pc.ADDRESS_CLAMP_TO_EDGE});for(u=0;6>u;u++)l._levels[u]=
...
return}e=[];for(h=0;h<f;h++)for(g=0;g<f;g++)e[h*f+g]=(new pc.Vec3(g/(f-1)*2-1,h/(f-1)*2-1,1)).normalize();var l=new Float32Array(27),p,q,t,w,y,x,u,v,A,B,D;for(d=m=0;6>d;d++)for(h=0;h<f;h++)for(g=0;g<f;g++){k=h*f+g;r=g;u=h;v=f;q=(2*(r+.5)/v-1)*(1-1/v);D=(2*(u+.5)/v-1)*(1-1/v);p=1/v;A=q-p;B=D-p;q+=p;D+=p;A=a(A,B)-a(A,D)-a(q,B)+a(q,D);if(0===r&&0===u||r===v-1&&0===u||0===r&&u===v-1||r===v-1&&u===v-1)A/=3;else if(0===r||0===u||r===v-1||u===v-1)A*=.5;r=A;u=4*r/17;v=8*r/17;A=15*r/17;B=5*r/68;D=15*r/68;
p=e[k];0==d?(w=p.z,y=-p.y,x=-p.x):1==d?(w=-p.z,y=-p.y,x=p.x):2==d?(w=p.x,y=p.z,x=p.y):3==d?(w=p.x,y=-p.z,x=-p.y):4==d?(w=p.x,y=-p.y,x=p.z):5==d&&(w=-p.x,y=-p.y,x=-p.z);c||(w=-w);q=b._levels[0][d][4*k+3]/255;for(p=0;3>p;p++)t=b._levels[0][d][4*k+p]/255,b.rgbm?(t*=8*q,t*=t):t=Math.pow(t,2.2),l[0+p]+=t*u,l[3+p]+=t*v*w,l[6+p]+=t*v*y,l[9+p]+=t*v*x,l[12+p]+=t*A*w*x,l[15+p]+=t*A*x*y,l[18+p]+=t*A*y*w,l[21+p]+=t*B*(3*x*x-1),l[24+p]+=t*D*(w*w-y*y),m+=r}for(p=0;p<l.length;p++)l[p]*=4*Math.PI/m;return l}console.error("ERROR: SH: cubemap must be synced to CPU")}}}}());pc.extend(pc,function(){return{paraboloidFromCubemap:function(e,a,b,c){var d=pc.shaderChunks,d=d.createShaderFromCode(e,d.fullscreenQuadVS,(a.fixCubemapSeams?d.fixCubemapSeamsStretchPS:d.fixCubemapSeamsNonePS)+d.genParaboloidPS,"genParaboloid"),f=e.scope.resolve("source"),g=e.scope.resolve("params"),h=new pc.Vec4,n=a.width,l=a.rgbm,m=a.format,n=2*Math.max(n,8),n=new pc.gfx.Texture(e,{rgbm:l,format:m,width:2*n,height:n,mipmaps:!1}),l=new pc.RenderTarget(e,n,{depth:!1});h.x=b;h.y=c?-1:1;f.setValue(a);
g.setValue(h.data);pc.drawQuadWithShader(e,l,d);return n},generateDpAtlas:function(e,a,b){var c,d;d=new pc.Vec4;for(var f=new pc.Vec4,g=4*a[0].width,h=pc.shaderChunks,h=h.createShaderFromCode(e,h.fullscreenQuadVS,h.dpAtlasQuadPS,"dpAtlasQuad"),n=e.scope.resolve("source"),l=e.scope.resolve("params"),m=new pc.gfx.Texture(e,{rgbm:a[0].rgbm,format:a[0].format,width:g,height:g,mipmaps:!1}),k=new pc.RenderTarget(e,m,{depth:!1}),r=(g+2)/g-1,p=0;6>p;p++){c=pc.paraboloidFromCubemap(e,a[p],p,b);n.setValue(c);
c=d;var q=p;c.x=.5*pc.math.clamp(q-2,0,1);var q=q-6*c.x,t=1-c.x;c.y=Math.min(.5*q,.75)*t+c.x;c.z=(1-.5*pc.math.clamp(q,0,1))*t;c.w=.5*c.z;c=1/c.z;f.x=c*r;f.y=2*f.x;f.x+=1;f.y+=1;l.setValue(f.data);d.x*=g;d.y*=g;d.z*=g;d.w*=g;pc.drawQuadWithShader(e,k,h,d)}return m}}}());pc.shaderChunks.TBNPS="void getTBN() {\n    dTBN = mat3(normalize(dTangentW), normalize(dBinormalW), normalize(dVertexNormalW));\n}\n";pc.shaderChunks.TBNfastPS="void getTBN() {\n    dTBN = mat3(dTangentW, dBinormalW, dVertexNormalW);\n}\n";pc.shaderChunks.alphaTestPS="uniform float alpha_ref;\nvoid alphaTest(float a) {\n    if (a < alpha_ref) discard;\n}\n";pc.shaderChunks.ambientConstantPS="\nvoid addAmbient() {\n    dDiffuseLight += light_globalAmbient;\n}\n";
...
!1):a.fresnelModel=0===a.fresnelModel?pc.FRESNEL_SCHLICK:a.fresnelModel;var f=(a.cubeMap||a.prefilteredCubemap&&a.useSpecular)&&!a.sphereMap&&!a.dpAtlas,g=a.sphereMap||f||a.dpAtlas,h=pc.precalculatedTangents,n=a.useTexCubeLod;a.cubeMap&&(a.sphereMap=null);a.dpAtlas&&(a.prefilteredCubemap=null);a.useSpecular||(a.specularMap=a.glossMap=null);var l=d||g||a.ambientSH||a.prefilteredCubemap||a.heightMap,m=a.pass>=pc.SHADER_SHADOW&&17>=a.pass;this.options=a;var k="",r="",p="",q=pc.shaderChunks,t,w={vertex_position:pc.SEMANTIC_POSITION};
...
y+"_directionVS;\n"):r+("   getLightDirPoint(light"+y+"_positionVS);\n"),r+=this._nonPointShadowMapProjection(e,a.lights[y],"(light"+y+"_shadowMatrixVS, light"+y+"_shadowParamsVS);\n")));t=[];var x=[],u,v,A;for(c in pc._matTex2D)b=c+"Map",a[c+"VertexColor"]&&(u=c+"VertexColorChannel",a[u]=this._correctChannel(c,a[u])),a[b]&&(u=b+"Channel",v=b+"Transform",A=b+"Uv",a[A]=Math.min(a[A],1),a[u]=this._correctChannel(c,a[u]),A=a[A],t[A]=!0,x[A]=x[A]||a[b]&&!a[v]);a.forceUv1&&(t[1]=!0);for(b=0;2>b;b++)t[b]&&
(w["vertex_texCoord"+b]=pc["SEMANTIC_TEXCOORD"+b],k+=q["uv"+b+"VS"],r+="   vec2 uv"+b+" = getUv"+b+"();\n"),x[b]&&(r+="   vUv"+b+" = uv"+b+";\n");t=[k,p,r,[]];for(c in pc._matTex2D)b=c+"Map",a[b]&&(v=b+"Transform",a[v]&&(A=b+"Uv",this._setMapTransform(t,c,a[v],a[A])));k=t[0];p=t[1];r=t[2];a.vertexColors&&(w.vertex_color=pc.SEMANTIC_COLOR,r+="   vVertexColor = vertex_color;\n");a.skin?(w.vertex_boneWeights=pc.SEMANTIC_BLENDWEIGHT,w.vertex_boneIndices=pc.SEMANTIC_BLENDINDICES,k+=pc.programlib.skinCode(e,
...
q.aoSpecOccSimplePS:q.aoSpecOccConstSimplePS):k+(a.occludeSpecularFloat?q.aoSpecOccPS:q.aoSpecOccConstPS));b=a.rgbmReflection?"decodeRGBM":a.hdrReflection?"":"gammaCorrectInput";a.sphereMap?(b=16<e.fragmentUniformsCount?q.reflectionSpherePS:q.reflectionSphereLowPS,b=b.replace(/\$texture2DSAMPLE/g,a.rgbmReflection?"texture2DRGBM":a.hdrReflection?"texture2D":"texture2DSRGB"),k+=b):f?k=a.prefilteredCubemap?n?k+q.reflectionPrefilteredCubeLodPS.replace(/\$DECODE/g,b):k+q.reflectionPrefilteredCubePS.replace(/\$DECODE/g,
b):k+q.reflectionCubePS.replace(/\$textureCubeSAMPLE/g,a.rgbmReflection?"textureCubeRGBM":a.hdrReflection?"textureCube":"textureCubeSRGB"):a.dpAtlas&&(k+=q.reflectionDpAtlasPS.replace(/\$texture2DSAMPLE/g,a.rgbmReflection?"texture2DRGBM":a.hdrReflection?"texture2D":"texture2DSRGB"));(f||a.sphereMap||a.dpAtlas)&&a.refraction&&(k+=q.refractionPS);0<r&&(x[pc.SHADOW_PCF3]&&(k+=q.shadowStandardPS),x[pc.SHADOW_PCF5]&&(k+=q.shadowStandardGL2PS),v&&(k+=q.shadowVSM_commonPS,x[pc.SHADOW_VSM8]&&(k+=q.shadowVSM8PS),
x[pc.SHADOW_VSM16]&&(k+=e.extTextureHalfFloatLinear?q.shadowEVSMPS.replace(/\$/g,"16"):q.shadowEVSMnPS.replace(/\$/g,"16")),x[pc.SHADOW_VSM32]&&(k+=e.extTextureFloatLinear?q.shadowEVSMPS.replace(/\$/g,"32"):q.shadowEVSMnPS.replace(/\$/g,"32"))),e.webgl2||e.extStandardDerivatives||(k+=q.biasConstPS),k+=q.shadowCoordPS+q.shadowCommonPS,A&&(k+=q.shadowCoordPerspZbufferPS),0<=y&&(x[pc.SHADOW_PCF3]&&(k+=q.shadowStandardVSPS),x[pc.SHADOW_PCF5]&&(k+=q.shadowStandardGL2VSPS),v&&(x[pc.SHADOW_VSM8]&&(k+=q.shadowVSMVSPS.replace(/\$VSM/g,
"VSM8").replace(/\$/g,"8")),x[pc.SHADOW_VSM16]&&(k+=q.shadowVSMVSPS.replace(/\$VSM/g,"VSM16").replace(/\$/g,"16")),x[pc.SHADOW_VSM32]&&(k+=q.shadowVSMVSPS.replace(/\$VSM/g,"VSM32").replace(/\$/g,"32")))));d&&(k+=q.lightDiffuseLambertPS);b=!1;a.useSpecular?(d&&(k+=a.shadingModel===pc.SPECULAR_PHONG?q.lightSpecularPhongPS:q.lightSpecularBlinnPS),a.sphereMap||f||a.dpAtlas||0<a.fresnelModel?k=0<a.fresnelModel?a.conserveEnergy?k+q.combineDiffuseSpecularPS:k+q.combineDiffuseSpecularNoConservePS:k+q.combineDiffuseSpecularOldPS:
a.diffuseMap?k+=q.combineDiffuseSpecularNoReflPS:(k+=q.combineDiffuseSpecularNoReflSeparateAmbientPS,b=!0)):k+=q.combineDiffusePS;m=!0;if(a.lightMap||a.lightVertexColor)k+=this._addMap("light",a,q,t,a.dirLightMap?q.lightmapDirPS:q.lightmapSinglePS,a.lightMapFormat),m=a.lightMapWithoutAmbient;m&&(t=a.rgbmAmbient?"decodeRGBM":a.hdrAmbient?"":"gammaCorrectInput",k=a.ambientSH?k+q.ambientSHPS:a.prefilteredCubemap?n?k+q.ambientPrefilteredCubeLodPS.replace(/\$DECODE/g,t):k+q.ambientPrefilteredCubePS.replace(/\$DECODE/g,
t):k+q.ambientConstantPS);a.ambientTint&&!b&&(k+="uniform vec3 material_ambient;\n");a.alphaTest&&(k+=q.alphaTestPS);a.msdf&&(k+=q.msdfPS);l&&(k+=q.viewDirPS,a.useSpecular&&(k+=q.reflDirPS));A=v=x=r=n=!1;k+=q.startPS;l&&(k=a.twoSidedLighting?k+"   dVertexNormalW = gl_FrontFacing ? vNormalW : -vNormalW;\n":k+"   dVertexNormalW = vNormalW;\n",a.heightMap||a.normalMap)&&(a.twoSidedLighting?(k+="   dTangentW = gl_FrontFacing ? vTangentW : -vTangentW;\n",k+="   dBinormalW = gl_FrontFacing ? vBinormalW : -vBinormalW;\n"):
...
a.data[4]=b.data[5];a.data[5]=b.data[6];a.data[6]=b.data[8];a.data[7]=b.data[9];a.data[8]=b.data[10]}for(var n=(new pc.Mat4).mul2((new pc.Mat4).setTranslate(.5,.5,.5),(new pc.Mat4).setScale(.5,.5,.5)),l={r:1,g:2,b:3,a:4},m=[(new pc.Quat).setFromEulerAngles(0,90,180),(new pc.Quat).setFromEulerAngles(0,-90,180),(new pc.Quat).setFromEulerAngles(90,0,0),(new pc.Quat).setFromEulerAngles(-90,0,0),(new pc.Quat).setFromEulerAngles(0,180,180),(new pc.Quat).setFromEulerAngles(0,0,180)],k=[{},{},{},{},{}],r=
new pc.Vec2,p={x:1,y:1,z:0,w:0},q=new pc.Mat4,t=new pc.Mat4,w=new pc.Mat4,y=new pc.Mat4,x=new pc.Mat4,u=new pc.Mat3,v=new pc.Mat4,A,B=new pc.Mat4,D=new pc.Mat4,z=new pc.Mat4,E=new pc.Mat4,I=new pc.Vec3,G=new pc.Vec3,H,C,F=new pc.Mat4,J=new pc.Mat4,Y=new pc.Mat4,X=new pc.Mat4,V=new pc.Vec3,Q={center:null,radius:0},L,Z=new pc.BoundingBox,S=[0,0],R,aa,K,T,N={},P,ba,O=[],U=0;8>U;U++)O.push(new pc.Vec3);var M=[new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3];
...
c.renderTarget,d.width===b._shadowResolution&&d.height===b._shadowResolution||f(a,b);return c},updateCameraFrustum:function(a){if(a.vrDisplay&&a.vrDisplay.presenting){A=a.vrDisplay.combinedProj;var b=a._node.getParent();b?x.copy(b.getWorldTransform()).mul(a.vrDisplay.combinedViewInv).invert():x.copy(a.vrDisplay.combinedView);y.copy(x).invert();this.viewInvId.setValue(y.data)}else{A=a.getProjectionMatrix();a.overrideCalculateProjection&&a.calculateProjection(A,pc.VIEW_CENTER);if(a.overrideCalculateTransform)a.calculateTransform(y,
pc.VIEW_CENTER);else{var b=a._node.getPosition(),c=a._node.getRotation();y.setTRS(b,c,pc.Vec3.ONE);this.viewInvId.setValue(y.data)}x.copy(y).invert()}a.frustum.update(A,x)},setCamera:function(a,b,c,d){var f=a.vrDisplay;if(f&&f.presenting){H=f.leftProj;C=f.rightProj;A=f.combinedProj;a.overrideCalculateProjection&&(a.calculateProjection(H,pc.VIEW_LEFT),a.calculateProjection(C,pc.VIEW_RIGHT),a.calculateProjection(A,pc.VIEW_CENTER));if(a.overrideCalculateTransform)a.calculateTransform(B,pc.VIEW_LEFT),
a.calculateTransform(D,pc.VIEW_RIGHT),a.calculateTransform(y,pc.VIEW_CENTER),z.copy(B).invert(),E.copy(D).invert(),x.copy(y).invert();else{var g=a._node.getParent();if(g){var e=g.getWorldTransform();B.mul2(e,f.leftViewInv);D.mul2(e,f.rightViewInv);z.copy(B).invert();E.copy(D).invert();x.copy(g.getWorldTransform()).mul(f.combinedViewInv).invert()}else B.copy(f.leftViewInv),D.copy(f.rightViewInv),z.copy(f.leftView),E.copy(f.rightView),x.copy(f.combinedView)}h(F,z);h(J,E);Y.mul2(H,z);X.mul2(C,E);I.data[0]=
B.data[12];I.data[1]=B.data[13];I.data[2]=B.data[14];G.data[0]=D.data[12];G.data[1]=D.data[13];G.data[2]=D.data[14]}else A=a.getProjectionMatrix(),a.overrideCalculateProjection&&a.calculateProjection(A,pc.VIEW_CENTER),this.projId.setValue(A.data),a.overrideCalculateTransform?a.calculateTransform(y,pc.VIEW_CENTER):(f=a._node.getPosition(),g=a._node.getRotation(),y.setTRS(f,g,pc.Vec3.ONE)),this.viewInvId.setValue(y.data),x.copy(y).invert(),this.viewId.setValue(x.data),h(u,x),this.viewId3.setValue(u.data),
v.mul2(A,x),this.viewProjId.setValue(v.data),this.viewPosId.setValue(a._node.getPosition().data);a.frustum.update(A,x);this.nearClipId.setValue(a._nearClip);this.farClipId.setValue(a._farClip);this.cameraParamsId.setValue(a._shaderParams.data);f=this.device;f.setRenderTarget(b);f.updateBegin();e=a.getRect();g=b?b.width:f.width;b=b?b.height:f.height;var l=Math.floor(e.x*g),k=Math.floor(e.y*b),m=Math.floor(e.width*g),e=Math.floor(e.height*b);f.setViewport(l,k,m,e);f.setScissor(l,k,m,e);c&&f.clear(a._clearOptions);
...
0},renderShadows:function(a,b){var f=this.device,g,h,e,k,w,y,x,C,u,I,H,v,G,F,z=1<<pc.SHADER_SHADOW,A,L;for(g=0;g<a.length;g++)if(e=a[g],w=e._type,e.castShadows&&e._enabled&&(e._shadowCamera||this.getShadowCamera(f,e),e.shadowUpdateMode!==pc.SHADOWUPDATE_NONE&&e.visibleThisFrame)){y=this.getShadowCamera(f,e);x=y._node;C=0;u=1;if(w===pc.LIGHTTYPE_DIRECTIONAL){if(0>e._visibleLength[b])continue;C=e._visibleCameraSettings[b];x.setPosition(C.x,C.y,C.z);y.orthoHeight=C.orthoHeight;y.farClip=C.farClip;C=
b}else w===pc.LIGHTTYPE_SPOT?(this.viewPosId.setValue(x.getPosition().data),this.shadowMapLightRadiusId.setValue(e.attenuationEnd)):w===pc.LIGHTTYPE_POINT&&(this.viewPosId.setValue(x.getPosition().data),this.shadowMapLightRadiusId.setValue(e.attenuationEnd),u=6);w!==pc.LIGHTTYPE_POINT&&(q.setTRS(x.getPosition(),x.getRotation(),pc.Vec3.ONE).invert(),t.mul2(y.getProjectionMatrix(),q),e._shadowMatrix.mul2(n,t));f.webgl2?w===pc.LIGHTTYPE_POINT?f.setDepthBias(!1):(f.setDepthBias(!0),f.setDepthBiasValues(-1E3*
...
!1,!1,!1):f.setColorWrite(!0,!0,!0,!0);for(C?u=C+1:C=0;C<u;){w===pc.LIGHTTYPE_POINT&&(x.setRotation(m[C]),y.renderTarget=e._shadowCubeMap[C]);this.setCamera(y,y.renderTarget,!0,w!==pc.LIGHTTYPE_POINT);F=e._visibleList[C];H=e._visibleLength[C];h=e._shadowType;I=h+5*w;for(h=0;h<H;h++){v=F[h];G=v.mesh;k=v.material;this.setBaseConstants(f,k);this.setSkinning(f,v,k);if(k.chunks){L=k.parameters;for(A in L)k=L[A],k.passFlags&z&&(k.scopeId||(k.scopeId=f.scope.resolve(A)),k.scopeId.setValue(k.data));L=v.parameters;
for(A in L)k=L[A],k.passFlags&z&&(k.scopeId||(k.scopeId=f.scope.resolve(A)),k.scopeId.setValue(k.data))}k=v._shader[pc.SHADER_SHADOW+I];if(!k){this.updateShader(v,v._shaderDefs,null,pc.SHADER_SHADOW+I);k=v._shader[pc.SHADER_SHADOW+I];L=v._key;var B=pc.SORTKEY_DEPTH,D=v.material,E=v.skinInstance?10:0,J=0;D.opacityMap&&(D=D.opacityMapChannel)&&(J=l[D]);L[B]=E+J}f.setShader(k);k=v.renderStyle;f.setVertexBuffer(v.morphInstance&&v.morphInstance._vertexBuffer?v.morphInstance._vertexBuffer:G.vertexBuffer,
0);f.setIndexBuffer(G.indexBuffer[k]);h+=this.drawInstance(f,v,G,k);this._shadowDrawCalls++}C++;w===pc.LIGHTTYPE_DIRECTIONAL&&(e._visibleLength[b]=-1)}e._isVsm&&(w=e._vsmBlurSize,1<w&&(y=y.renderTarget,x=d(f,e._shadowResolution,e._shadowType,1),u=e._shadowType===pc.SHADOW_VSM8,C=e.vsmBlurMode,F=(u?this.blurPackedVsmShader:this.blurVsmShader)[C][w],F||(this.blurVsmWeights[w]=c(w),F=pc.shaderChunks.fullscreenQuadVS,h="#define SAMPLES "+w+"\n",h=u?h+this.blurPackedVsmShaderCode[C]:h+this.blurVsmShaderCode[C],
F=pc.shaderChunks.createShaderFromCode(this.device,F,h,"blurVsm"+C+""+w+""+u),u?this.blurPackedVsmShader[C][w]=F:this.blurVsmShader[C][w]=F),p.z=e._shadowResolution-2,p.w=p.z,this.sourceId.setValue(y.colorBuffer),r.x=1/e._shadowResolution,r.y=0,this.pixelOffsetId.setValue(r.data),C===pc.BLUR_GAUSSIAN&&this.weightId.setValue(this.blurVsmWeights[w]),pc.drawQuadWithShader(f,x,F,null,p),this.sourceId.setValue(x.colorBuffer),r.y=r.x,r.x=0,this.pixelOffsetId.setValue(r.data),pc.drawQuadWithShader(f,y,F,
null,p)))}f.webgl2?f.setDepthBias(!1):f.extStandardDerivatives&&(this.polygonOffset[0]=0,this.polygonOffset[1]=0,this.polygonOffsetId.setValue(this.polygonOffset))},updateShader:function(a,b,c,d,f){a.material._scene=this.scene;a.material.updateShader(this.device,this.scene,b,c,d,f);a._shader[d]=a.material.shader},renderForward:function(a,b,c,d,f,g,h,e){var l=this.device,k=this.scene,m=a.vrDisplay,n=1<<f;e=e?e._lightHash:0;var p,r,q,t,w,y,x,u,v=null,A,L,S=.5*l.width;for(p=0;p<c;p++)if(r=b[p],!g||!r.mask||
g&r.mask)if(r.command)r.command();else{q=r.mesh;t=r.material;w=r._shaderDefs;x=r.mask;this.setSkinning(l,r,t);t&&t===v&&w!==y&&(v=null);if(r.isStatic||A)v=null;if(t!==v){this._materialSwitches++;r._shader[f]&&r._shaderDefs===w&&r._lightHash===e||(r.isStatic?this.updateShader(r,w,r._staticLightList,f,d):(y=f+"_"+w+"_"+e,r._shader[f]=t.variants[y],r._shader[f]||(this.updateShader(r,w,null,f,d),t.variants[y]=r._shader[f])),r._shaderDefs=w,r._lightHash=e);l.setShader(r._shader[f]);y=t.parameters;for(L in y)A=
y[L],A.passFlags&n&&(A.scopeId||(A.scopeId=l.scope.resolve(L)),A.scopeId.setValue(A.data));v&&x===u||(u=this.dispatchDirectLights(d[pc.LIGHTTYPE_DIRECTIONAL],k,x),this.dispatchLocalLights(d,k,x,u,r._staticLightList));this.alphaTestId.setValue(t.alphaTest);l.setBlending(t.blend);t.blend&&(t.separateAlphaBlend?(l.setBlendFunctionSeparate(t.blendSrc,t.blendDst,t.blendSrcAlpha,t.blendDstAlpha),l.setBlendEquationSeparate(t.blendEquation,t.blendAlphaEquation)):(l.setBlendFunction(t.blendSrc,t.blendDst),
...
a.length=f.length;for(b=0;b<f.length;b++)a[b]=f[b]},prepareStaticMeshes:function(a,b){var c,d,f,g,h,e=this.device,l=a.length,k,m,n=[],p,r,q,t,w,y,x,u,C,v,I,H,G,F,z=new pc.Vec3,A=new pc.Vec3,L=new pc.BoundingBox,D=new pc.Mat4,B=[],E,J,S=[],R=[],K=[];for(c=0;c<l;c++)if(k=a[c],k.isStatic){p=k.aabb;K.length=0;for(E=pc.LIGHTTYPE_POINT;E<=pc.LIGHTTYPE_SPOT;E++)for(d=0;d<b.length;d++)m=b[d],m._type===E&&m._enabled&&m._mask&k.mask&&m.isStatic&&(S[d]||(S[d]=new pc.BoundingBox,m._node.getWorldTransform(),m.getBoundingSphere(Q),
S[d].center.copy(Q.center),S[d].halfExtents.x=Q.radius,S[d].halfExtents.y=Q.radius,S[d].halfExtents.z=Q.radius),S[d].intersects(p)&&K.push(d));if(0===K.length)n.push(k);else{p=k.mesh;E=p.vertexBuffer;m=p.indexBuffer[k.renderStyle];r=2===m.bytesPerIndex?new Uint16Array(m.lock()):new Uint32Array(m.lock());q=p.primitive[k.renderStyle].count/3;x=p.primitive[k.renderStyle].base;t=E.format.elements;w=E.format.size/4;p=new Float32Array(E.storage);for(f=0;f<t.length;f++)t[f].name===pc.SEMANTIC_POSITION&&
(y=t[f].offset/4);B.length=q;for(f=0;f<q;f++)B[f]=0;t=!1;R.length=6*q;for(f=0;f<q;f++){I=v=C=Number.MAX_VALUE;H=-Number.MAX_VALUE;G=-Number.MAX_VALUE;F=-Number.MAX_VALUE;for(g=0;3>g;g++)d=r[3*f+g+x],d=d*w+y,h=p[d],u=p[d+1],d=p[d+2],h<C&&(C=h),u<v&&(v=u),d<I&&(I=d),h>H&&(H=h),u>G&&(G=u),d>F&&(F=d);d=6*f;R[d]=C;R[d+1]=v;R[d+2]=I;R[d+3]=H;R[d+4]=G;R[d+5]=F}for(h=0;h<K.length;h++)for(d=K[h],D.copy(k.node.worldTransform).invert(),L.setFromTransformedAabb(S[d],D),u=L.getMin().data,C=L.getMax().data,g=1<<
h,f=0;f<q;f++)d=6*f,R[d]<=C[0]&&R[d+3]>=u[0]&&R[d+1]<=C[1]&&R[d+4]>=u[1]&&R[d+2]<=C[2]&&R[d+5]>=u[2]&&(B[f]|=g,t=!0);if(t){t={};for(f=0;f<q;f++)d=3*f+x,J=B[f],t[J]||(t[J]=[]),g=t[J],g.push(r[d]),g.push(r[d+1]),g.push(r[d+2]);for(J in t){g=t[J];r=new pc.IndexBuffer(e,m.format,g.length,m.usage);(2===r.bytesPerIndex?new Uint16Array(r.lock()):new Uint32Array(r.lock())).set(g);r.unlock();I=v=C=Number.MAX_VALUE;H=-Number.MAX_VALUE;G=-Number.MAX_VALUE;F=-Number.MAX_VALUE;for(f=0;f<g.length;f++)d=g[f],h=
p[d*w+y],u=p[d*w+y+1],d=p[d*w+y+2],h<C&&(C=h),u<v&&(v=u),d<I&&(I=d),h>H&&(H=h),u>G&&(G=u),d>F&&(F=d);z.set(C,v,I);A.set(H,G,F);f=new pc.BoundingBox;f.setMinMax(z,A);q=new pc.Mesh;q.vertexBuffer=E;q.indexBuffer[0]=r;q.primitive[0].type=pc.PRIMITIVE_TRIANGLES;q.primitive[0].base=0;q.primitive[0].count=g.length;q.primitive[0].indexed=!0;q.aabb=f;r=new pc.MeshInstance(k.node,q,k.material);r.isStatic=k.isStatic;r.visible=k.visible;r.layer=k.layer;r.castShadow=k.castShadow;r._receiveShadow=k._receiveShadow;
r.cull=k.cull;r.pick=k.pick;r.mask=k.mask;r.parameters=k.parameters;r._shaderDefs=k._shaderDefs;r._staticSource=k;r._staticLightList=k._staticLightList?k._staticLightList:[];for(f=0;f<K.length;f++)g=1<<f,J&g&&(q=b[K[f]],0>r._staticLightList.indexOf(q)&&r._staticLightList.push(q));r._staticLightList.sort(this.lightCompare);n.push(r)}}else n.push(k)}}else n.push(k);a.length=n.length;for(c=0;c<n.length;c++)a[c]=n[c]},updateShaders:function(a){var b,c=[];for(b=0;b<a.length;b++){var d=a[b];void 0!==d.material&&
...
d._lights),a._dirty=!0,b.updateShaders=!0,d._needsStaticPrepare=!1,d._staticPrepareDone=!0)}},cullLocalShadowmap:function(a,b){var c,d,f,g,h,e,l,k,n,p,r;d=a._type;if(d!==pc.LIGHTTYPE_DIRECTIONAL)for(a.visibleThisFrame=!0,f=this.getShadowCamera(this.device,a),f.projection=pc.PROJECTION_PERSPECTIVE,f.nearClip=a.attenuationEnd/1E3,f.farClip=a.attenuationEnd,f.aspectRatio=1,d===pc.LIGHTTYPE_SPOT?(f.fov=2*a._outerConeAngle,h=1):(f.fov=90,h=6),g=f._node,c=a._node,g.setPosition(c.getPosition()),d===pc.LIGHTTYPE_SPOT&&
(g.setRotation(c.getRotation()),g.rotateLocal(-90,0,0)),e=0;e<h;e++){d===pc.LIGHTTYPE_POINT&&(g.setRotation(m[e]),f.renderTarget=a._shadowCubeMap[e]);this.updateCameraFrustum(f);(n=a._visibleList[e])||(n=a._visibleList[e]=[]);c=p=a._visibleLength[e]=0;for(l=b.length;c<l;c++)k=b[c],r=!0,k.cull&&(r=this._isVisible(f,k)),r&&(n[p]=k,p++,k.visibleThisFrame=!0);a._visibleLength[e]=p;n.length!==p&&(n.length=p);n.sort(this.depthSortCompare)}},cullDirectionalShadowmap:function(a,b,c,d){var f,g,h,e,l,k,m,n,
p,r,t,y;g=this.device;a.visibleThisFrame=!0;g=this.getShadowCamera(g,a);h=g._node;e=a._node;h.setPosition(e.getPosition());h.setRotation(e.getRotation());h.rotateLocal(-90,0,0);n=a.shadowDistance||c._farClip;p=c._nearClip;f=c._fov*Math.PI/180;l=c._aspect;k=c._projection;t=k===pc.PROJECTION_PERSPECTIVE?Math.tan(f/2)*p:c._orthoHeight;r=t*l;O[0].x=r;O[0].y=-t;O[0].z=-p;O[1].x=r;O[1].y=t;O[1].z=-p;O[2].x=-r;O[2].y=t;O[2].z=-p;O[3].x=-r;O[3].y=-t;O[3].z=-p;k===pc.PROJECTION_PERSPECTIVE&&(t=Math.tan(f/
2)*n,r=t*l);O[4].x=r;O[4].y=-t;O[4].z=-n;O[5].x=r;O[5].y=t;O[5].z=-n;O[6].x=-r;O[6].y=t;O[6].z=-n;O[7].x=-r;O[7].y=-t;O[7].z=-n;l=V.sub2(O[0],O[6]).length();l=Math.max(l,V.sub2(O[4],O[6]).length());q.copy(h.getWorldTransform()).invert();w.copy(q).mul(c._node.worldTransform);for(f=0;8>f;f++)w.transformPoint(O[f],O[f]);n=p=c=1E6;r=t=k=-1E6;for(f=0;8>f;f++)m=O[f],m.x<n&&(n=m.x),m.x>r&&(r=m.x),m.y<p&&(p=m.y),m.y>t&&(t=m.y),m.z<c&&(c=m.z),m.z>k&&(k=m.z);f=l/a._shadowResolution;n=Math.floor((n-.5*(l-(r-
n)))/f)*f;p=Math.floor((p-.5*(l-(t-p)))/f)*f;n=.5*(n+l+n);p=.5*(p+l+p);h.translateLocal(n,p,1E5);g.projection=pc.PROJECTION_ORTHOGRAPHIC;g.nearClip=0;g.farClip=2E5;g.aspectRatio=1;g.orthoHeight=.5*l;this.updateCameraFrustum(g);t=!0;(k=a._visibleList[d])||(k=a._visibleList[d]=[]);f=l=a._visibleLength[d]=0;for(r=b.length;f<r;f++)y=b[f],m=!0,y.cull&&(m=this._isVisible(g,y)),m&&(k[l]=y,l++,y.visibleThisFrame=!0,m=y.aabb,t?(Z.copy(m),t=!1):Z.add(m));a._visibleLength[d]=l;k.length!==l&&(k.length=l);k.sort(this.depthSortCompare);
b=Z.getMin();f=Z.getMax();M[0].x=M[1].x=M[2].x=M[3].x=b.x;M[1].y=M[3].y=M[7].y=M[5].y=b.y;M[2].z=M[3].z=M[6].z=M[7].z=b.z;M[4].x=M[5].x=M[6].x=M[7].x=f.x;M[0].y=M[2].y=M[4].y=M[6].y=f.y;M[0].z=M[1].z=M[4].z=M[5].z=f.z;f=9999999999;b=-9999999999;for(k=0;8>k;++k)q.transformPoint(M[k],M[k]),l=M[k].z,l<f&&(f=l),l>b&&(b=l);k=b;f>c&&(c=f);h.setPosition(e.getPosition());h.translateLocal(n,p,k+.01);g.farClip=k-c;(e=a._visibleCameraSettings[d])||(e=a._visibleCameraSettings[d]={});a=h.getPosition().data;e.x=
...
b.width;this._screenSize.y=b.height;this._screenSize.z=1/b.width;this._screenSize.w=1/b.height;this.screenSizeId.setValue(this._screenSize.data)},renderComposition:function(a){var b=this.device,c,d=a._renderedRt,f=a._renderedByCam,g=a._renderedLayer,h,e,l,k,m,n,p,r;this.beginLayers(a);a._update()&pc.COMPUPDATED_LIGHTS&&(this.scene.updateShaders=!0);this.beginFrame(a);this.setSceneConstants();var q=0,t,w;for(h=0;h<a.layerList.length;h++)if(e=a.layerList[h],e.enabled&&a.subLayerEnabled[h])for(l=a.subLayerList[h],
t=e.instances,k=e.cameras,m=0;m<k.length;m++)if(c=k[m]){c.frameBegin(e.renderTarget);w=l?e.transparentMeshInstances:e.opaqueMeshInstances;r=p=!1;for(n=0;n<q;n++)if(f[n]===c&&(p=!0,g[n]===e)){r=!0;break}p||(this.updateCameraFrustum(c.camera),this._camerasRendered++);r||this.cullLights(c.camera,e._lights);p&&r||(f[q]=c,g[q]=e,q++);n=l?t.visibleTransparent[m]:t.visibleOpaque[m];if(!n.done){if(e.onPreCull)e.onPreCull(m);n.length=this.cull(c.camera,w,n.list);n.done=!0;if(e.onPostCull)e.onPostCull(m)}c.frameEnd()}for(h=
...
if(!(e._preRenderCalledForCameras&1<<k)){if(e.onPreRender)e.onPreRender(k);e._preRenderCalledForCameras|=1<<k;e.overrideClear&&this.clearView(c,e.renderTarget,e._clearOptions)}if(c){m=e.renderTarget;g=!1;for(n=0;n<q;n++)if(d[n]===m&&f[n]===c){g=!0;break}g||(e.overrideClear||this.clearView(c,e.renderTarget),d[q]=m,f[q]=c,q++);this.renderShadows(e._sortedLights[pc.LIGHTTYPE_DIRECTIONAL],k);e._sortVisible(l,c.node,k);n=l?t.visibleTransparent[k]:t.visibleOpaque[k];this.scene._activeCamera=c.camera;this.setCamera(c.camera,
...
b.push(this);for(c=0;c<d;++c)b=this._children[c].findByLabel(a,b);return b},_sync:function(){this._dirtyLocal&&(this.localTransform.setTRS(this.localPosition,this.localRotation,this.localScale),this._dirtyLocal=!1);if(this._dirtyWorld){if(null===this._parent)this.worldTransform.copy(this.localTransform);else if(this.scaleCompensation){var g,n=this._parent,l=this.localScale,m=n;if(m){for(;m&&m.scaleCompensation;)m=m._parent;m&&(m=m._parent)&&(g=m.worldTransform.getScale(),d.mul2(g,this.localScale),
l=d)}c.setFromMat4(n.worldTransform);b.mul2(c,this.localRotation);m=n.worldTransform;n.scaleCompensation&&(f.mul2(g,n.getLocalScale()),e.setTRS(n.worldTransform.getTranslation(a),c,f),m=e);m.transformPoint(this.localPosition,a);this.worldTransform.setTRS(a,b,l)}else this.worldTransform.mul2(this._parent.worldTransform,this.localTransform);this._dirtyWorld=!1}},syncHierarchy:function(){if(this._enabled){(this._dirtyLocal||this._dirtyWorld)&&this._sync();for(var a=0;a<this._children.length;a++)this._children[a].syncHierarchy()}},
...
g=this._node.getWorldTransform();this._viewMat.copy(g).invert();this._viewProjMat.mul2(f,this._viewMat);this._viewProjMat.transformPoint(a,d);a=a.data;f=this._viewProjMat.data;a=a[0]*f[3]+a[1]*f[7]+a[2]*f[11]+1*f[15];d.x=.5*(d.x/a+1)*b;d.y=.5*(1-d.y/a)*c;return d},screenToWorld:function(d,g,h,n,l,m){void 0===m&&(m=new pc.Vec3);var f=this.getProjectionMatrix(),r=this._node.getWorldTransform();this._viewMat.copy(r).invert();this._viewProjMat.mul2(f,this._viewMat);c.copy(this._viewProjMat).invert();
this._projection===pc.PROJECTION_PERSPECTIVE?(a.set(d/n*2-1,(l-g)/l*2-1,1),c.transformPoint(a,b),b.scale(1/(a.x*c.data[3]+a.y*c.data[7]+a.z*c.data[11]+c.data[15])),d=h/this._farClip,m.lerp(this._node.getPosition(),b,d)):(e.set(d/n,(l-g)/l,h/(this._farClip-this._nearClip)),e.scale(2),e.sub(pc.Vec3.ONE),c.transformPoint(e,m));return m},getClearOptions:function(){return this._clearOptions},getProjectionMatrix:function(){if(this._projMatDirty){if(this._projection===pc.PROJECTION_PERSPECTIVE)this._projMat.setPerspective(this._fov,
...
a.normalOffsetBias=this._normalOffsetBias;a.shadowResolution=this._shadowResolution;a.shadowDistance=this.shadowDistance;return a},getColor:function(){return this._color},getBoundingSphere:function(c){if(this._type===pc.LIGHTTYPE_SPOT){var d=this.attenuationEnd,f=this._outerConeAngle,n=Math.cos(f*pc.math.DEG_TO_RAD),l=this._node;e.copy(l.up);e.scale(.5*-d*n);e.add(l.getPosition());c.center=e;a.copy(l.up);a.scale(-d);b.copy(l.right);b.scale(Math.sin(f*pc.math.DEG_TO_RAD)*d);a.add(b);c.radius=.5*a.length()}else this._type===
...
!0;for(d=0;d<a.data.length;d++)if(this._mapXForms[b][c][d]!=a.data[d]){f=!1;break}if(f)return c+1}c=this._mapXForms[b].length;this._mapXForms[b][c]=[];for(d=0;d<a.data.length;d++)this._mapXForms[b][c][d]=a.data[d];return c+1},updateShader:function(a,b,c,d,f,g){!this._colorProcessed&&this._scene&&(this._colorProcessed=!0,this._processColor());this._mapXForms=[];var h=a.useTexCubeLod,e=!a.extTextureLod,l,k,m,n,p,r;this.useSkybox&&(l=b._skyboxPrefiltered[0],k=b._skyboxPrefiltered[1],m=b._skyboxPrefiltered[2],
n=b._skyboxPrefiltered[3],p=b._skyboxPrefiltered[4],r=b._skyboxPrefiltered[5]);var q=this.prefilteredCubeMap128||l;k=this.prefilteredCubeMap64||k;m=this.prefilteredCubeMap32||m;n=this.prefilteredCubeMap16||n;p=this.prefilteredCubeMap8||p;r=this.prefilteredCubeMap4||r;if(q){var t=q&&k&&m&&n&&p&&r;e&&t?(q.dpAtlas||(q.dpAtlas=pc.generateDpAtlas(a,[q,k,m,n,p,r]),q.sh=pc.shFromCubemap(n)),this.dpAtlas=q.dpAtlas,this.ambientSH=q.sh,this._setParameter("ambientSH[0]",this.ambientSH),this._setParameter("texture_sphereMap",
...
-1,blendMapsWithColors:!0,ambientTint:this.ambientTint,diffuseTint:k,specularTint:r?3:0,metalnessTint:this.useMetalness&&1>this.metalness?1:0,glossTint:1,emissiveTint:x,opacityTint:1!==this.opacity&&this.blendType!==pc.BLEND_NONE?1:0,alphaTest:0<this.alphaTest,alphaToCoverage:this.alphaToCoverage,needsNormalFloat:this.normalizeNormalMap,sphereMap:!!this.sphereMap,cubeMap:!!this.cubeMap,dpAtlas:!!this.dpAtlas,ambientSH:!!this.ambientSH,useSpecular:m,rgbmAmbient:p,rgbmReflection:t,hdrAmbient:n,hdrReflection:w,
...
this.mesh.vertexBuffer.format.size;var p,q,t,w,y;for(f=0;f<g.length;f++)g[f].name===pc.SEMANTIC_POSITION?q=g[f].offset:g[f].name===pc.SEMANTIC_BLENDINDICES?t=g[f].offset:g[f].name===pc.SEMANTIC_BLENDWEIGHT&&(w=g[f].offset);var g=new Uint8Array(this.mesh.vertexBuffer.storage),x=new Float32Array(this.mesh.vertexBuffer.storage),u=q/4,v=w/4,A=a/4,B,D,z,E,I;w=[];q=[];d=this.mesh.boneUsed;for(f=0;f<c;f++)w[f]=new pc.Vec3(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE),q[f]=new pc.Vec3(-Number.MAX_VALUE,
-Number.MAX_VALUE,-Number.MAX_VALUE);for(y=0;y<e;y++)for(f=0;4>f;f++)0<x[y*A+v+f]&&(p=g[y*a+t+f],z=x[y*A+u],E=x[y*A+u+1],I=x[y*A+u+2],B=q[p],D=w[p],D.x>z&&(D.x=z),D.y>E&&(D.y=E),D.z>I&&(D.z=I),B.x<z&&(B.x=z),B.y<E&&(B.y=E),B.z<I&&(B.z=I),d[p]=!0);if(this.morphInstance){var G;d=this.morphInstance.morph._targets;var H=new Float32Array(3*e),C=new Float32Array(3*e),F;for(y=0;y<e;y++)H[3*y]=C[3*y]=x[y*A+u],H[3*y+1]=C[3*y+1]=x[y*A+u+1],H[3*y+2]=C[3*y+2]=x[y*A+u+2];for(e=0;e<d.length;e++)for(f=d[e],u=f.indices,
y=u.length,z=f.deltaPositions,f=0;f<y;f++)G=u[f],p=z[3*f],B=z[3*f+1],D=z[3*f+2],0>p?H[3*G]+=p:C[3*G]+=p,0>B?H[3*G+1]+=B:C[3*G+1]+=B,0>D?H[3*G+2]+=D:C[3*G+2]+=D;for(e=0;e<d.length;e++)for(f=d[e],u=f.indices,y=u.length,f=0;f<y;f++)for(G=u[f],F=0;4>F;F++)0<x[G*A+v+F]&&(p=g[G*a+t+F],B=q[p],D=w[p],z=H[3*G],E=H[3*G+1],I=H[3*G+2],D.x>z&&(D.x=z),D.y>E&&(D.y=E),D.z>I&&(D.z=I),z=C[3*G],E=C[3*G+1],I=C[3*G+2],B.x<z&&(B.x=z),B.y<E&&(B.y=E),B.z<I&&(B.z=I))}for(f=0;f<c;f++)a=new pc.BoundingBox,a.setMinMax(w[f],
...
c}},addPrimitive:function(a,b,c,e){var d,f,g=[],h=0,r=a.length;for(d=0;d<r;d++)for(var p=a[d].index,q=0;4>q;q++)if(0<c.blendWeight.data[4*p+q]){var t=c.blendIndices.data[4*p+q],w=!0;for(f=0;f<h;f++)if(g[f]==t){w=!1;break}w&&(g[h]=t,f=this.getBoneRemap(t),h+=-1===f?1:0)}if(this.boneIndices.length+h>e)return!1;for(d=0;d<h;d++)this.boneIndices.push(g[d]);for(d=0;d<r;d++)this.addVertex(a[d],b[d],c);return!0},getBoneRemap:function(a){for(var b=0;b<this.boneIndices.length;b++)if(this.boneIndices[b]===a)return b;
return-1}};return{partitionSkin:function(d,f,g){var h,n,l,m;b(d);var k=d.vertices,r=d.skins,p,q=d.meshes,t=d.meshInstances,w=function(a){var b=new e;b.index=a;return b};for(h=r.length-1;0<=h;h--)if(r[h].boneNames.length>g){var y=r.splice(h,1)[0],x=[];for(n=0;n<q.length;n++)q[n].skin===y&&x.push(q[n]);for(n=0;n<x.length;n++)m=q.indexOf(x[n]),-1!==m&&q.splice(m,1);if(0===x.length)throw Error("partitionSkin: There should be at least one mesh that references a skin");var u=x[0].vertices;for(n=1;n<x.length;n++)if(x[n].vertices!==
u)throw Error("partitionSkin: All meshes that share a skin should also share the same vertex buffer");var v=[],A=[];l=[];var B=0;for(n=0;n<x.length;n++){p=x[n];for(var D=p.indices,z=p.base;z<p.base+p.count;){m=D[z++];A[0]=w(m);l[0]=m;m=D[z++];A[1]=w(m);l[1]=m;m=D[z++];A[2]=w(m);l[2]=m;for(var E=!1,I=B;I<v.length;I++)if(m=v[I],m.addPrimitive(A,l,u,g)){E=!0;break}E||(m=new a,m.originalMesh=p,m.addPrimitive(A,l,u,g),v.push(m))}B=v.length}p=[];x=[];for(n=0;n<v.length;n++)if(m=v[n],m.vertices.length&&
m.indices.length){A=p.length;l=m.vertices.length;B=x.length;D=m.indices.length;m.partition=n;m.vertexStart=A;m.vertexCount=l;m.indexStart=B;m.indexCount=D;z=0;for(E=A;z<l;)p[E++]=m.vertices[z++];z=0;for(E=B;z<D;)x[E++]=m.indices[z++]+A}A=[];for(n=0;n<v.length;n++){m=v[n];B=[];D=[];for(l=0;l<m.boneIndices.length;l++)B.push(y.inverseBindMatrices[m.boneIndices[l]]),D.push(y.boneNames[m.boneIndices[l]]);m={inverseBindMatrices:B,boneNames:D};A.push(m);r.push(m)}var G,y={};for(G in u)y[G]={components:u[G].components,
data:[],type:u[G].type};for(G in u)if("blendIndices"===G)for(m=y[G].data,n=0;n<p.length;n++)l=p[n].boneIndices,m.push(l[0],l[1],l[2],l[3]);else for(n=u[G],B=n.data,D=n.components,n=0;n<p.length;n++)for(m=p[n].index,l=0;l<D;l++)y[G].data.push(B[m*D+l]);k[k.indexOf(u)]=y;for(n=0;n<v.length;n++)for(m=v[n],p={aabb:{min:[0,0,0],max:[0,0,0]},vertices:y,skin:A[n],indices:x.splice(0,m.indexCount),type:"triangles",base:0,count:m.indexCount},q.push(p),l=t.length-1;0<=l;l--)t[l].mesh===m.originalMesh&&(t.push({mesh:p,
node:t[l].node}),f&&f.push({material:f[l].material,path:f[l].path}));for(n=0;n<v.length;n++)for(m=v[n],l=t.length-1;0<=l;l--)t[l].mesh===m.originalMesh&&(t.splice(l,1),f&&f.splice(l,1))}c(d)}}}());pc.extend(pc,function(){var e=new pc.Vec3,a=new pc.Vec3,b=function(a){this.aabb=new pc.BoundingBox;this._baseAabb=this._baseBuffer=null;this._targets=a;this._aabbDirty=this._dirty=!0;this._baseData=null;this._vertSizeF=this._offsetTF=this._offsetNF=this._offsetPF=0};pc.extend(b.prototype,{_setBaseMesh:function(a){this._baseBuffer=a.vertexBuffer;this._baseAabb=a._aabb;this._baseData=new Float32Array(this._baseBuffer.storage);for(var b=a=-1,c=-1,d=this._baseBuffer.format.elements,e=this._baseBuffer.format.size,
l=0;l<d.length;l++)d[l].name===pc.SEMANTIC_POSITION?a=d[l].offset:d[l].name===pc.SEMANTIC_NORMAL?b=d[l].offset:d[l].name===pc.SEMANTIC_TANGENT&&(c=d[l].offset);this._offsetPF=a/4;this._offsetNF=b/4;this._offsetTF=c/4;this._vertSizeF=e/4;this._dirty=!0},_calculateAabb:function(){if(this._baseBuffer){this.aabb.copy(this._baseAabb);var b,c,g,h,n,l,m,k=this._vertSizeF,r=this._offsetPF,p=this._baseData;for(c=0;c<this._targets.length;c++){h=this._targets[c];if(!h.aabb&&0<h.indices.length){h.aabb=this.aabb.clone();
e.set(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE);a.set(-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE);b=h.indices.length;for(g=0;g<b;g++)n=h.indices[g],l=n*k+r,n=p[l]+h.deltaPositions[3*g],m=p[l+1]+h.deltaPositions[3*g+1],l=p[l+2]+h.deltaPositions[3*g+2],e.x>n&&(e.x=n),e.y>m&&(e.y=m),e.z>l&&(e.z=l),a.x<n&&(a.x=n),a.y<m&&(a.y=m),a.z<l&&(a.z=l);h.aabb.setMinMax(e,a)}h.aabb&&this.aabb.add(h.aabb)}this._aabbDirty=!1}},addTarget:function(a){this._targets.push(a);this._aabbDirty=!0},removeTarget:function(a){a=
...
update:function(a){this.morph._baseBuffer!==a.vertexBuffer&&this.morph._setBaseMesh(a);this._vertexData||this._setBaseMesh(a);var b,c=this.morph._targets,d=this._weights,e,l,m,k,r,p=this.morph._vertSizeF,q=this.morph._offsetPF,t=this.morph._offsetNF,w=this.morph._offsetTF,y=this._vertexData;y.set(this.morph._baseData);for(var x=0;x<c.length;x++)if(l=d[x],0!==l)for(e=c[x],a=e.indices.length,m=0;m<a;m++)r=3*m,b=e.indices[m],k=b*p+q,y[k]+=e.deltaPositions[r]*l,y[k+1]+=e.deltaPositions[r+1]*l,y[k+2]+=
e.deltaPositions[r+2]*l,e.deltaNormals&&(k=b*p+t,y[k]+=e.deltaNormals[r]*l,y[k+1]+=e.deltaNormals[r+1]*l,y[k+2]+=e.deltaNormals[r+2]*l,e.deltaTangents&&(r=4*m,k=b*p+w,y[k]+=e.deltaTangents[r]*l,y[k+1]+=e.deltaTangents[r+1]*l,y[k+2]+=e.deltaTangents[r+2]*l,y[k+3]+=e.deltaTangents[r+3]*l,y[k+3]=0<y[k+3]?1:-1));this._vertexBuffer.unlock()}};return{MorphTarget:function(a){if(a.indices)this.indices=a.indices;else{var b=a.deltaPositions;this.indices=[];this.indices.length=b.length;for(var c=0;c<b.length;c++)this.indices[c]=
...
this.meshInstances[a];-1===b.indexOf(c.material)&&b.push(c.material)}return b},clone:function(){var a,b,c=[],d=[],f=function(a){var b=a.clone();c.push(a);d.push(b);for(var g=0;g<a._children.length;g++)b.addChild(f(a._children[g]));return b},g=f(this.graph),e=[],n=[],l=[];for(a=0;a<this.skinInstances.length;a++){var m=this.skinInstances[a].skin,k=new pc.SkinInstance(m),r=[];for(b=0;b<m.boneNames.length;b++){var p=g.findByName(m.boneNames[b]);r.push(p)}k.bones=r;n.push(k)}for(a=0;a<this.morphInstances.length;a++)b=
new pc.MorphInstance(this.morphInstances[a].morph),l.push(b);for(a=0;a<this.meshInstances.length;a++)b=this.meshInstances[a],m=c.indexOf(b.node),m=new pc.MeshInstance(d[m],b.mesh,b.material),b.skinInstance&&(k=this.skinInstances.indexOf(b.skinInstance),m.skinInstance=n[k]),b.morphInstance&&(b=this.morphInstances.indexOf(b.morphInstance),m.morphInstance=l[b]),e.push(m);a=new pc.Model;a.graph=g;a.meshInstances=e;a.skinInstances=n;a.morphInstances=l;a.getGraph().syncHierarchy();return a},destroy:function(){for(var a=
this.meshInstances,b,c,d,f,g=0;g<a.length;g++){b=a[g];if(c=b.mesh)if(c._refCount--,1>c._refCount){c.vertexBuffer&&(c.vertexBuffer.destroy(),c.vertexBuffer=null);for(f=0;f<c.indexBuffer.length;f++)(d=c.indexBuffer[f])&&d.destroy();c.indexBuffer.length=0}(c=b.skinInstance)&&(c=c.boneTexture)&&c.destroy();b.skinInstance=null;(c=b.morphInstance)&&c.destroy();b.morphInstance=null;b.material=null}},generateWireframe:function(){var a,b,c,d,f,g,e,n,l,m,k=[];for(a=0;a<this.meshInstances.length;a++)g=this.meshInstances[a].mesh,
-1===k.indexOf(g)&&k.push(g);var r=[[0,1],[1,2],[2,0]];for(a=0;a<k.length;a++){g=k[a];e=g.primitive[pc.RENDERSTYLE_SOLID].base;n=g.primitive[pc.RENDERSTYLE_SOLID].count;l=g.indexBuffer[pc.RENDERSTYLE_SOLID];m=new Uint16Array(l.lock());var p={},q=[];for(b=e;b<e+n;b+=3)for(c=0;3>c;c++){d=m[b+r[c][0]];f=m[b+r[c][1]];var t=d>f?f<<16|d:d<<16|f;void 0===p[t]&&(p[t]=0,q.push(d,f))}l.unlock();b=new pc.IndexBuffer(l.device,pc.INDEXFORMAT_UINT16,q.length);c=new Uint16Array(b.lock());c.set(q);b.unlock();g.primitive[pc.RENDERSTYLE_WIREFRAME]=
...
0);a("startAngle2",this.startAngle);a("animTilesX",1);a("animTilesY",1);a("animNumFrames",1);a("animSpeed",1);a("animLoop",!0);this.frameRandom=new pc.Vec3(0,0,0);a("colorGraph",k);a("colorGraph2",this.colorGraph);a("scaleGraph",l);a("scaleGraph2",this.scaleGraph);a("alphaGraph",l);a("alphaGraph2",this.alphaGraph);a("localVelocityGraph",m);a("localVelocityGraph2",this.localVelocityGraph);a("velocityGraph",m);a("velocityGraph2",this.velocityGraph);a("rotationSpeedGraph",n);a("rotationSpeedGraph2",
...
this.qAlpha2,this.alphaUMax);if(this.pack8){var e=[0,0,0];c(this.qVelocity,e);var l=[0,0,0];c(this.qVelocity2,l);g=[0,0,0];c(this.qLocalVelocity,g);var k=[0,0,0];c(this.qLocalVelocity2,k);var m=Math.max(e[0],l[0]),m=Math.max(m,e[1]),m=Math.max(m,l[1]),m=Math.max(m,e[2]),m=Math.max(m,l[2]),e=Math.max(g[0],k[0]),e=Math.max(e,g[1]),e=Math.max(e,k[1]),e=Math.max(e,g[2]),e=Math.max(e,k[2]);this.maxVel=m+e}if(!this.useCpu){this.internalTex0=h(f,a,1,b(this.qLocalVelocity,this.qLocalVelocityDiv));this.internalTex1=
h(f,a,1,b(this.qVelocity,this.qVelocityDiv));g=this.qRotSpeed;for(var k=this.qScale,m=this.qScaleDiv,e=this.qRotSpeedDiv,l=this.qAlphaDiv,n=Array(4*g.length),p=0;p<g.length;p++)n[4*p]=g[p],n[4*p+1]=k[p],n[4*p+2]=0,n[4*p+3]=(255*m[p]<<16|255*e[p]<<8|255*l[p])/16777216;this.internalTex2=h(f,a,1,n)}g=this.qColor;k=this.qAlpha;m=Array(4*k.length);for(e=0;e<k.length;e++)m[4*e]=g[3*e],m[4*e+1]=g[3*e+1],m[4*e+2]=g[3*e+2],m[4*e+3]=k[e];this.internalTex3=h(f,a,1,m,pc.PIXELFORMAT_R8_G8_B8_A8,1,!0)},_initializeTextures:function(){this.colorMap&&
...
1],q.data[1]=c+(d-c)*g,c=this.qLocalVelocity[n+2],d=this.qLocalVelocity[r+2],q.data[2]=c+(d-c)*g,c=this.qLocalVelocity2[n],d=this.qLocalVelocity2[r],w.data[0]=c+(d-c)*g,c=this.qLocalVelocity2[n+1],d=this.qLocalVelocity2[r+1],w.data[1]=c+(d-c)*g,c=this.qLocalVelocity2[n+2],d=this.qLocalVelocity2[r+2],w.data[2]=c+(d-c)*g,c=this.qVelocity[n],d=this.qVelocity[r],p.data[0]=c+(d-c)*g,c=this.qVelocity[n+1],d=this.qVelocity[r+1],p.data[1]=c+(d-c)*g,c=this.qVelocity[n+2],d=this.qVelocity[r+2],p.data[2]=c+
(d-c)*g,c=this.qVelocity2[n],d=this.qVelocity2[r],t.data[0]=c+(d-c)*g,c=this.qVelocity2[n+1],d=this.qVelocity2[r+1],t.data[1]=c+(d-c)*g,c=this.qVelocity2[n+2],d=this.qVelocity2[r+2],t.data[2]=c+(d-c)*g,q.data[0]+=(w.data[0]-q.data[0])*y.data[0],q.data[1]+=(w.data[1]-q.data[1])*y.data[1],q.data[2]+=(w.data[2]-q.data[2])*y.data[2],0<this.initialVelocity&&(this.emitterShape===pc.EMITTERSHAPE_SPHERE?(H.copy(y).scale(2).sub(pc.Vec3.ONE).normalize(),q.add(H.scale(this.initialVelocity))):q.add(pc.Vec3.FORWARD.scale(this.initialVelocity))),
p.data[0]+=(t.data[0]-p.data[0])*y.data[0],p.data[1]+=(t.data[1]-p.data[1])*y.data[1],p.data[2]+=(t.data[2]-p.data[2])*y.data[2],C+=(J-C)*y.data[1],ja=(ja+1E4*Z%1*(Y-ja))*E,c=1E3*Z%1*(V-X),this.meshInstance.node&&B.transformPoint(q,q),q.add(p.mul(I)),A.copy(q),x.data[0]=this.particleTex[4*L],x.data[1]=this.particleTex[4*L+1],x.data[2]=this.particleTex[4*L+2],u.copy(x).add(q.scale(a)),v.copy(u),this.particleTex[4*L]=v.data[0],this.particleTex[4*L+1]=v.data[1],this.particleTex[4*L+2]=v.data[2],this.particleTex[4*
L+3]+=C*a,this.wrap&&this.wrapBounds&&(v.sub(l),v.data[0]=e(v.data[0],this.wrapBounds.data[0])-.5*this.wrapBounds.data[0],v.data[1]=e(v.data[1],this.wrapBounds.data[1])-.5*this.wrapBounds.data[1],v.data[2]=e(v.data[2],this.wrapBounds.data[2])-.5*this.wrapBounds.data[2],v.add(l)),0<this.sort&&(1===this.sort?(F.copy(v).sub(m),this.particleDistance[L]=-(F.data[0]*F.data[0]+F.data[1]*F.data[1]+F.data[2]*F.data[2])):2===this.sort?this.particleDistance[L]=W:3===this.sort&&(this.particleDistance[L]=-W))):
this.calcSpawnPosition(l,L);b?0>W&&(this.particleTex[4*L+3+8*this.numParticlesPot]=-1):(W>=ia&&(W-=Math.max(ia,(this.numParticles-1)*ha),this.particleTex[4*L+3+8*this.numParticlesPot]=this.loop?1:-1),0>W&&this.loop&&(this.particleTex[4*L+3+8*this.numParticlesPot]=1));0>this.particleTex[4*L+3+8*this.numParticlesPot]&&(la=!1);this.particleTex[4*L+3+4*this.numParticlesPot]=W;for(C=0;C<this.numParticleVerts;C++)Z=this.vbCPU[h*this.numParticleVerts*4+4*C],ha=this.vbCPU[h*this.numParticleVerts*4+4*C+1],
ia=this.vbCPU[h*this.numParticleVerts*4+4*C+2],la||(Z=ha=ia=0),W=h*this.numParticleVerts*14+14*C,k[W]=v.data[0],k[W+1]=v.data[1],k[W+2]=v.data[2],k[W+3]=ma,k[W+4]=this.alignToMotion?0:this.particleTex[4*L+3],k[W+5]=ja,k[W+6]=c,k[W+7]=A.data[0],k[W+8]=Z,k[W+9]=ha,k[W+10]=ia,k[W+11]=A.data[1],k[W+12]=A.data[2]}if(this.sort>pc.PARTICLESORT_NONE&&this.camera){l=this.particleDistance;for(h=0;h<this.numParticles;h++)this.vbToSort[h]=[h,l[Math.floor(this.vbCPU[h*this.numParticleVerts*4+3])]];this.vbOld.set(this.vbCPU);
this.vbToSort.sort(function(a,b){return a[1]-b[1]});for(h=0;h<this.numParticles;h++)for(k=this.vbToSort[h][0]*this.numParticleVerts*4,m=h*this.numParticleVerts*4,l=0;l<4*this.numParticleVerts;l++)this.vbCPU[m+l]=this.vbOld[k+l]}}else h.setBlending(!1),h.setColorWrite(!0,!0,!0,!0),h.setCullMode(pc.CULLFACE_NONE),h.setDepthTest(!1),h.setDepthWrite(!1),this.frameRandom.x=Math.random(),this.frameRandom.y=Math.random(),this.frameRandom.z=Math.random(),this.constantGraphSampleSize.setValue(1/this.precision),
...
new pc.Command(0,0,function(){b.clear(g._clearDepthOptions)});this.resize(c,d);this._ignoreOpacityFor=null};a.prototype.getSelection=function(a,c,d,f){var b=this.device;"object"===typeof a?(f=a,a=f.x,c=f.y,d=f.width,f=f.height):c=this.layer.renderTarget.height-(c+(f||1));d=d||1;f=f||1;var e=b.renderTarget;b.setRenderTarget(this.layer.renderTarget);b.updateBegin();var n=new Uint8Array(4*d*f);b.readPixels(a,c,d,f,n);b.updateEnd();b.setRenderTarget(e);a=[];c=this.layer.instances.visibleOpaque[0].list;
for(var l,m,b=0;b<d*f;b++)e=n[4*b+0],l=n[4*b+1],m=n[4*b+2],e=e<<16|l<<8|m,16777215!==e&&(e=c[e],-1===a.indexOf(e)&&a.push(e));return a};a.prototype.prepare=function(a,c,d){var b=this.device,g,e=this;a instanceof pc.Camera&&(a=a._component);this.scene=c;var n=null,l=null;d instanceof pc.Layer?n=d:l=d;if(!this.layer){var m=b.scope.resolve("uColor");this.layer=new pc.Layer({name:"Picker",shaderPass:pc.SHADER_PICK,opaqueSortMode:pc.SORTMODE_NONE,onEnable:function(){if(!this.renderTarget){var a=new pc.Texture(b,
...
pc.calculateNormals=function(e,a){var b=a.length/3,c=e.length/3,d,f,g,h,n=new pc.Vec3,l=new pc.Vec3,m=new pc.Vec3,k=new pc.Vec3,r=new pc.Vec3,p=new pc.Vec3,q=[];for(h=0;h<e.length;h++)q[h]=0;for(h=0;h<b;h++)d=a[3*h],f=a[3*h+1],g=a[3*h+2],n.set(e[3*d],e[3*d+1],e[3*d+2]),l.set(e[3*f],e[3*f+1],e[3*f+2]),m.set(e[3*g],e[3*g+1],e[3*g+2]),k.sub2(l,n),r.sub2(m,n),p.cross(k,r).normalize(),q[3*d]+=p.x,q[3*d+1]+=p.y,q[3*d+2]+=p.z,q[3*f]+=p.x,q[3*f+1]+=p.y,q[3*f+2]+=p.z,q[3*g]+=p.x,q[3*g+1]+=p.y,q[3*g+2]+=p.z;
for(h=0;h<c;h++)b=q[3*h],d=q[3*h+1],f=q[3*h+2],b=1/Math.sqrt(b*b+d*d+f*f),q[3*h]*=b,q[3*h+1]*=b,q[3*h+2]*=b;return q};
pc.calculateTangents=function(e,a,b,c){var d=c.length/3,f=e.length/3,g,h,n,l,m,k,r,p,q,t,w,y,x,u,v=new pc.Vec3,A=new pc.Vec3,B=new pc.Vec3,D=new pc.Vec3,z=new pc.Vec3,E=new pc.Vec2,I=new pc.Vec2,G=new pc.Vec2,H,C=new Float32Array(3*f),F=new Float32Array(3*f),J=[];for(H=0;H<d;H++)g=c[3*H],h=c[3*H+1],n=c[3*H+2],B.set(e[3*g],e[3*g+1],e[3*g+2]),D.set(e[3*h],e[3*h+1],e[3*h+2]),z.set(e[3*n],e[3*n+1],e[3*n+2]),E.set(b[2*g],b[2*g+1]),I.set(b[2*h],b[2*h+1]),G.set(b[2*n],b[2*n+1]),l=D.x-B.x,m=z.x-B.x,k=D.y-
B.y,r=z.y-B.y,p=D.z-B.z,q=z.z-B.z,t=I.x-E.x,w=G.x-E.x,y=I.y-E.y,x=G.y-E.y,u=t*x-w*y,0==u?(v.set(0,1,0),A.set(1,0,0)):(u=1/u,v.set((x*l-y*m)*u,(x*k-y*r)*u,(x*p-y*q)*u),A.set((t*m-w*l)*u,(t*r-w*k)*u,(t*q-w*p)*u)),C[3*g+0]+=v.x,C[3*g+1]+=v.y,C[3*g+2]+=v.z,C[3*h+0]+=v.x,C[3*h+1]+=v.y,C[3*h+2]+=v.z,C[3*n+0]+=v.x,C[3*n+1]+=v.y,C[3*n+2]+=v.z,F[3*g+0]+=A.x,F[3*g+1]+=A.y,F[3*g+2]+=A.z,F[3*h+0]+=A.x,F[3*h+1]+=A.y,F[3*h+2]+=A.z,F[3*n+0]+=A.x,F[3*n+1]+=A.y,F[3*n+2]+=A.z;y=new pc.Vec3;x=new pc.Vec3;e=new pc.Vec3;
b=new pc.Vec3;for(H=0;H<f;H++)e.set(a[3*H],a[3*H+1],a[3*H+2]),y.set(C[3*H],C[3*H+1],C[3*H+2]),x.set(F[3*H],F[3*H+1],F[3*H+2]),c=e.dot(y),b.copy(e).scale(c),b.sub2(y,b).normalize(),J[4*H]=b.x,J[4*H+1]=b.y,J[4*H+2]=b.z,b.cross(e,y),J[4*H+3]=0>b.dot(x)?-1:1;return J};
pc.createMesh=function(e,a,b){var c=b&&void 0!==b.normals?b.normals:null,d=b&&void 0!==b.tangents?b.tangents:null,f=b&&void 0!==b.colors?b.colors:null,g=b&&void 0!==b.uvs?b.uvs:null,h=b&&void 0!==b.uvs1?b.uvs1:null,n=b&&void 0!==b.indices?b.indices:null,l=b&&void 0!==b.blendIndices?b.blendIndices:null,m=b&&void 0!==b.blendWeights?b.blendWeights:null;b=[{semantic:pc.SEMANTIC_POSITION,components:3,type:pc.TYPE_FLOAT32}];null!==c&&b.push({semantic:pc.SEMANTIC_NORMAL,components:3,type:pc.TYPE_FLOAT32});
...
p],h[2*p+1]),null!==l&&r.element[pc.SEMANTIC_BLENDINDICES].set(l[2*p],l[2*p+1]),null!==m&&r.element[pc.SEMANTIC_BLENDWEIGHT].set(m[2*p],m[2*p+1]),r.next();r.end();c=null;if(d=null!==n)c=new pc.IndexBuffer(e,pc.INDEXFORMAT_UINT16,n.length),(new Uint16Array(c.lock())).set(n),c.unlock();e=new pc.BoundingBox;e.compute(a);a=new pc.Mesh;a.vertexBuffer=k;a.indexBuffer[0]=c;a.primitive[0].type=pc.PRIMITIVE_TRIANGLES;a.primitive[0].base=0;a.primitive[0].count=d?n.length:b;a.primitive[0].indexed=d;a.aabb=e;
return a};
pc.createTorus=function(e,a){var b=a&&void 0!==a.tubeRadius?a.tubeRadius:.2,c=a&&void 0!==a.ringRadius?a.ringRadius:.3,d=a&&void 0!==a.segments?a.segments:30,f=a&&void 0!==a.sides?a.sides:20,g,h,n,l,m,k,r,p,q,t,w=[],y=[],x=[],u=[];for(g=0;g<=f;g++)for(h=0;h<=d;h++)n=Math.cos(2*Math.PI*h/d)*(c+b*Math.cos(2*Math.PI*g/f)),l=Math.sin(2*Math.PI*g/f)*b,m=Math.sin(2*Math.PI*h/d)*(c+b*Math.cos(2*Math.PI*g/f)),k=Math.cos(2*Math.PI*h/d)*Math.cos(2*Math.PI*g/f),r=Math.sin(2*Math.PI*g/f),p=Math.sin(2*Math.PI*
h/d)*Math.cos(2*Math.PI*g/f),q=g/f,t=1-h/d,w.push(n,l,m),y.push(k,r,p),x.push(q,t),g<f&&h<d&&(n=g*(d+1)+h,l=(g+1)*(d+1)+h,m=g*(d+1)+(h+1),k=(g+1)*(d+1)+(h+1),u.push(n,l,m),u.push(l,k,m));b={normals:y,uvs:x,indices:u};pc.precalculatedTangents&&(b.tangents=pc.calculateTangents(w,y,x,u));return pc.createMesh(e,w,b)};
pc._createConeData=function(e,a,b,c,d,f){var g,h,n,l,m,k=new pc.Vec3,r=new pc.Vec3;n=new pc.Vec3;var p,q=[],t=[],w=[],y=[],x=[],u;if(0<b)for(g=0;g<=c;g++)for(h=0;h<=d;h++)u=h/d*2*Math.PI-Math.PI,p=Math.sin(u),u=Math.cos(u),m=new pc.Vec3(p*e,-b/2,u*e),l=new pc.Vec3(p*a,b/2,u*a),k.lerp(m,l,g/c),r.sub2(l,m).normalize(),p=new pc.Vec3(u,0,-p),n.cross(p,r).normalize(),q.push(k.x,k.y,k.z),t.push(n.x,n.y,n.z),l=h/d,m=g/c,w.push(l,m),p=m,m=l,l=p,l/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,m=m*primitiveUv1PaddingScale+
primitiveUv1Padding,y.push(l,m),g<c&&h<d&&(p=g*(d+1)+h,u=g*(d+1)+(h+1),l=(g+1)*(d+1)+h,m=(g+1)*(d+1)+(h+1),x.push(p,u,l),x.push(u,m,l));if(f){e=Math.floor(d/2);g=b/2;for(b=0;b<=e;b++)for(u=b*Math.PI*.5/e,p=Math.sin(u),u=Math.cos(u),k=0;k<=d;k++)f=2*k*Math.PI/d-Math.PI/2,l=Math.sin(f),f=Math.cos(f),f*=p,h=u,n=l*p,l=1-k/d,m=1-b/e,q.push(f*a,h*a+g,n*a),t.push(f,h,n),w.push(l,m),l/=3,m/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,m=m*primitiveUv1PaddingScale+primitiveUv1Padding,l+=1/3,y.push(l,
m);r=(c+1)*(d+1);for(b=0;b<e;++b)for(k=0;k<d;++k)p=b*(d+1)+k,u=p+d+1,x.push(r+p+1,r+u,r+p),x.push(r+p+1,r+u+1,r+u);for(b=0;b<=e;b++)for(u=.5*Math.PI+b*Math.PI*.5/e,p=Math.sin(u),u=Math.cos(u),k=0;k<=d;k++)f=2*k*Math.PI/d-Math.PI/2,l=Math.sin(f),f=Math.cos(f),f*=p,h=u,n=l*p,l=1-k/d,m=1-b/e,q.push(f*a,h*a-g,n*a),t.push(f,h,n),w.push(l,m),l/=3,m/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,m=m*primitiveUv1PaddingScale+primitiveUv1Padding,l+=2/3,y.push(l,m);r=(c+1)*(d+1)+(d+1)*(e+1);for(b=0;b<
e;++b)for(k=0;k<d;++k)p=b*(d+1)+k,u=p+d+1,x.push(r+p+1,r+u,r+p),x.push(r+p+1,r+u+1,r+u)}else{r=(c+1)*(d+1);if(0<e)for(g=0;g<d;g++)u=g/d*2*Math.PI,f=Math.sin(u),h=-b/2,n=Math.cos(u),l=1-(f+1)/2,m=(n+1)/2,q.push(f*e,h,n*e),t.push(0,-1,0),w.push(l,m),l/=3,m/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,m=m*primitiveUv1PaddingScale+primitiveUv1Padding,l+=1/3,y.push(l,m),1<g&&x.push(r,r+g,r+g-1);r+=d;if(0<a)for(g=0;g<d;g++)u=g/d*2*Math.PI,f=Math.sin(u),h=b/2,n=Math.cos(u),l=1-(f+1)/2,m=(n+1)/2,q.push(f*
a,h,n*a),t.push(0,1,0),w.push(l,m),l/=3,m/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,m=m*primitiveUv1PaddingScale+primitiveUv1Padding,l+=2/3,y.push(l,m),1<g&&x.push(r,r+g-1,r+g)}return{positions:q,normals:t,uvs:w,uvs1:y,indices:x}};
...
pc.createSphere=function(e,a){var b=a&&void 0!==a.radius?a.radius:.5,c=a&&void 0!==a.latitudeBands?a.latitudeBands:16,d=a&&void 0!==a.longitudeBands?a.longitudeBands:16,f,g,h,n,l,m,k,r,p,q=[],t=[],w=[],y=[];for(g=0;g<=c;g++)for(f=g*Math.PI/c,h=Math.sin(f),n=Math.cos(f),f=0;f<=d;f++)l=2*f*Math.PI/d-Math.PI/2,m=Math.sin(l),l=Math.cos(l),l*=h,k=n,m*=h,r=1-f/d,p=1-g/c,q.push(l*b,k*b,m*b),t.push(l,k,m),w.push(r,p);for(g=0;g<c;++g)for(f=0;f<d;++f)b=g*(d+1)+f,h=b+d+1,y.push(b+1,h,b),y.push(b+1,h+1,h);c=
...
pc.createPlane=function(e,a){var b=a&&void 0!==a.halfExtents?a.halfExtents:new pc.Vec2(.5,.5),c=a&&void 0!==a.widthSegments?a.widthSegments:5,d=a&&void 0!==a.lengthSegments?a.lengthSegments:5,f,g,h,n,l,m,k=[],r=[],p=[],q=[],t=0;for(f=0;f<=c;f++)for(g=0;g<=d;g++)h=-b.x+2*b.x*f/c,n=-(-b.y+2*b.y*g/d),l=f/c,m=g/d,k.push(h,0,n),r.push(0,1,0),p.push(l,m),f<c&&g<d&&(q.push(t+d+1,t+1,t),q.push(t+d+1,t+d+2,t+1)),t++;b={normals:r,uvs:p,uvs1:p,indices:q};pc.precalculatedTangents&&(b.tangents=pc.calculateTangents(k,
...
[5,0,6]],n=[[0,0,1],[0,0,-1],[0,1,0],[0,-1,0],[1,0,0],[-1,0,0]],l=[],m=[],k=[],r=[],p=[],q=0,b=function(a,b,c){var d,f,e,t;for(e=0;e<=b;e++)for(t=0;t<=c;t++){d=new pc.Vec3;f=new pc.Vec3;var w=new pc.Vec3,y=new pc.Vec3;d.lerp(g[h[a][0]],g[h[a][1]],e/b);f.lerp(g[h[a][0]],g[h[a][2]],t/c);w.sub2(f,g[h[a][0]]);y.add2(d,w);d=e/b;f=t/c;l.push(y.x,y.y,y.z);m.push(n[a][0],n[a][1],n[a][2]);k.push(d,f);d/=3;f/=3;d=d*primitiveUv1PaddingScale+primitiveUv1Padding;f=f*primitiveUv1PaddingScale+primitiveUv1Padding;
d+=a%3/3;f+=Math.floor(a/3)/3;r.push(d,f);e<b&&t<c&&(p.push(q+c+1,q+1,q),p.push(q+c+1,q+c+2,q+1));q++}};b(0,c,f);b(1,c,f);b(2,c,d);b(3,c,d);b(4,d,f);b(5,d,f);c={normals:m,uvs:k,uvs1:r,indices:p};pc.precalculatedTangents&&(c.tangents=pc.calculateTangents(l,m,k,p));return pc.createMesh(e,l,c)};pc.Scene.defaultMaterial=new pc.StandardMaterial;pc.Scene.defaultMaterial.shadingModel=pc.SPECULAR_BLINN;pc.extend(pc,function(){function e(a,b){return a.priority-b.priority}function a(a,b){return b.key-a.key}var b,c,d,f,g=[null,function(a,b){return a.drawOrder-b.drawOrder},function(a,d){b=a._key[pc.SORTKEY_FORWARD];c=d._key[pc.SORTKEY_FORWARD];return b===c&&a.mesh&&d.mesh?d.mesh.id-a.mesh.id:c-b},function(a,b){return b.zdist-a.zdist},function(a,b){return a.zdist-b.zdist}],h=0,n=function(){this.opaqueMeshInstances=[];this.transparentMeshInstances=[];this.shadowCasters=[];this.visibleOpaque=[];this.visibleTransparent=
...
(this._dirty=!0)};l.prototype.removeMeshInstances=function(a,b){var c,d,f,g,e,h,l,k=this.opaqueMeshInstances,m=this.transparentMeshInstances,n=this.shadowCasters;for(c=0;c<a.length;c++){f=a[c];g=-1;e=0;h=k.length;for(d=0;d<h;d++){l=k[d];if(l===f){g=d;e=1;break}if(l._staticSource===f)0>g&&(g=d),e++;else if(0<=g)break}0<=g&&k.splice(g,e);g=-1;e=0;h=m.length;for(d=0;d<h;d++){l=m[d];if(l===f){g=d;e=1;break}if(l._staticSource===f)0>g&&(g=d),e++;else if(0<=g)break}0<=g&&m.splice(g,e);b||(d=n.indexOf(f),
0<=d&&n.splice(d,1))}this._dirty=!0};l.prototype.clearMeshInstances=function(a){if(0!==this.opaqueMeshInstances.length||0!==this.transparentMeshInstances.length||!a&&0!==this.shadowCasters.length)this.opaqueMeshInstances.length=0,this.transparentMeshInstances.length=0,a||(this.shadowCasters.length=0),this.passThrough||(this._dirty=!0)};l.prototype.addLight=function(a){0<=this._lightComponents.indexOf(a)||(this._lightComponents.push(a),this._lights.push(a.light),this._dirtyLights=!0,this._generateLightHash())};
...
!0,c.material._dirtyBlend=!1))}for(a=0;a<f;a++)this.layerList[a]._dirty=!1,this.layerList[a]._version++}if(this._dirtyBlend){var g=g|pc.COMPUPDATED_BLEND,n,l;for(a=0;a<f;a++)if(d=this.layerList[a],!d.passThrough){e=d.opaqueMeshInstances;c=d.transparentMeshInstances;n=[];l=[];for(b=0;b<e.length;b++)e[b].material&&e[b].material.blendType!==pc.BLEND_NONE?l.push(e[b]):n.push(e[b]);for(b=0;b<c.length;b++)c[b].material&&c[b].material.blendType!==pc.BLEND_NONE?l.push(c[b]):n.push(c[b]);d.opaqueMeshInstances.length=
n.length;for(b=0;b<n.length;b++)d.opaqueMeshInstances[b]=n[b];d.transparentMeshInstances.length=l.length;for(b=0;b<l.length;b++)d.transparentMeshInstances[b]=l[b]}this._dirtyBlend=!1}this._dirty=!1;if(this._dirtyLights||g&pc.COMPUPDATED_INSTANCES)for(g|=pc.COMPUPDATED_LIGHTS,this._lights.length=0,a=this._lightShadowCasters.length=0;a<f;a++)for(d=this.layerList[a],e=d._lights,b=0;b<e.length;b++)n=e[b],c=this._lights.indexOf(n),0>c&&(this._lights.push(n),c=this._lights.length-1),(n=this._lightShadowCasters[c])||
(this._lightShadowCasters[c]=[]);if(this._dirtyLights)for(this._sortLights(this),this._dirtyLights=!1,a=0;a<f;a++)d=this.layerList[a],this._sortLights(d),d._dirtyLights=!1;if(g)for(a=0;a<f;a++)for(d=this.layerList[a],e=d._lights,b=0;b<e.length;b++)for(n=e[b],c=this._lights.indexOf(n),n=this._lightShadowCasters[c],l=d.shadowCasters,c=0;c<l.length;c++)0>n.indexOf(l[c])&&n.push(l[c]);if(g&pc.COMPUPDATED_LIGHTS||this._dirtyCameras)for(this._globalLightCameras.length=0,e=this._sortedLights[pc.LIGHTTYPE_DIRECTIONAL],
b=0;b<e.length;b++)for(n=e[b],this._globalLightCameras[b]=[],a=0;a<f;a++)if(d=this.layerList[a],!(0>d._sortedLights[pc.LIGHTTYPE_DIRECTIONAL].indexOf(n)))for(c=0;c<d.cameras.length;c++)0<=this._globalLightCameras[b].indexOf(d.cameras[c])||this._globalLightCameras[b].push(d.cameras[c]);if(this._dirtyCameras){g|=pc.COMPUPDATED_CAMERAS;for(a=this.cameras.length=0;a<f;a++)for(d=this.layerList[a],b=0;b<d.cameras.length;b++)e=d.cameras[b],c=this.cameras.indexOf(e),0>c&&this.cameras.push(e);this._renderList.length=
0;for(a=c=this._renderListCamera.length=0;a<f;a++)if(c)c--;else if(d=this.layerList[a],0!==d.cameras.length||d.isPostEffect)if(n=d._cameraHash,0===n)this._renderList.push(a),this._renderListCamera.push(0);else{e=1;for(b=a+1;b<f;b++)if(l=this.layerList[b]._cameraHash,n!==l){e=b-a-1;break}else b===f-1&&(e=b-a);if(1===e)for(n=0;n<d.cameras.length;n++)this._renderList.push(a),this._renderListCamera.push(n);else{for(n=0;n<d.cameras.length;n++)for(b=0;b<=e;b++)this._renderList.push(a+b),this._renderListCamera.push(n);
...
this._meshes[a]=g?f.call(this,g):null;this.fire("set:meshes")};b.prototype._createSimpleMesh=function(b){var c=b.rect,f=this._atlas.texture.width,g=this._atlas.texture.height,h=c.data[2]/this._pixelsPerUnit,n=c.data[3]/this._pixelsPerUnit,l=b.pivot.x;b=b.pivot.y;var m=c.data[0]/f,k=c.data[1]/g,f=(c.data[0]+c.data[2])/f,c=(c.data[1]+c.data[3])/g;return pc.createMesh(this._device,[-l*h,-b*n,0,(1-l)*h,-b*n,0,(1-l)*h,(1-b)*n,0,-l*h,(1-b)*n,0],{uvs:[m,k,f,k,f,c,m,c],normals:e,indices:a})};b.prototype._create9SliceMesh=
function(){var a=pc.Vec2.ONE,b,f,g,e,n,l,m=[],k=[],r=[],p=[],q=0;for(b=0;3>=b;b++)for(n=0===b||3===b?0:1,f=0;3>=f;f++)g=-a.x+2*a.x*(1>=b?0:3)/3,e=-(-a.y+2*a.y*(1>=f?0:3)/3),l=0===f||3===f?0:1,m.push(-g,0,e),k.push(0,1,0),r.push(n,l),3>b&&3>f&&(p.push(q+3+1,q+1,q),p.push(q+3+1,q+3+2,q+1)),q++;return pc.createMesh(this._device,m,{normals:k,uvs:r,indices:p})};b.prototype._onSetFrames=function(a){this._updatingProperties?this._meshesDirty=!0:this._createMeshes()};b.prototype._onFrameChanged=function(a,
...
0;this.looping=!0;this._interpolatedKeys=[];this._interpolatedKeyDict={};this._currKeyIndices={};this.graph=null;var d=this;b(a)};a.prototype.addTime=function(a){if(null!==this._animation){var b,d,f,g,e,n,l,m=this._animation._nodes;b=this._animation.duration;if(this._time!==b||this.looping){this._time+=a;if(this._time>b)for(this._time=this.looping?0:b,b=0;b<m.length;b++)d=m[b],f=d._name,this._currKeyIndices[f]=0;else if(0>this._time)for(this._time=this.looping?b:0,b=0;b<m.length;b++)d=m[b],f=d._name,
this._currKeyIndices[f]=d._keys.length-2;a=0<=a?1:-1;for(b=0;b<m.length;b++){d=m[b];f=d._name;d=d._keys;g=this._interpolatedKeyDict[f];l=!1;if(1!==d.length)for(var k=this._currKeyIndices[f];k<d.length-1&&0<=k;k+=a)if(e=d[k],n=d[k+1],e.time<=this._time&&n.time>=this._time){l=(this._time-e.time)/(n.time-e.time);g._pos.lerp(e.position,n.position,l);g._quat.slerp(e.rotation,n.rotation,l);g._scale.lerp(e.scale,n.scale,l);g._written=!0;this._currKeyIndices[f]=k;l=!0;break}if(1===d.length||!l&&0===this._time&&
this.looping)g._pos.copy(d[0].position),g._quat.copy(d[0].rotation),g._scale.copy(d[0].scale),g._written=!0}}}};a.prototype.blend=function(a,c,d){for(var b=this._interpolatedKeys.length,g=0;g<b;g++){var e=a._interpolatedKeys[g],n=c._interpolatedKeys[g],l=this._interpolatedKeys[g];e._written&&n._written?(l._quat.slerp(e._quat,c._interpolatedKeys[g]._quat,d),l._pos.lerp(e._pos,c._interpolatedKeys[g]._pos,d),l._scale.lerp(e._scale,n._scale,d),l._written=!0):e._written?(l._quat.copy(e._quat),l._pos.copy(e._pos),
l._scale.copy(e._scale),l._written=!0):n._written&&(l._quat.copy(n._quat),l._pos.copy(n._pos),l._scale.copy(n._scale),l._written=!0)}};Object.defineProperty(a.prototype,"animation",{get:function(){return this._animation},set:function(a){this._animation=a;this.currentTime=0}});a.prototype.getAnimation=function(){return this._animation};Object.defineProperty(a.prototype,"currentTime",{get:function(){return this._time},set:function(a){this._time=a;a=this._interpolatedKeys.length;for(var b=0;b<a;b++)this._currKeyIndices[this._interpolatedKeys[b]._name]=
...
e.prototype._enableKeyboard=function(){this._keyboard=new pc.Keyboard;if(!this._element)throw Error("Controller must be attached to an Element");this._keyboard.attach(this._element)};return{Controller:e}}());pc.extend(pc,function(){var e,a,b=new pc.Vec3,c=new pc.Vec3,d=new pc.Vec3,f=new pc.Vec3,g=new pc.Vec3,h=new pc.Vec3,n=new pc.Vec3,l=new pc.Vec3,m=new pc.Vec3,k=new pc.Vec2,r=new pc.Vec3,p=new pc.Vec3,q=new pc.Vec3,t=new pc.Vec3,w=new pc.Vec3,y=new pc.Vec3,x=new pc.Vec3,u=new pc.Vec3,v=new pc.Vec4,A=function(a,b,c){d.sub2(b,a);f.sub2(c[0],a);g.sub2(c[1],a);h.sub2(c[2],a);l.cross(h,d);if(0<=f.dot(l)){if(0>-g.dot(l)||0>m.cross(d,g).dot(f))return!1}else if(n.sub2(c[3],a),0>n.dot(l)||0>m.cross(d,f).dot(n))return!1;
return 1E-8>d.sub2(c[0],c[2]).lengthSq()||1E-8>d.sub2(c[1],c[3]).lengthSq()?!1:!0},B=function(a,b,c){this.event=a;this.element=b;this.camera=c;this._stopPropagation=!1};B.prototype={stopPropagation:function(){this._stopPropagation=!0;this.event.stopImmediatePropagation();this.event.stopPropagation()}};var D=function(a,b,c,d,f,g,e){this.x=d;this.y=f;this.ctrlKey=a.ctrlKey||!1;this.altKey=a.altKey||!1;this.shiftKey=a.shiftKey||!1;this.metaKey=a.metaKey||!1;this.button=a.button;pc.Mouse.isPointerLocked()?
(this.dx=a.movementX||a.webkitMovementX||a.mozMovementX||0,this.dy=a.movementY||a.webkitMovementY||a.mozMovementY||0):(this.dx=d-g,this.dy=f-e);this.wheel=a.detail?-1*a.detail:a.wheelDelta?a.wheelDelta/120:0},D=pc.inherits(D,B),z=function(a,b,c,d,f,g){this.touches=a.touches;this.changedTouches=a.changedTouches;this.x=d;this.y=f},z=pc.inherits(z,B),E=function(a){this._app=null;this._attached=!1;this._target=null;this._enabled=!0;this._lastY=this._lastX=0;this._upHandler=this._handleUp.bind(this);this._downHandler=
...
c,e,a)){d=e;break}}else if(this._checkElement3d(b,c,e,a)){d=e;break}}return d},_buildHitCorners:function(a,b,c,d){if(a.entity&&a.entity.button){var f=a.entity.button.hitPadding||v;r.copy(a.entity.up);p.copy(r).scale(-1);t.copy(a.entity.right);q.copy(t).scale(-1);r.scale(f.data[3]*d);p.scale(f.data[1]*d);t.scale(f.data[2]*c);q.scale(f.data[0]*c);w.copy(b[0]).add(p).add(q);y.copy(b[1]).add(p).add(t);x.copy(b[2]).add(r).add(t);u.copy(b[3]).add(r).add(q);b=[w,y,x,u]}return b},_calculateScaleToScreen:function(a){var b=
a.entity;a=a.screen.screen.scale;for(k.set(a,a);b&&!b.screen;)k.mul(b.getLocalScale()),b=b.parent;return k},_checkElement2d:function(a,d,f,g){var e=this.app.graphicsDevice.width,h=this.app.graphicsDevice.height,l=g.rect.z*e,k=g.rect.w*h,m=g.rect.x*e;g=(1-g.rect.y)*h;var n=g-k;a=a*e/this._target.clientWidth;d=d*h/this._target.clientHeight;return a>=m&&a<=m+l&&d<=g&&d>=n&&(a=e*(a-m)/l,d=h-h*(d-n)/k,e=this._calculateScaleToScreen(f),f=this._buildHitCorners(f,f.screenCorners,e.x,e.y),b.set(a,d,1),c.set(a,
d,-1),A(b,c,f))?!0:!1},_checkElement3d:function(a,d,f,g){var e=this._target.clientWidth,h=this._target.clientHeight,l=g.rect.z*e,k=g.rect.w*h,m=g.rect.x*e,n=(1-g.rect.y)*h,p=n-k,r=d;return a>=m&&a<=m+l&&d<=n&&r>=p&&(a=e*(a-m)/l,r=h*(r-p)/k,h=f.entity.getWorldTransform().getScale(),f=this._buildHitCorners(f,f.worldCorners,h.x,h.y),g.screenToWorld(a,r,g.nearClip,b),g.screenToWorld(a,r,g.farClip,c),A(b,c,f))?!0:!1}};Object.defineProperty(E.prototype,"enabled",{get:function(){return this._enabled},set:function(a){this._enabled=
a}});Object.defineProperty(E.prototype,"app",{get:function(){return this._app||pc.app},set:function(a){this._app=a}});return{ElementInput:E,ElementInputEvent:B,ElementMouseEvent:D,ElementTouchEvent:z}}());pc.extend(pc,function(){var e=function(a){pc.events.attach(this);var b=this;this.isSupported=e.isSupported;this.usesPolyfill=e.usesPolyfill;window.InitializeWebVRPolyfill&&window.InitializeWebVRPolyfill();this._index={};this.displays=[];this.display=null;this._app=a;this._onDisplayConnect=this._onDisplayConnect.bind(this);this._onDisplayDisconnect=this._onDisplayDisconnect.bind(this);b._attach();this._getDisplays(function(a,d){if(a)b.fire("error",a);else{for(var c=0;c<d.length;c++)b._addDisplay(d[c]);
...
a=this.cameras[a];for(var t,w,y,x,u=0;u<g.length;u++){t=g[u];if(t===this)break;if(t.renderTarget===q&&t.enabled&&e[u]&&(w=t.cameras.indexOf(a),!(0>w)))for(w=(y=h[u])?t.instances.visibleTransparent[w]:t.instances.visibleOpaque[w],y=w.length,w=w.list,t=0;t<y;t++)x=w[t],x.material&&x.material.depthWrite&&!x._noDepthDrawGl1&&(c[f]=x,f++)}b.length=f},onPreRenderOpaque:function(a){this.renderTarget&&this.renderTarget.width===d.graphicsDevice.width&&this.renderTarget.height===d.graphicsDevice.height||(this.onDisable(),
...
!1));this.tick=c(this)};e._currentApplication=null;e._applications={};e.getApplication=function(a){return a?e._applications[a]:e._currentApplication};var a=function(a){this.length=a;this.count=0;this.inc=function(){this.count++};this.done=function(){return this.count===this.length}};e.prototype={configure:function(a,b){var c=this;pc.http.get(a,function(a,d){if(a)b(a);else{var f=d.application_properties,g=d.scenes,e=d.assets;c._parseApplicationProperties(f,function(a){c._onVrChange(f.vr);c._parseScenes(g);
c._parseAssets(e);a?b(a):b(null)})}})},preload:function(b){var c=this;c.fire("preload:start");var d=this.assets.list({preload:!0}),e=new a(d.length),n=!1,l=function(){c.graphicsDevice&&!n&&e.done()&&(n=!0,c.fire("preload:end"),b())},m=d.length,k;if(e.length){var r=function(a){e.inc();c.fire("preload:progress",e.count/m);e.done()&&l()},p=function(a,b){e.inc();c.fire("preload:progress",e.count/m);e.done()&&l()};for(k=0;k<d.length;k++)d[k].loaded?(e.inc(),c.fire("preload:progress",e.count/m),e.done()&&
l()):(d[k].once("load",r),d[k].once("error",p),this.assets.load(d[k]))}else l()},getSceneUrl:function(a){return(a=this._sceneRegistry.find(a))?a.url:null},loadSceneHierarchy:function(a,b){this._sceneRegistry.loadSceneHierarchy(a,b)},loadSceneSettings:function(a,b){this._sceneRegistry.loadSceneSettings(a,b)},loadScene:function(a,b){this._sceneRegistry.loadScene(a,b)},_preloadScripts:function(b,c){if(pc.script.legacy){var d=this;d.systems.script.preloading=!0;var f=this._getScriptReferences(b),e=0,
l=f.length,m=new a(l),k,r=/^http(s)?:\/\//;if(l)for(var p=function(a,b){a&&console.error(a);m.inc();m.done()&&(d.systems.script.preloading=!1,c())},e=0;e<l;e++)k=f[e],!r.test(k.toLowerCase())&&d._scriptPrefix&&(k=pc.path.join(d._scriptPrefix,f[e])),this.loader.load(k,"script",p);else d.systems.script.preloading=!1,c()}else c()},_parseApplicationProperties:function(a,b){var c,d;a.useDevicePixelRatio||(a.useDevicePixelRatio=a.use_device_pixel_ratio);a.resolutionMode||(a.resolutionMode=a.resolution_mode);
...
this;this.layer.shader=l.shader;this.layer.renderTarget=l.destRenderTarget;if(!b){b=m.scope.resolve("uColorBuffer");c=m.scope.resolve("uScreenSize");for(var F=m.supportsMsaa?4:1,G=0;2>G;G++)a[G]=new pc.RenderTarget({depth:!0,stencil:m.supportsStencil,samples:F,autoResolve:!1}),a[G].name="backbuffer"+G;e.on("prerender",function(){var b=e.scene.layers.layerList,c,d,l=0,k=0;n=h=g=!1;var C=pc.PIXELFORMAT_R8_G8_B8_A8;if(e.scene.layers._dirty){var F=0,H,G;for(c=0;c<b.length;c++){d=!1;var I;if((I=b[c].isPostEffect)&&
!(I=0===F)&&(I=b[c].unmodifiedUvs&&b[c].shader)){a:{var J,N,P,ba;H=b;G=f;var O=F,U=E(b[c].shader.definition.fshader);if(0!==U.length)for(ba=0;ba<O;ba++)for(P=0;P<U.length;P++)for(I=U[P],J=E(H[G[ba]].shader.definition.fshader),N=0;N<J.length;N++)if(J[N]===I){I=!0;break a}I=!1}I=!I}I?(f[F]=c,F++,c===b.length-1&&(d=!0)):0<F&&(d=!0);if(d){if(1<F){I="post_";for(d=0;d<F;d++)J=b[f[d]],I+=J.name?J.name:J.id,d<F-1&&(I+="_");J=m.programLib._cache[I];if(!J){N="vec4 shaderOutput;\n";P="void main() {\n";ba=[];
for(d=0;d<F;d++){J=b[f[d]].shader.definition.fshader+"\n";J=J.replace(w,"//").replace(y,"//").replace(x,"//").replace(u,"shaderOutput");0<d&&(J=J.replace(v,"//").replace(A,"//").replace(B,"shaderOutput;//"));J=J.replace(D,"void main"+d);var M,fa,ga,U=J;G=ba;fa=U.length;var ca=0,da=M=0,O="";for(H=0;H<fa;H++)ga=U.charAt(H),"{"===ga?(0===M&&(ca=H),M++):"}"===ga&&(1===M&&(ga=H,O+=U.substr(da,ca-da+1),da=ga),M--);O+=U.substr(da,U.length-da+1);ca=null;da=O.match(r)||[];for(H=0;H<da.length;H++)for(U=da[H].split(","),
fa=0;fa<U.length;fa++)M=U[fa].replace(p,"").trim(),0<=G.indexOf(M)?(ca||(ca=[]),ca.push(M)):G.push(M);O=O.match(q)||[];for(H=0;H<O.length;H++)for(U=O[H].split(","),fa=0;fa<U.length;fa++)M=U[fa].replace(t,"").trim(),M=G.indexOf(M),0<=M&&G.splice(M,1);if(H=ca)for(G=0;G<H.length;G++)J=J.replace(new RegExp("\\b"+H[G]+"\\b","g"),H[G]+"NNNN"+d);N+=J;P+="main"+d+"();\n"}P+="gl_FragColor = shaderOutput;\n}\n";J=pc.shaderChunks.createShaderFromCode(m,pc.shaderChunks.fullscreenQuadVS,N+P,I)}for(d=0;d<F;d++)b[f[d]]._postEffectCombined=
d===F-1?1:-1;b[f[F-1]]._postEffectCombinedShader=J;b[f[F-1]]._postEffectCombinedBilinear=b[f[0]].postEffectBilinear;b[f[F-1]]._postEffectCombinedSrc=b[f[0]].postEffect.srcRenderTarget}f[0]=c;F=1}}}for(c=0;c<b.length;c++){if(b[c].isPostEffect&&(!b[c].postEffect.srcRenderTarget&&!b[c]._postEffectCombined||!b[c].postEffect._postEffectCombinedSrc&&0<=b[c]._postEffectCombined)){for(d=c-1;d>=l;d--)b[d].renderTarget||(b[d].renderTarget=a[k]);b[c]._backbufferRtId=k;l=c;g=!0;1===k&&(h=!0);b[c].postEffect.hdr&&
(C=m.webgl2&&m.extTextureFloatRenderable?pc.PIXELFORMAT_111110F:m.extTextureHalfFloatLinear&&m.extTextureHalfFloatRenderable?pc.PIXELFORMAT_RGBA16F:pc.PIXELFORMAT_R8_G8_B8_A8);b[c].postEffect.shader&&!b[c].renderTarget&&(k=1-k)}else b[c].isPostEffect||b[c].renderTarget||!g||(b[c].renderTarget=a[k]);b[c].isPostEffect&&!b[c].renderTarget&&(n=!0)}if(g)if(!a[0].colorBuffer)z(0,m,C);else if(a[0].width!==m.width||a[0].height!==m.height||a[0]._colorBuffer._format!==C)a[0].colorBuffer.destroy(),a[0].destroy(),
z(0,m,C);if(h)if(!a[1].colorBuffer)z(1,m,C);else if(a[1].width!==m.width||a[1].height!==m.height||a[1]._colorBuffer._format!==C)a[1].colorBuffer.destroy(),a[1].destroy(),z(1,m,C)},this);e.on("postrender",function(){var b=e.graphicsDevice;if(g&&!n){for(var c=e.scene.layers.layerList,d,f=c.length-1;0<=f&&(d=c[f].renderTarget,d!==a[0]&&d!==a[1]);f--);d&&(1<d._samples&&d.resolve(!0,!1),b.copyRenderTarget(d,null,!0,!1))}},this)}}var a=[null,null],b=null,c,d=new pc.Vec4,f=[],g=!1,h=!1,n=!1,l=/uniform[ \t\n\r]+\S+[ \t\n\r]+\S+[ \t\n\r]*\;/g,
m=/\S+[ \t\n\r]*\;/,k=/[ \t\n\r]*\;/,r=/(float|int|bool|vec2|vec3|vec4|struct)([ \t\n\r]+[^\;]+[ \t\n\r]*\,*)+\;/g,p=/(float|int|bool|vec2|vec3|vec4|struct|\,|\;|\{|\})/g,q=/(uniform|varying|in|out)[ \t\n\r]+(float|int|bool|vec2|vec3|vec4|struct)([ \t\n\r]+[^\;]+[ \t\n\r]*\,*)+\;/g,t=/(float|int|bool|vec2|vec3|vec4|struct|uniform|varying|in|out|\,|\;|\{|\})/g,w=/#version/g,y=/out highp vec4 pc_fragColor;/g,x=/#define gl_FragColor/g,u=/gl_FragColor/g,v=/uniform[ \t\n\r]+sampler2D[ \t\n\r]+uColorBuffer;/g,
A=/(varying|in)[ \t\n\r]+vec2[ \t\n\r]+vUv0;/g,B=/(texture2D|texture)[ \t\n\r]*\([ \t\n\r]*uColorBuffer/g,D=/void[ \t\n\r]+main/g,z=function(b,c,d){c=new pc.Texture(c,{format:d,width:c.width,height:c.height});c.minFilter=pc.FILTER_NEAREST;c.magFilter=pc.FILTER_NEAREST;c.addressU=pc.ADDRESS_CLAMP_TO_EDGE;c.addressV=pc.ADDRESS_CLAMP_TO_EDGE;a[b]._colorBuffer=c},E=function(a){a=a.match(l)||[];for(var b,c,d=[],f=0;f<a.length;f++)b=a[f].search(m),c=a[f].search(k),b=a[f].substr(b,c-b),"uColorBuffer"!==
...
preloading:this.preloading})},cloneComponent:function(a,c){var b,f,e=[],h={};for(b=0;b<a.script._scripts.length;b++){var n=a.script._scripts[b],l=n.__scriptType.__name;e.push(l);var m={};for(f in n.__attributes)m[f]=n.__attributes[f];h[l]={enabled:n._enabled,attributes:m}}for(f in a.script._scriptsIndex)f.awayting&&e.splice(f.ind,0,f);return this.addComponent(c,{enabled:a.script.enabled,order:e,scripts:h})},_callComponentMethod:function(a,c){for(var b=this._beginLooping(),f=0;f<this._components.length;f++)if(!this._components[f]._destroyed&&
...
if(h.name&&b){for(var n in b)b.hasOwnProperty(n)&&this._createAccessor(b[n],c);a.script.data.attributes[h.name]=this._cloneAttributes(b)}break}}},_createAccessor:function(a,c){var b=this;a={name:a.name,value:a.value,type:a.type};b._convertAttributeValue(a);Object.defineProperty(c.instance,a.name,{get:function(){return a.value},set:function(d){var f=a.value;a.value=d;b._convertAttributeValue(a);c.instance.fire("set",a.name,f,a.value)},configurable:!0})},_updateAccessors:function(a,c){var b,f=a.script.scripts.length,
e,h=c.url,n,l;for(b=0;b<f;b++)if(n=a.script,l=n.scripts[b],l.url===h){b=l.name;l=l.attributes;if(b){if(l)for(e in l)l.hasOwnProperty(e)&&this._createAccessor(l[e],c);if(f=n.data.attributes[b])for(e in f)if(h=f[e],!(e in l))delete c.instance[h.name];else if(l[e].value!==h.value&&c.instance.onAttributeChanged)c.instance.onAttributeChanged(h.name,h.value,l[e].value);l?n.data.attributes[b]=this._cloneAttributes(l):delete n.data.attributes[b]}break}},_convertAttributeValue:function(a){if("rgb"===a.type||
...
c}},onSetDistanceModel:function(a,b,c){a=this.data.slots;for(var d in a)if(b=a[d],!b.overlap){b=b.instances;for(var f=0,e=b.length;f<e;f++)b[f].distanceModel=c}},onSetPositional:function(a,b,c){a=this.data.slots;for(var d in a)if(b=a[d],!b.overlap){c=b.instances;for(var f=0,e=c.length;f<e;f++){var h=c[f].isPlaying||c[f].isSuspended,n=c[f].currentTime;h&&c[f].stop();c[f]=b._createInstance();h&&(c[f].play(),c[f].currentTime=n)}}},onEnable:function(){e._super.onEnable.call(this);if(!this.system._inTools){var a=
...
f,f);c=new Ammo.btCylinderShapeX(c);break;case 1:c=new Ammo.btVector3(f,.5*e,f);c=new Ammo.btCylinderShape(c);break;case 2:c=new Ammo.btVector3(f,f,.5*e),c=new Ammo.btCylinderShapeZ(c)}return c}});var g=function(a){},g=pc.inherits(g,a);g.prototype=pc.extend(g.prototype,{beforeInitialize:function(a,b){},createPhysicalShape:function(a,b){if("undefined"!==typeof Ammo&&b.model){var c=b.model,d=new Ammo.btCompoundShape,f,e;for(f=0;f<c.meshInstances.length;f++){var g=c.meshInstances[f],l=g.mesh,h=l.indexBuffer[pc.RENDERSTYLE_SOLID],
n=l.vertexBuffer,x=n.getFormat(),u=x.size/4,v;for(e=0;e<x.elements.length;e++){var A=x.elements[e];A.name===pc.SEMANTIC_POSITION&&(v=new Float32Array(n.lock(),A.offset))}var h=new Uint16Array(h.lock()),n=l.primitive[0].count/3,x=new Ammo.btVector3,A=new Ammo.btVector3,B=new Ammo.btVector3,D,z,E=l.primitive[0].base,I=new Ammo.btTriangleMesh;for(e=0;e<n;e++)l=h[E+3*e]*u,D=h[E+3*e+1]*u,z=h[E+3*e+2]*u,x.setValue(v[l],v[l+1],v[l+2]),A.setValue(v[D],v[D+1],v[D+2]),B.setValue(v[z],v[z+1],v[z+2]),I.addTriangle(x,
...
b[0]-a._calculatedWidth*c[0];a._margin.data[2]=a._localAnchor.data[2]-a._localAnchor.data[0]-a._calculatedWidth-a._margin.data[0];a._margin.data[1]=b[1]-a._calculatedHeight*c[1];a._margin.data[3]=a._localAnchor.data[3]-a._localAnchor.data[1]-a._calculatedHeight-a._margin.data[1];this._dirtyLocal||this._dirtify(!0)},_sync:function(){var e=this.element,g=e.screen;if(g){if(e._anchorDirty){var h,n,p=0,q=1;this._parent&&this._parent.element?(h=this._parent.element.calculatedWidth,n=this._parent.element.calculatedHeight,
p=this._parent.element.pivot.x,q=this._parent.element.pivot.y):(n=g.screen.resolution,h=n.x/g.screen.scale,n=n.y/g.screen.scale);e._anchorTransform.setTranslate(h*(e.anchor.x-p),-(n*(q-e.anchor.y)),0);e._anchorDirty=!1;e._calculateLocalAnchors()}e._sizeDirty&&e._calculateSize()}this._dirtyLocal&&(this.localTransform.setTRS(this.localPosition,this.localRotation,this.localScale),h=this.localPosition.data,p=e._pivot.data,e._margin.data[0]=h[0]-e._calculatedWidth*p[0],e._margin.data[2]=e._localAnchor.data[2]-
...
"_absBottom",{get:function(){return this._localAnchor.data[1]+this._margin.data[1]}});Object.defineProperty(h.prototype,"margin",{get:function(){return this._margin},set:function(a){this._margin.copy(a);this._calculateSize(!0,!0)}});Object.defineProperty(h.prototype,"left",{get:function(){return this._margin.data[0]},set:function(a){this._margin.data[0]=a;var b=this.entity.getLocalPosition();this._setWidth(this._absRight-(this._localAnchor.data[0]+a));b.x=a+this._calculatedWidth*this._pivot.data[0];
...
0>a&&0<=this._batchGroupId&&this.enabled&&this.entity.enabled&&(this._image._model?this.addModelToLayers(this._image._model):this._text._model&&this.addModelToLayers(this._text._model)),this._batchGroupId=a)}});var n=function(a){Object.defineProperty(h.prototype,a,{get:function(){return this._text?this._text[a]:this._image?this._image[a]:null},set:function(b){this._text?this._text[a]=b:this._image&&(this._image[a]=b)}})};n("fontSize");n("color");n("font");n("fontAsset");n("spacing");n("lineHeight");
n("wrapLines");n("lines");n("alignment");n("autoWidth");n("autoHeight");n("text");n("texture");n("textureAsset");n("material");n("materialAsset");n("sprite");n("spriteAsset");n("spriteFrame");n("pixelsPerUnit");n("opacity");n("rect");n("mask");return{ElementComponent:h}}());pc.extend(pc,function(){var e=["enabled"],a=function(a){this.id="element";this.app=a;a.systems.add(this.id,this);this.ComponentType=pc.ElementComponent;this.DataType=pc.ElementComponentData;this.schema=e;this._defaultTexture=new pc.Texture(a.graphicsDevice,{width:1,height:1,format:pc.PIXELFORMAT_R8_G8_B8_A8});a=this._defaultTexture.lock();var b=new Uint8Array(4);b[0]=255;b[1]=255;b[2]=255;b[3]=255;a.set(b);this._defaultTexture.unlock();this._maskMaterials={};this.defaultImageMaterial=new pc.StandardMaterial;
...
0;this._lineWidths=[];this._lineContents=[];var n=d.length,l=0,m=0,k=0,r=1,p=0,q=0,t=0,w=0,y=0,x=1E-4<=Math.abs(this._element.anchor.x-this._element.anchor.z),u=this._element.calculatedWidth;if(this.autoWidth&&!x||!this._wrapLines)u=Number.POSITIVE_INFINITY;var v=0,x=0,A=1,B,D,z,E;for(D in e.chars)z=e.chars[D],A=z.height/32*this._fontSize/z.height,z.bounds&&(v=Math.min(v,z.bounds[1]*A),x=Math.max(x,z.bounds[3]*A));for(E=0;E<this._meshInfo.length;E++)this._meshInfo[E].quad=0,this._meshInfo[E].lines=
{};for(E=0;E<n;E++){B=d.charAt(E);D=d.charCodeAt(E);var I=0,G=0,H=0,C=1,F=A=0;(z=e.chars[D])&&z.scale?(I=(z.width+z.height)/2,A=I/32*this._fontSize/I,C=I/32*this._fontSize/z.scale,H=z.xadvance*A,I=z.xoffset*A,G=z.yoffset*A,z.bounds?(F=(z.bounds[2]-z.bounds[0])*A,A*=z.bounds[0]):(F=I,A=0)):(H=1,G=I=0,C=this._fontSize);var J=a.test(B),Y=c.test(B),X=b.test(B);if(J)f(E,m),q=E+1,t=E+1;else{B=this._meshInfo[z&&z.map||0];if(l+F+A>=u&&0<y&&!X)if(0===w)q=E,f(E,m);else{z=Math.max(E-q,0);E-=z+1;B.lines[r-1]-=
z;B.quad-=z;f(q,p);continue}z=B.quad;B.lines[r-1]=z;B.positions[12*z+0]=l-I;B.positions[12*z+1]=k-G;B.positions[12*z+2]=0;B.positions[12*z+3]=l-I+C;B.positions[12*z+4]=k-G;B.positions[12*z+5]=0;B.positions[12*z+6]=l-I+C;B.positions[12*z+7]=k-G+C;B.positions[12*z+8]=0;B.positions[12*z+9]=l-I;B.positions[12*z+10]=k-G+C;B.positions[12*z+11]=0;this.width=Math.max(this.width,l+F+A);this.height=Math.max(this.height,x-(k+v));l+=this._spacing*H;X||J||(m=l);Y&&(w++,p=m,q=E+1);y++;D=this._getUv(D);B.uvs[8*
z+0]=D[0];B.uvs[8*z+1]=D[1];B.uvs[8*z+2]=D[2];B.uvs[8*z+3]=D[1];B.uvs[8*z+4]=D[2];B.uvs[8*z+5]=D[3];B.uvs[8*z+6]=D[0];B.uvs[8*z+7]=D[3];B.quad++}}t<n&&f(n,l);this._noResize=!0;this.autoWidth=this._autoWidth;this.autoHeight=this._autoHeight;this._noResize=!1;e=this._element.pivot.data[0];n=this._element.pivot.data[1];m=this._alignment.x;q=this._alignment.y;for(E=0;E<this._meshInfo.length;E++)if(0!==this._meshInfo[E].count){z=0;for(var V in this._meshInfo[E].lines){u=this._meshInfo[E].lines[V];v=-e*
this._element.calculatedWidth+m*(this._element.calculatedWidth-this._lineWidths[parseInt(V,10)]);for(D=(1-n)*this._element.calculatedHeight-x-(1-q)*(this._element.calculatedHeight-this.height);z<=u;z++)this._meshInfo[E].positions[12*z]+=v,this._meshInfo[E].positions[12*z+3]+=v,this._meshInfo[E].positions[12*z+6]+=v,this._meshInfo[E].positions[12*z+9]+=v,this._meshInfo[E].positions[12*z+1]+=D,this._meshInfo[E].positions[12*z+4]+=D,this._meshInfo[E].positions[12*z+7]+=D,this._meshInfo[E].positions[12*
z+10]+=D;z=u+1}z=4*this._meshInfo[E].quad;u=new pc.VertexIterator(this._meshInfo[E].meshInstance.mesh.vertexBuffer);for(v=0;v<z;v++)u.element[pc.SEMANTIC_POSITION].set(this._meshInfo[E].positions[3*v+0],this._meshInfo[E].positions[3*v+1],this._meshInfo[E].positions[3*v+2]),u.element[pc.SEMANTIC_TEXCOORD0].set(this._meshInfo[E].uvs[2*v+0],this._meshInfo[E].uvs[2*v+1]),u.next();u.end();this._meshInfo[E].meshInstance.mesh.aabb.compute(this._meshInfo[E].positions);this._meshInfo[E].meshInstance._aabbVer=
...
a[1]);this._font&&this._updateText()}});Object.defineProperty(e.prototype,"autoWidth",{get:function(){return this._autoWidth},set:function(a){(this._autoWidth=a)&&1E-4>Math.abs(this._element.anchor.x-this._element.anchor.z)&&(this._element.width=this.width)}});Object.defineProperty(e.prototype,"autoHeight",{get:function(){return this._autoHeight},set:function(a){(this._autoHeight=a)&&1E-4>Math.abs(this._element.anchor.y-this._element.anchor.w)&&(this._element.height=this.height)}});return{TextElement:e}}());pc.extend(pc,function(){var e=new pc.Vec2,a=new pc.Vec3,b=new pc.Vec3,c=new pc.Vec3,d=new pc.Vec3,f=new pc.Vec3,g=new pc.Quat,h={x:"y",y:"x"},n=function(a,b){if(!(a&&a instanceof pc.ElementComponent))throw Error("Element was null or not an ElementComponent");if(b&&"x"!==b&&"y"!==b)throw Error("Unrecognized axis: "+b);this._element=a;this._app=a.system.app;this._axis=b||null;this._enabled=!0;this._dragScale=new pc.Vec3;this._dragStartMousePosition=new pc.Vec3;this._dragStartHandlePosition=new pc.Vec3;
this._deltaMousePosition=new pc.Vec3;this._deltaHandlePosition=new pc.Vec3;this._isDragging=!1;pc.events.attach(this);this._toggleLifecycleListeners("on")};pc.extend(n.prototype,{_toggleLifecycleListeners:function(a){this._element[a]("mousedown",this._onMouseDownOrTouchStart,this);this._element[a]("touchstart",this._onMouseDownOrTouchStart,this)},_toggleDragListeners:function(a){var b="on"===a,c=b?"addEventListener":"removeEventListener";this._hasDragListeners&&b||(this._handleMouseUpOrTouchEnd||
...
this._element.screen.screen.screenSpace?(b.set(e.x,-e.y,0),c.set(0,0,-1)):(a.copy(this._dragCamera.screenToWorld(e.x,e.y,1)),b.copy(this._dragCamera.entity.getPosition()),c.copy(a).sub(b).normalize())},_calculateDragScale:function(){var a=this._element.entity,b=this._element.screen&&this._element.screen.screen,c=b&&b.screenSpace,b=c?b.scale:1,d=this._dragScale;for(d.set(b,b,b);a&&(d.mul(a.getLocalScale()),a=a.parent,!c||!a.screen););d.data[0]=1/d.data[0];d.data[1]=1/d.data[1];d.data[2]=1/d.data[2]},
...
this.fire("drag:move",this._deltaHandlePosition)}},destroy:function(){this._toggleLifecycleListeners("off");this._toggleDragListeners("off")}});Object.defineProperty(n.prototype,"enabled",{get:function(){return this._enabled},set:function(a){this._enabled=a}});Object.defineProperty(n.prototype,"isDragging",{get:function(){return this._isDragging}});return{ElementDragHelper:n}}());pc.extend(pc,{BUTTON_TRANSITION_MODE_TINT:0,BUTTON_TRANSITION_MODE_SPRITE_CHANGE:1});pc.extend(pc,function(){var e={DEFAULT:"_defaultTint",HOVER:"hoverTint",PRESSED:"pressedTint",INACTIVE:"inactiveTint"},a={DEFAULT:"_defaultSpriteAsset",HOVER:"hoverSpriteAsset",PRESSED:"pressedSpriteAsset",INACTIVE:"inactiveSpriteAsset"},b={DEFAULT:"_defaultSpriteFrame",HOVER:"hoverSpriteFrame",PRESSED:"pressedSpriteFrame",INACTIVE:"inactiveSpriteFrame"},c=function(a,b){this._visualState="DEFAULT";this._isPressed=this._isHovering=!1;this._imageEntity=null;this._defaultTint=new pc.Color(1,1,1,1);this._defaultSpriteAsset=
...
this.schema=e;this.on("beforeremove",this._onRemoveComponent,this)},a=pc.inherits(a,pc.ComponentSystem);pc.Component._buildAccessors(pc.ButtonComponent.prototype,e);pc.extend(a.prototype,{initializeComponentData:function(b,c,d){a._super.initializeComponentData.call(this,b,c,e)},_onRemoveComponent:function(a,c){c.onRemove()}});return{ButtonComponentSystem:a}}());pc.extend(pc,function(){return{ButtonComponentData:pc.inherits(function(){this.enabled=!0},pc.ComponentData)}}());pc.extend(pc,{SCROLL_MODE_CLAMP:0,SCROLL_MODE_BOUNCE:1,SCROLL_MODE_INFINITE:2,SCROLLBAR_VISIBILITY_SHOW_ALWAYS:0,SCROLLBAR_VISIBILITY_SHOW_WHEN_REQUIRED:1});pc.extend(pc,function(){var e=new pc.Vec2,a=function(a,c){this._viewportReference=new pc.EntityReference(this,"viewportEntity",{"element#gain":this._onViewportElementGain,"element#resize":this._onSetContentOrViewportSize});this._contentReference=new pc.EntityReference(this,"contentEntity",{"element#gain":this._onContentElementGain,"element#lose":this._onContentElementLose,"element#resize":this._onSetContentOrViewportSize});this._scrollbarUpdateFlags={};this._scrollbarReferences={};this._scrollbarReferences[pc.ORIENTATION_HORIZONTAL]=
...
a=pc.inherits(a,pc.Component);pc.extend(a.prototype,{_toggleLifecycleListeners:function(a,c){this[a]("set_horizontal",this._onSetHorizontalScrollingEnabled,this);this[a]("set_vertical",this._onSetVerticalScrollingEnabled,this);pc.ComponentSystem[a]("update",this._onUpdate,this);c.app.systems.element[a]("add",this._onElementComponentAdd,this);c.app.systems.element[a]("beforeremove",this._onElementComponentRemove,this)},_toggleElementListeners:function(a){!this.entity.element||"on"===a&&this._hasElementListeners||
...
this.system);this._toggleElementListeners("off");this._destroyDragHelper()}});Object.defineProperty(a.prototype,"scroll",{get:function(){return this._scroll},set:function(a){this._onSetScroll(a.x,a.y)}});return{ScrollViewComponent:a}}());pc.extend(pc,function(){var e=[{name:"enabled",type:"boolean"},{name:"horizontal",type:"boolean"},{name:"vertical",type:"boolean"},{name:"scrollMode",type:"number"},{name:"bounceAmount",type:"number"},{name:"friction",type:"number"},{name:"horizontalScrollbarVisibility",type:"number"},{name:"verticalScrollbarVisibility",type:"number"},{name:"viewportEntity",type:"entity"},{name:"contentEntity",type:"entity"},{name:"horizontalScrollbarEntity",type:"entity"},{name:"verticalScrollbarEntity",type:"entity"}],
a=function(a){this.id="scrollview";this.app=a;a.systems.add(this.id,this);this.ComponentType=pc.ScrollViewComponent;this.DataType=pc.ScrollViewComponentData;this.schema=e;this.on("beforeremove",this._onRemoveComponent,this)},a=pc.inherits(a,pc.ComponentSystem);pc.Component._buildAccessors(pc.ScrollViewComponent.prototype,e);pc.extend(a.prototype,{initializeComponentData:function(b,c,d){a._super.initializeComponentData.call(this,b,c,e)},_onRemoveComponent:function(a,c){c.onRemove()}});return{ScrollViewComponentSystem:a}}());pc.extend(pc,function(){return{ScrollViewComponentData:pc.inherits(function(){this.enabled=!0},pc.ComponentData)}}());pc.extend(pc,function(){var e=function(a,b){this._app=a.app;this._handleReference=new pc.EntityReference(this,"handleEntity",{"element#gain":this._onHandleElementGain,"element#lose":this._onHandleElementLose});this._toggleLifecycleListeners("on")},e=pc.inherits(e,pc.Component);pc.extend(e.prototype,{_toggleLifecycleListeners:function(a){this[a]("set_value",this._onSetValue,this);this[a]("set_handleSize",this._onSetHandleSize,this)},_onHandleElementGain:function(){this._destroyDragHelper();this._handleDragHelper=
new pc.ElementDragHelper(this._handleReference.entity.element,this._getAxis());this._handleDragHelper.on("drag:move",this._onHandleDrag,this);this._updateHandlePositionAndSize()},_onHandleElementLose:function(){this._destroyDragHelper()},_onHandleDrag:function(a){this._handleReference.entity&&this.enabled&&this.entity.enabled&&(this.value=this._handlePositionToScrollValue(a[this._getAxis()]))},_onSetValue:function(a,b,c){1E-5<Math.abs(c-b)&&(this.data.value=pc.math.clamp(c,0,1),this._updateHandlePositionAndSize(),
this.fire("set:value",this.data.value))},_onSetHandleSize:function(a,b,c){1E-5<Math.abs(c-b)&&(this.data.handleSize=pc.math.clamp(c,0,1),this._updateHandlePositionAndSize())},_updateHandlePositionAndSize:function(){var a=this._handleReference.entity,b=a&&a.element;a&&(a=a.getLocalPosition(),a[this._getAxis()]=this._getHandlePosition(),this._handleReference.entity.setLocalPosition(a));b&&(b[this._getDimension()]=this._getHandleLength())},_handlePositionToScrollValue:function(a){return a*this._getSign()/
this._getUsableTrackLength()},_scrollValueToHandlePosition:function(a){return a*this._getSign()*this._getUsableTrackLength()},_getUsableTrackLength:function(){return Math.max(this._getTrackLength()-this._getHandleLength(),.001)},_getTrackLength:function(){return this.entity.element?this.orientation===pc.ORIENTATION_HORIZONTAL?this.entity.element.calculatedWidth:this.entity.element.calculatedHeight:0},_getHandleLength:function(){return this._getTrackLength()*this.handleSize},_getHandlePosition:function(){return this._scrollValueToHandlePosition(this.value)},
_getSign:function(){return this.orientation===pc.ORIENTATION_HORIZONTAL?1:-1},_getAxis:function(){return this.orientation===pc.ORIENTATION_HORIZONTAL?"x":"y"},_getDimension:function(){return this.orientation===pc.ORIENTATION_HORIZONTAL?"width":"height"},_destroyDragHelper:function(){this._handleDragHelper&&this._handleDragHelper.destroy()},_setHandleDraggingEnabled:function(a){this._handleDragHelper&&(this._handleDragHelper.enabled=a)},onEnable:function(){this._setHandleDraggingEnabled(!0)},onDisable:function(){this._setHandleDraggingEnabled(!1)},
onRemove:function(){this._destroyDragHelper();this._toggleLifecycleListeners("off")}});return{ScrollbarComponent:e}}());pc.extend(pc,function(){var e=[{name:"enabled",type:"boolean"},{name:"orientation",type:"number"},{name:"value",type:"number"},{name:"handleSize",type:"number"},{name:"handleEntity",type:"entity"}],a=function(a){this.id="scrollbar";this.app=a;a.systems.add(this.id,this);this.ComponentType=pc.ScrollbarComponent;this.DataType=pc.ScrollbarComponentData;this.schema=e;this.on("beforeremove",this._onRemoveComponent,this)},a=pc.inherits(a,pc.ComponentSystem);pc.Component._buildAccessors(pc.ScrollbarComponent.prototype,
e);pc.extend(a.prototype,{initializeComponentData:function(b,c,d){a._super.initializeComponentData.call(this,b,c,e)},_onRemoveComponent:function(a,c){c.onRemove()}});return{ScrollbarComponentSystem:a}}());pc.extend(pc,function(){return{ScrollbarComponentData:pc.inherits(function(){this.enabled=!0},pc.ComponentData)}}());pc.extend(pc,{FITTING_NONE:0,FITTING_STRETCH:1,FITTING_SHRINK:2,FITTING_BOTH:3});pc.extend(pc,function(){function e(a){return a.element}function a(a){return a.enabled&&a.element&&a.element.enabled}function b(a){var b="_"+a;Object.defineProperty(c.prototype,a,{get:function(){return this[b]},set:function(a){this[b]!==a&&(this[b]=a,this._scheduleReflow())}})}var c=function(a,b){this._orientation=pc.ORIENTATION_HORIZONTAL;this._reverseX=!1;this._reverseY=!0;this._alignment=new pc.Vec2(0,1);this._padding=new pc.Vec4;this._spacing=new pc.Vec2;this._heightFitting=this._widthFitting=
...
[]}},_onRemoveComponent:function(a,c){c.onRemove()}});return{LayoutGroupComponentSystem:a}}());pc.extend(pc,function(){return{LayoutGroupComponentData:pc.inherits(function(){this.enabled=!0},pc.ComponentData)}}());pc.extend(pc,function(){function e(){}function a(a){function e(a){a=a.entity.layoutchild;return!a||!a.enabled||!a.excludeFromLayout}function h(a,b,c){switch(a){case pc.FITTING_NONE:return f.NONE;case pc.FITTING_STRETCH:return b<c?f.APPLY_STRETCHING:f.NONE;case pc.FITTING_SHRINK:return b>=c?f.APPLY_SHRINKING:f.NONE;case pc.FITTING_BOTH:return b<c?f.APPLY_STRETCHING:b>=c?f.APPLY_SHRINKING:f.NONE;default:throw Error("Unrecognized fitting mode: "+a);}}function k(a,b){return y(a,b.size)+(a.length-1)*D.spacing[b.axis]}
function n(a,b,c){var d=u(a,c.maxSize),f=x(a,c.fittingProportion),e=B(f,d);b=g[c.axis]-b;for(var h=0;h<a.length;++h){var k=d[h],l=q(k,b,f,e),m=a[k][c.size]+l,n=Math.min(m,a[k][c.maxSize]);a[k][c.size]=n;b-=l-Math.max(m-n,0)}}function p(a,b,c){var d=u(a,c.minSize,!0),f;f=x(a,c.fittingProportion);if(1===f.length)f=[1];else{for(var e=[],h=f.length,k=0;k<h;++k)e.push((1-f[k])/(h-1));f=e}e=B(f,d);b-=g[c.axis];for(h=0;h<a.length;++h){var k=d[h],l=q(k,b,f,e),m=a[k][c.size]-l,n=Math.max(m,a[k][c.minSize]);
a[k][c.size]=n;b-=l-Math.max(n-m,0)}}function q(a,b,c,d){c=c[a];a=d[a];return 1E-5>Math.abs(c)&&1E-5>Math.abs(a)?b:b*c/a}function t(a){for(var b=[],c=0;c<a.length;++c){var d=a[c],f=Math.max(w(d,"minWidth"),0),e=Math.max(w(d,"minHeight"),0),g=Math.max(w(d,"maxWidth"),f),h=Math.max(w(d,"maxHeight"),e),k;k=w(d,"width");k=Math.min(Math.max(k,f),g);var l;l=w(d,"height");l=Math.min(Math.max(l,e),h);var m=w(d,"fitWidthProportion"),d=w(d,"fitHeightProportion");b.push({minWidth:f,minHeight:e,maxWidth:g,maxHeight:h,
width:k,height:l,fitWidthProportion:m,fitHeightProportion:d})}return b}function w(a,b){var c=a.entity.layoutchild;return c&&c.enabled&&void 0!==c[b]&&null!==c[b]?c[b]:void 0!==a[b]?a[b]:d[b]}function y(a,b){return a.reduce(function(a,c){return a+c[b]},0)}function x(a,b){var c=y(a,b),d=[],f=a.length,e;if(0===c)for(e=0;e<f;++e)d.push(1/f);else for(e=0;e<f;++e)d.push(a[e][b]/c);return d}function u(a,b,c){a.forEach(v);return a.slice().sort(function(a,d){return c?d[b]-a[b]:a[b]-d[b]}).map(A)}function v(a,
b){a.index=b}function A(a){return a.index}function B(a,b){var c=[];c[b[a.length-1]]=a[b[a.length-1]];for(var d=a.length-2;0<=d;--d)c[b[d]]=c[b[d+1]]+a[b[d]];return c}var D,z=b[a],E=b[c[a]];return function(a,b){a=a.filter(e);D=b;g.x=D.containerSize.x-D.padding.data[0]-D.padding.data[2];g.y=D.containerSize.y-D.padding.data[1]-D.padding.data[3];for(var c=a,d=0;d<c.length;++d){var l=c[d],m=l.anchor.data;if(0!==m[0]||0!==m[1]||0!==m[2]||0!==m[3])l.anchor=[0,0,0,0]}c=a;if(D.wrap){for(var d=[[]],l=t(c),
m=0,r=D[z.fitting]===pc.FITTING_SHRINK,q=0;q<c.length;++q){0<d[d.length-1].length&&(m+=D.spacing[z.axis]);var u=l[q][z.size],m=m+u;!r&&m>g[z.axis]&&0!==d[d.length-1].length&&(m=u,d.push([]));d[d.length-1].push(c[q]);r&&m>g[z.axis]&&q!==c.length-1&&(m=0,d.push([]))}c=d}else c=[c];d=D.orientation===pc.ORIENTATION_HORIZONTAL&&D.reverseX||D.orientation===pc.ORIENTATION_VERTICAL&&D.reverseY;l=D.orientation===pc.ORIENTATION_HORIZONTAL&&D.reverseY||D.orientation===pc.ORIENTATION_VERTICAL&&D.reverseX;if(d)for(m=
0;m<c.length;++m)d&&c[m].reverse();l&&c.reverse();d=[];for(l=0;l<c.length;++l)m=t(c[l]),r=k(m,z),q=h(D[z.fitting],r,g[z.axis]),q===f.APPLY_STRETCHING?n(m,r,z):q===f.APPLY_SHRINKING&&p(m,r,z),d.push(m);u=[];q=[];for(m=0;m<c.length;++m){r=c[m];r.largestElement=null;r.largestSize={width:Number.NEGATIVE_INFINITY,height:Number.NEGATIVE_INFINITY};for(l=0;l<r.length;++l){var w=d[m][l];w[E.size]>r.largestSize[E.size]&&(r.largestElement=r[l],r.largestSize=w)}u.push(r.largestElement);q.push(r.largestSize)}l=
k(q,E);m=h(D[E.fitting],l,g[E.axis]);m===f.APPLY_STRETCHING?n(q,l,E):m===f.APPLY_SHRINKING&&p(q,l,E);for(m=0;m<c.length;++m)for(r=c[m],l=0;l<r.length;++l)q=d[m][l],u=1===c.length?g[E.axis]:r.largestSize[E.size],w=h(D[E.fitting],q[E.size],u),w===f.APPLY_STRETCHING?q[E.size]=Math.min(u,q[E.maxSize]):w===f.APPLY_SHRINKING&&(q[E.size]=Math.max(u,q[E.minSize]));a:{l={};l[z.axis]=0;l[E.axis]=0;c[z.size]=Number.NEGATIVE_INFINITY;m=[];for(r=0;r<c.length;++r){q=c[r];if(0===q.length){l=void 0;break a}for(var u=
[],w=d[r],v=0;v<q.length;++v){var x=q[v],y=w[v];l[E.axis]-=-y[E.size]*x.pivot[E.axis];l[z.axis]-=-y[z.size]*x.pivot[z.axis];u[v]={};u[v][z.axis]=l[z.axis];u[v][E.axis]=l[E.axis];l[E.axis]+=-y[E.size]*x.pivot[E.axis];l[z.axis]+=y[z.size]*(1-x.pivot[z.axis])+D.spacing[z.axis]}q[z.size]=l[z.axis]-D.spacing[z.axis];q[E.size]=q.largestSize[E.size];c[z.size]=Math.max(c[z.size],q[z.size]);l[z.axis]=0;l[E.axis]+=q[E.size]+D.spacing[E.axis];m.push(u)}c[E.size]=l[E.axis]-D.spacing[E.axis];l=m}m=l;r=D.alignment[z.axis];
q=D.alignment[E.axis];u=D.padding[z.axis];w=D.padding[E.axis];for(v=0;v<c.length;++v)for(var x=c[v],y=d[v],A=m[v],B=(g[z.axis]-x[z.size])*r+u,G=(g[E.axis]-c[E.size])*q+w,I=0;I<x.length;++I){var N=(x[E.size]-y[I][E.size])*D.alignment[E.axis];A[I][z.axis]+=B;A[I][E.axis]+=G+N}for(m=0;m<c.length;++m)for(r=c[m],q=d[m],u=l[m],w=0;w<r.length;++w)v=r[w],v[z.calculatedSize]=q[w][z.size],v[E.calculatedSize]=q[w][E.size],D.orientation===pc.ORIENTATION_HORIZONTAL?v.entity.setLocalPosition(u[w][z.axis],u[w][E.axis],
v.entity.getLocalPosition().z):v.entity.setLocalPosition(u[w][E.axis],u[w][z.axis],v.entity.getLocalPosition().z);d=c.width;c=c.height;return{bounds:new pc.Vec4((g.x-d)*D.alignment.x+D.padding.x,(g.y-c)*D.alignment.y+D.padding.y,d,c)}}}var b={};b[pc.ORIENTATION_HORIZONTAL]={axis:"x",size:"width",calculatedSize:"calculatedWidth",minSize:"minWidth",maxSize:"maxWidth",fitting:"widthFitting",fittingProportion:"fitWidthProportion"};b[pc.ORIENTATION_VERTICAL]={axis:"y",size:"height",calculatedSize:"calculatedHeight",
...
a[f.getGuid()]=e.getGuid()}}return d};return{Entity:a}}());pc.extend(pc,function(){function e(a,b,c){if(a&&a instanceof pc.Component){if(!b||"string"!==typeof b)throw Error("The propertyName argument is required and must be a string");if(c&&"object"!==typeof c)throw Error("If provided, the eventConfig argument must be an object");}else throw Error("The parentComponent argument is required and must be a Component");this._parentComponent=a;this._entityPropertyName=b;this._entity=null;this._app=a.system.app;this._configureEventListeners(c||{},{"entity#destroy":this._onEntityDestroy});
this._toggleLifecycleListeners("on")}pc.extend(e.prototype,{_configureEventListeners:function(a,b){var c=this._parseEventListenerConfig(a,"external",this._parentComponent),d=this._parseEventListenerConfig(b,"internal",this);this._eventListenerConfigs=c.concat(d);this._listenerStatusFlags={};this._gainListeners={};this._loseListeners={}},_parseEventListenerConfig:function(a,b,c){return Object.keys(a).map(function(d,f){var e=d.split("#"),h=e[0],n=e[1],l=a[d];if(2!==e.length||"string"!==typeof h||0===
h.length||"string"!==typeof n||0===n.length)throw Error("Invalid event listener description: `"+d+"`");if("function"!==typeof l)throw Error("Invalid or missing callback for event listener `"+d+"`");return{id:b+"_"+f+"_"+d,sourceName:h,eventName:n,callback:l,scope:c}},this)},_toggleLifecycleListeners:function(a){this._parentComponent[a]("set_"+this._entityPropertyName,this._onSetEntityGuid,this);this._parentComponent.system[a]("beforeremove",this._onParentComponentRemove,this);pc.ComponentSystem[a]("postInitialize",
this._onPostInitialize,this);for(var b=[],c=0;c<this._eventListenerConfigs.length;++c){var d=this._eventListenerConfigs[c],f=this._app.systems[d.sourceName];f&&(-1===b.indexOf(f)&&b.push(f),f&&"gain"===d.eventName&&(this._gainListeners[d.sourceName]=d),f&&"lose"===d.eventName&&(this._loseListeners[d.sourceName]=d))}for(c=0;c<b.length;++c)b[c][a]("add",this._onComponentAdd,this),b[c][a]("beforeremove",this._onComponentRemove,this)},_onSetEntityGuid:function(a,b,c){null!==c&&void 0!==c&&"string"!==
typeof c?console.warn("Entity field `"+this._entityPropertyName+"` was set to unexpected type '"+typeof c+"'"):b!==c&&this._updateEntityReference()},_onPostInitialize:function(){this._updateEntityReference()},_updateEntityReference:function(){var a=this._parentComponent.data[this._entityPropertyName],a=a?this._parentComponent.system.app.root.findByGuid(a):null;this._entity!==a&&(this._entity&&this._onBeforeEntityChange(),(this._entity=a)&&this._onAfterEntityChange())},_onBeforeEntityChange:function(){this._toggleEntityListeners("off");
this._callAllGainOrLoseListeners(this._loseListeners)},_onAfterEntityChange:function(){this._toggleEntityListeners("on");this._callAllGainOrLoseListeners(this._gainListeners)},_onComponentAdd:function(a,b){var c=b.system.name;a===this._entity&&(this._callGainOrLoseListener(c,this._gainListeners),this._toggleComponentListeners("on",c))},_onComponentRemove:function(a,b){var c=b.system.name;a===this._entity&&(this._callGainOrLoseListener(c,this._loseListeners),this._toggleComponentListeners("off",c,
!0))},_callAllGainOrLoseListeners:function(a){for(var b in this._entity.c)this._callGainOrLoseListener(b,a)},_callGainOrLoseListener:function(a,b){if(this._entity.c.hasOwnProperty(a)&&b[a]){var c=b[a];c.callback.call(c.scope)}},_toggleEntityListeners:function(a,b){if(this._entity)for(var c=0;c<this._eventListenerConfigs.length;++c)this._safeToggleListener(a,this._eventListenerConfigs[c],b)},_toggleComponentListeners:function(a,b,c){for(var d=0;d<this._eventListenerConfigs.length;++d){var f=this._eventListenerConfigs[d];
...
e=d.lock(),l=0;4>l;l++)for(var m=0;4>m;m++)e[4*l+m]=b[c][m];d.unlock()}},_createParameters:function(a){var b=[];a.shadingModel||(a.shadingModel="blinn"===a.shader?pc.SPECULAR_BLINN:pc.SPECULAR_PHONG);var c=a.shader;delete a.shader;for(var d in a)a.hasOwnProperty(d)&&b.push({name:d,type:e[d],data:a[d]});a.shader=c;a.parameters=b},patch:function(a,b){void 0===a.data.shader&&(a.data=a.resource._data,delete a.resource._data);this._updateStandardMaterial(a,a.data,b);a.off("change",this._onAssetChange,
this);a.on("change",this._onAssetChange,this);a.on("unload",this._onAssetUnload,this)},_onAssetChange:function(a,b,c){"data"===b&&this._updateStandardMaterial(a,c,this._assets)},_onAssetUnload:function(a){delete a.data.parameters;delete a.data.chunks;delete a.data.name},_updateStandardMaterial:function(d,e,h){var f=d.resource,g;d.file&&(g=pc.path.getDirectory(d.getFileUrl()));e.name=d.name;e.parameters||this._createParameters(e);var m="path"===e.mapping_format;e.chunks=d.resource.chunks;e.parameters.forEach(function(k,
l){var n;if("texture"===k.type){f._assetHandlers||(f._assetHandlers={});var q=f._assetHandlers[k.name];if(!k.data||k.data instanceof pc.Texture)q&&!k.data&&(h.off("load:"+q.id,q.bind),h.off("add:"+q.id,q.add),h.off("remove:"+q.id,q.remove),q.url&&(h.off("add:url:"+q.url,q.add),h.off("remove:url:"+q.url,q.remove)),f._assetHandlers[k.name]=null);else if(m?d=h.getByUrl(pc.path.join(g,k.data)):(n=k.data,d=h.get(k.data)),q&&(h.off("load:"+q.id,q.bind),h.off("add:"+q.id,q.add),h.off("remove:"+q.id,q.remove),
q.url&&(h.off("add:url:"+q.url,q.add),h.off("remove:url:"+q.url,q.remove)),f._assetHandlers[k.name]=null),q=f._assetHandlers[k.name]={id:n,url:m?pc.path.join(g,k.data):"",bind:function(a){e.parameters[l].data=a.resource;f[e.parameters[l].name]=a.resource;f.update()},add:function(a){h.load(a)},remove:function(a){f[e.parameters[l].name]===a.resource&&(e.parameters[l].data=null,f[e.parameters[l].name]=null,f.update())}},n?(h.on("load:"+n,q.bind),h.on("remove:"+n,q.remove)):m&&(h.on("load:url:"+pc.path.join(g,
k.data),q.bind),h.on("remove:url:"+pc.path.join(g,k.data),q.remove)),d)d.resource?q.bind(d):b[e.parameters[l].name]&&(n=a[b[e.parameters[l].name]])&&(e.parameters[l].data=n,f[e.parameters[l].name]=n),h.load(d);else if(n)h.once("add:"+n,q.add);else if(m)h.once("add:url:"+q.url,q.add)}else if("cubemap"===k.type&&k.data&&!(k.data instanceof pc.Texture)){m?d=h.getByUrl(pc.path.join(g,k.data)):(n=k.data,d=h.get(k.data));var r=function(a){k.data=a.resource;1<a.resources.length&&(e.parameters.push({name:"prefilteredCubeMap128",
...
b.data.hasOwnProperty("mipmaps")&&d.mipmaps!==b.data.mipmaps&&(d.mipmaps=b.data.mipmaps);b.data.hasOwnProperty("anisotropy")&&d.anisotropy!==b.data.anisotropy&&(d.anisotropy=b.data.anisotropy);var f=!!b.data.rgbm;b.data.hasOwnProperty("rgbm")&&d.rgbm!==f&&(d.rgbm=f)}b.resource.texture=d;var d={},n;for(n in b.data.frames)f=b.data.frames[n],d[n]={rect:new pc.Vec4(f.rect),pivot:new pc.Vec2(f.pivot),border:new pc.Vec4(f.border)};b.resource.frames=d;b.off("change",this._onAssetChange,this);b.on("change",
...
var b=this._parseNodes(a),c=this._parseSkins(a,b),e=this._parseMorphs(a,b),h=this._parseVertexBuffers(a),n=this._parseIndexBuffers(a,h),n=this._parseMeshes(a,c.skins,e.morphs,h,n.buffer,n.data);this._initMorphs(a,e.morphs,h,n);a=this._parseMeshInstances(a,b,n,c.skins,c.instances,e.morphs,e.instances);h=new pc.Model;h.graph=b[0];h.meshInstances=a;h.skinInstances=c.instances;h.morphInstances=e.instances;h.getGraph().syncHierarchy();return h},_parseNodes:function(a){a=a.model;var b=[],c;for(c=0;c<a.nodes.length;c++){var e=
a.nodes[c],h=new pc.GraphNode;h.setName(e.name);h.setLocalPosition(e.position[0],e.position[1],e.position[2]);h.setLocalEulerAngles(e.rotation[0],e.rotation[1],e.rotation[2]);h.setLocalScale(e.scale[0],e.scale[1],e.scale[2]);h.scaleCompensation=!!e.scaleCompensation;b.push(h)}for(c=1;c<a.parents.length;c++)b[a.parents[c]].addChild(b[c]);return b},_parseSkins:function(a,b){var c=a.model,d=[],e=[],n,l;!this._device.supportsBoneTextures&&0<c.skins.length&&(n=this._device.getBoneLimit(),pc.partitionSkin(c,
null,n));for(n=0;n<c.skins.length;n++){var m=c.skins[n],k=[];for(l=0;l<m.inverseBindMatrices.length;l++){var r=m.inverseBindMatrices[l];k[l]=new pc.Mat4(r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15])}m=new pc.Skin(this._device,k,m.boneNames);d.push(m);k=new pc.SkinInstance(m);r=[];for(l=0;l<m.boneNames.length;l++){var p=b[0].findByName(m.boneNames[l]);r.push(p)}k.bones=r;e.push(k)}return{skins:d,instances:e}},_parseMorphs:function(a,b){var c=a.model,d=[],e=
[],n,l,m,k,r;if(c.morphs)for(n=0;n<c.morphs.length;n++){m=c.morphs[n].targets;r=[];for(l=0;l<m.length;l++){var p=m[l].aabb;k=p.min;p=p.max;k=new pc.BoundingBox(new pc.Vec3(.5*(p[0]+k[0]),.5*(p[1]+k[1]),.5*(p[2]+k[2])),new pc.Vec3(.5*(p[0]-k[0]),.5*(p[1]-k[1]),.5*(p[2]-k[2])));k=new pc.MorphTarget({indices:m[l].indices,deltaPositions:m[l].deltaPositions,deltaNormals:m[l].deltaNormals,name:m[l].name,aabb:k});r.push(k)}l=new pc.Morph(r);d.push(l);l=new pc.MorphInstance(l);e.push(l)}return{morphs:d,instances:e}},
_calculateTangentsMorphTarget:function(a,b,e,g,h,n,l,m){var c,d,f,q,t,w,y,x,u,v,A,B,D,z,E,I,G,H,C,F;I=g.length/3;for(F=0;F<I;F++)G=g[3*F],H=g[3*F+1],C=g[3*F+2],y=a[3*G],t=a[3*G+1],w=a[3*G+2],q=a[3*H],x=a[3*H+1],u=a[3*H+2],v=a[3*C],A=a[3*C+1],B=a[3*C+2],D=e[2*G],c=e[2*G+1],z=e[2*H],f=e[2*H+1],E=e[2*C],d=e[2*C+1],q-=y,y=v-y,x-=t,t=A-t,u-=w,w=B-w,z-=D,D=E-D,f-=c,B=d-c,c=z*B-D*f,0==c?(c=0,d=1,f=0,q=1,w=t=0):(E=1/c,c=(B*q-f*y)*E,d=(B*x-f*t)*E,f=(B*u-f*w)*E,q=(z*y-D*q)*E,t=(z*t-D*x)*E,w=(z*w-D*u)*E),h[3*
G+0]+=c,h[3*G+1]+=d,h[3*G+2]+=f,h[3*H+0]+=c,h[3*H+1]+=d,h[3*H+2]+=f,h[3*C+0]+=c,h[3*C+1]+=d,h[3*C+2]+=f,n[3*G+0]+=q,n[3*G+1]+=t,n[3*G+2]+=w,n[3*H+0]+=q,n[3*H+1]+=t,n[3*H+2]+=w,n[3*C+0]+=q,n[3*C+1]+=t,n[3*C+2]+=w;c=l.length;for(C=0;C<c;C++)F=l[C],u=b[3*F],d=b[3*F+1],x=b[3*F+2],a=h[3*F],e=h[3*F+1],g=h[3*F+2],I=n[3*F],G=n[3*F+1],H=n[3*F+2],w=u*a+d*e+x*g,y=u*w,t=d*w,w*=x,q=d*g-e*x,x=x*a-g*u,u=u*e-a*d,a-=y,e-=t,g-=w,w=1/Math.sqrt(a*a+e*e+g*g),a*=w,e*=w,g*=w,m[4*F]=a,m[4*F+1]=e,m[4*F+2]=g,m[4*F+3]=0>q*
I+x*G+u*H?-1:1;return m},_initMorphs:function(a,b,e,g){a=a.model;var c,d,f,m,k,r,p,q,t,w,y,x,u,v,A,B=[],D=[];for(e=0;e<g.length;e++)if(t=a.meshes[e].vertices,!D[t]&&(d=a.vertices[t],d.tangent)){var z=new Float32Array(d.tangent.data);D[t]=!0;if(d.position&&d.normal&&d.texCoord0){var E=[];for(c=0;c<a.meshes.length;c++)a.meshes[c].vertices===t&&(E=E.concat(a.meshes[c].indices));t=d.position.data;w=d.normal.data;y=d.texCoord0.data;x=t.length/3;u=E.length;var I=new Float32Array(4*x),G=new Float32Array(3*
x),H=new Float32Array(3*x);v=new Float32Array(3*x);v.set(t);A=new Float32Array(3*x);A.set(w);for(c=0;c<b.length;c++)if(a.meshes[e].morph===c)for(f=0;f<b[c]._targets.length;f++){d=b[c]._targets[f];var C=d.indices,F=C.length;if(0!==F){d.deltaTangents=new Float32Array(4*F);if(!q||q.length<x)q=new Uint8Array(x);else for(m=0;m<x;m++)q[m]=0;for(m=0;m<F;m++)k=C[m],q[k]=1;var J=0;for(m=0;m<u;m+=3)if(k=E[m],r=E[m+1],p=E[m+2],q[k]||q[r]||q[p])B[J]=k,B[J+1]=r,B[J+2]=p,J+=3;B.length=J;r=d.deltaPositions;p=d.deltaNormals;
for(m=0;m<F;m++)k=C[m],v[3*k]+=r[3*m],v[3*k+1]+=r[3*m+1],v[3*k+2]+=r[3*m+2],A[3*k]+=p[3*m],A[3*k+1]+=p[3*m+1],A[3*k+2]+=p[3*m+2];this._calculateTangentsMorphTarget(v,A,y,B,G,H,C,I);r=d.deltaTangents;for(m=0;m<F;m++)k=C[m],r[4*m]=I[4*m]-z[4*k],r[4*m+1]=I[4*m+1]-z[4*k+1],r[4*m+2]=I[4*m+2]-z[4*k+2],r[4*m+3]=I[4*m+3]-z[4*k+3];if(f!==b[c]._targets.length-1){for(m=0;m<u;m+=3)k=E[m],r=E[m+1],p=E[m+2],G[3*k+0]=0,G[3*k+1]=0,G[3*k+2]=0,G[3*r+0]=0,G[3*r+1]=0,G[3*r+2]=0,G[3*p+0]=0,G[3*p+1]=0,G[3*p+2]=0,H[3*k+
0]=0,H[3*k+1]=0,H[3*k+2]=0,H[3*r+0]=0,H[3*r+1]=0,H[3*r+2]=0,H[3*p+0]=0,H[3*p+1]=0,H[3*p+2]=0;for(m=0;m<F;m++)k=d.indices[m],v[3*k]=t[3*k],v[3*k+1]=t[3*k+1],v[3*k+2]=t[3*k+2],A[3*k]=w[3*k],A[3*k+1]=w[3*k+1],A[3*k+2]=w[3*k+2]}}}}}},_parseVertexBuffers:function(b){b=b.model;var c=[],e,g,h={position:pc.SEMANTIC_POSITION,normal:pc.SEMANTIC_NORMAL,tangent:pc.SEMANTIC_TANGENT,blendWeight:pc.SEMANTIC_BLENDWEIGHT,blendIndices:pc.SEMANTIC_BLENDINDICES,color:pc.SEMANTIC_COLOR,texCoord0:pc.SEMANTIC_TEXCOORD0,
texCoord1:pc.SEMANTIC_TEXCOORD1,texCoord2:pc.SEMANTIC_TEXCOORD2,texCoord3:pc.SEMANTIC_TEXCOORD3,texCoord4:pc.SEMANTIC_TEXCOORD4,texCoord5:pc.SEMANTIC_TEXCOORD5,texCoord6:pc.SEMANTIC_TEXCOORD6,texCoord7:pc.SEMANTIC_TEXCOORD7},n,l;for(n=0;n<b.vertices.length;n++){var m=b.vertices[n];if(!m.tangent&&m.position&&m.normal&&m.texCoord0){e=[];for(l=0;l<b.meshes.length;l++)b.meshes[l].vertices===n&&(e=e.concat(b.meshes[l].indices));e=pc.calculateTangents(m.position.data,m.normal.data,m.texCoord0.data,e);m.tangent=
{type:"float32",components:4,data:e}}l=[];for(g in m){e=m[g];var k=e.type;this._device.supportsUnsignedByte||("uint8"===k&&(k="float32"),"int8"===k&&(k="float32"));l.push({semantic:h[g],components:e.components,type:a[k],normalize:h[g]===pc.SEMANTIC_COLOR})}e=new pc.VertexFormat(this._device,l);var k=m.position.data.length/m.position.components,r=new pc.VertexBuffer(this._device,e,k),p=new pc.VertexIterator(r);for(l=0;l<k;l++){for(g in m)switch(e=m[g],e.components){case 1:p.element[h[g]].set(e.data[l]);
break;case 2:p.element[h[g]].set(e.data[2*l],e.data[2*l+1]);break;case 3:p.element[h[g]].set(e.data[3*l],e.data[3*l+1],e.data[3*l+2]);break;case 4:p.element[h[g]].set(e.data[4*l],e.data[4*l+1],e.data[4*l+2],e.data[4*l+3])}p.next()}p.end();c.push(r)}return c},_parseIndexBuffers:function(a,b){var c=a.model,d=null,e=null,n,l=0;for(n=0;n<c.meshes.length;n++){var m=c.meshes[n];void 0!==m.indices&&(l+=m.indices.length)}for(n=c=0;n<b.length;n++)c=Math.max(c,b[n].numVertices);0<l&&(65535<c&&this._device.extUintElement?
(d=new pc.IndexBuffer(this._device,pc.INDEXFORMAT_UINT32,l),e=new Uint32Array(d.lock())):(d=new pc.IndexBuffer(this._device,pc.INDEXFORMAT_UINT16,l),e=new Uint16Array(d.lock())));return{buffer:d,data:e}},_parseMeshes:function(a,b,f,g,h,n){a=a.model;var c=[],d=0,k;for(k=0;k<a.meshes.length;k++){var r=a.meshes[k],p=r.aabb,q=p.min,p=p.max,q=new pc.BoundingBox(new pc.Vec3(.5*(p[0]+q[0]),.5*(p[1]+q[1]),.5*(p[2]+q[2])),new pc.Vec3(.5*(p[0]-q[0]),.5*(p[1]-q[1]),.5*(p[2]-q[2]))),p=void 0!==r.indices,t=new pc.Mesh;
t.vertexBuffer=g[r.vertices];t.indexBuffer[0]=p?h:null;t.primitive[0].type=e[r.type];t.primitive[0].base=p?r.base+d:r.base;t.primitive[0].count=r.count;t.primitive[0].indexed=p;t.skin=void 0!==r.skin?b[r.skin]:null;t.morph=void 0!==r.morph?f[r.morph]:null;t.aabb=q;p&&(n.set(r.indices,d),d+=r.indices.length);c.push(t)}null!==h&&h.unlock();return c},_parseMeshInstances:function(a,b,e,g,h,n,l){a=a.model;var c=[],d;for(d=0;d<a.meshInstances.length;d++){var f=a.meshInstances[d],p=e[f.mesh],f=new pc.MeshInstance(b[f.node],
p,pc.ModelHandler.DEFAULT_MATERIAL);if(p.skin){var q=g.indexOf(p.skin);f.skinInstance=h[q]}p.morph&&(p=n.indexOf(p.morph),f.morphInstance=l[p]);c.push(f)}return c}};return{JsonModelParser:b}}());pc.extend(pc,function(){var e=function(a){this._app=a};e.prototype={parse:function(a){var b={},c,d,e=null;for(c in a.entities)b[c]=this._createEntity(a.entities[c]),null===a.entities[c].parent&&(e=b[c]);for(c in a.entities){var g=a.entities[c].children.length;for(d=0;d<g;d++){var h=a.entities[c].children[d];b[h]&&b[c].addChild(b[h])}}this._openComponentData(e,a.entities);return e},_createEntity:function(a){var b=new pc.Entity,c=a.position,d=a.rotation,e=a.scale;b.name=a.name;b._guid=a.resource_id;
...
d,function(b,c){a.data=d;h(a)})})):h(a)},_loadMaterials:function(a,b,c){var d=this,e,g=b.mapping.length,h=[],n=function(a,b){d._loadTextures(b,function(a,d){c(null,b)})};0===g&&c(null,h);var l=function(a,b){h.push(b);g--;0===g&&n(null,h)};for(e=0;e<b.mapping.length;e++){var m=b.mapping[e].path;m?d.loadFromUrl(pc.path.join(a,m),"material",l):g--}},_loadTextures:function(a,b){var c,d,e={},g=[],h=[],n=0;for(c=0;c<a.length;c++)if(a[c].data.parameters){var l=a[c].data.parameters;for(d=0;d<l.length;d++)if("texture"===
l[d].type){var m=a[c].getFileUrl(),m=pc.path.getDirectory(m),m=pc.path.join(m,l[d].data);e[m]||(e[m]=!0,g.push(m),n++)}}else console.warn("Update material asset loader to support new material format");if(n)for(d=function(a,c){h.push(c);n--;a&&console.error(a);0===n&&b(null,h)},c=0;c<g.length;c++)this.loadFromUrl(g[c],"texture",d);else b(null,h)},findAll:function(a,b){var c=this,d=this._names[a];return d?(d=d.map(function(a){return c._assets[a]}),b?d.filter(function(a){return a.type===b}):d):[]},_onTagAdd:function(a,
...
c,d)}}var a=[],b=[],c,d=new pc.Vec3,f=new pc.BoundingBox,g=new pc.BoundingBox,h={},n=["texture_lightMap","texture_dirLightMap"],l=[],m=function(a,b,c,d,e){this.device=a;this.root=b;this.scene=c;this.renderer=d;this.assets=e};m.prototype={calculateLightmapSize:function(a){var b,c=this.scene.lightmapSizeMultiplier||16,e=1,f=1,g=1,h=1;a.model.asset?(b=this.assets.get(a.model.asset).data,b.area&&(e=b.area.x,f=b.area.y,g=b.area.z,h=b.area.uv)):a.model._area&&(b=a.model,b._area&&(e=b._area.x,f=b._area.y,
g=b._area.z,h=b._area.uv));b=a.model.lightmapSizeMultiplier||1;e*=b;f*=b;g*=b;d.copy(a.localScale);for(a=a._parent;a;)d.mul(a.localScale),a=a._parent;d.x=Math.abs(d.x);d.y=Math.abs(d.y);d.z=Math.abs(d.z);e=e*d.y*d.z+f*d.x*d.z+g*d.x*d.y;e=Math.sqrt(e/h);return Math.min(pc.math.nextPowerOfTwo(e*c),this.scene.lightmapMaxResolution||2048)},bake:function(k,m){var p,q,r=this.device,w=this.scene,y=1;void 0===m&&(m=pc.BAKE_COLORDIR);m===pc.BAKE_COLORDIR&&(y=2);var x,u=[],v=[];if(k){var A;for(p=b.length-1;0<=
p;p--)for(q=0;q<k.length;q++)if(b[p]===k[q]){for(A=0;A<a[p].length;A++)a[p][A].destroy();a.splice(p,1);b.splice(p,1)}A=[];for(p=0;p<k.length;p++)e(k[p],A,v);k=A;e(this.root,null,null,u)}else{for(p=0;p<a.length;p++)for(q=0;q<a[p].length;q++)a[p][q].destroy();a=[];b=[];k=[];e(this.root,k,v,u)}if(0===k.length)r.fire("lightmapper:end",{timestamp:pc.now(),target:this});else{A=!1;w._needsStaticPrepare&&(w._needsStaticPrepare=!1,A=!0);var B=[],D=[[],[]],z={},E,I;q=new pc.Texture(this.device,{width:4,height:4,
format:pc.PIXELFORMAT_R8_G8_B8_A8,rgbm:!0});for(p=0;p<k.length;p++){E=this.calculateLightmapSize(k[p]);B.push(E);for(x=0;x<y;x++)I=new pc.Texture(r,{width:E,height:E,format:pc.PIXELFORMAT_R8_G8_B8_A8,mipmaps:!1,rgbm:0===x,minFilter:pc.FILTER_NEAREST,magFilter:pc.FILTER_NEAREST}),D[x].push(I);if(!z[E]){var G=new pc.Texture(r,{width:E,height:E,format:pc.PIXELFORMAT_R8_G8_B8_A8,mipmaps:!1,rgbm:!0,minFilter:pc.FILTER_NEAREST,magFilter:pc.FILTER_NEAREST}),G=new pc.RenderTarget(r,G,{depth:!1});z[E]=G}}var H=
w.layers;H._update();B=[];E=[];var G=[],C=[],F=H._lights;for(p=0;p<F.length;p++)F[p]._enabled&&(I=F[p]._mask,0!==(I&4)&&(E.push(I),G.push(F[p].shadowUpdateMode),F[p]._mask=4294967295,F[p].shadowUpdateMode=F[p]._type===pc.LIGHTTYPE_DIRECTIONAL?pc.SHADOWUPDATE_REALTIME:pc.SHADOWUPDATE_THISFRAME,B.push(F[p]),F[p].isStatic=!1)),C.push(F[p]._enabled),F[p].enabled=!1;var J=pc.shaderChunks,Y="#define UV1LAYOUT\n"+J.transformVS,X=J.bakeLmEndPS;I=J.createShaderFromCode(r,J.fullscreenQuadVS,J.dilatePS,"lmDilate");
var V=r.scope.resolve("source"),Q=r.scope.resolve("pixelOffset"),L=r.scope.resolve("bakeDir"),Z=new pc.Vec2,H=H._meshInstances;for(p=0;p<H.length;p++)H[p].node&&H[p].node.getWorldTransform();var H=w.fog,S=w.ambientLight.data[0],R=w.ambientLight.data[1],aa=w.ambientLight.data[2];w.fog=pc.FOG_NONE;w.ambientLight.data[0]=0;w.ambientLight.data[1]=0;w.ambientLight.data[2]=0;c||(c=new pc.Camera,c._node=new pc.GraphNode,c.clearColor[0]=0,c.clearColor[1]=0,c.clearColor[2]=0,c.clearColor[3]=0,c.clearDepth=
...
u[K].model.meshInstances,p=0;p<M.length;p++)M[p].visibleThisFrame=!0,U.push(M[p]);this.renderer.updateCpuSkinMatrices(U);this.renderer.gpuUpdate(U);var fa=[],ga=[];M=[[],[]];var ca,da,ea,ka=[];ka.length=k.length;for(x=0;x<y;x++)l[x]||(p=new pc.StandardMaterial,p.chunks.transformVS=Y,0===x?(p.chunks.endPS=X,p.ambient=new pc.Color(0,0,0),p.ambientTint=!0,p.lightMap=q):(p.chunks.basePS=J.basePS+"\nuniform sampler2D texture_dirLightMap;\nuniform float bakeDir;\n",p.chunks.endPS=J.bakeDirLmEndPS),p.chunks.outputAlphaPS=
"\n",p.chunks.outputAlphaOpaquePS="\n",p.chunks.outputAlphaPremulPS="\n",p.cull=pc.CULLFACE_NONE,p.forceUv1=!0,p.update(),p.updateShader(r,w),p.name="lmMaterial"+x,l[x]=p);for(K=0;K<k.length;K++){N=v[K];ka[K]=0;if(0<N.length)for(f.copy(N[0].aabb),p=0;p<N.length;p++)N[p].node.getWorldTransform(),f.add(N[p].aabb);p=new pc.BoundingBox;p.copy(f);ga.push(p);for(p=0;p<N.length;p++)P=N[p],P._shaderDefs&=~(pc.SHADERDEF_LM|pc.SHADERDEF_DIRLM),P.mask=4,P.deleteParameter("texture_lightMap"),P.deleteParameter("texture_dirLightMap"),
P.setParameter("texture_lightMap",P.material.lightMap?P.material.lightMap:q),P.setParameter("texture_dirLightMap",q);for(x=0;x<y;x++)T=D[x][K],ca=new pc.RenderTarget(r,T,{depth:!1}),M[x].push(ca)}for(q=0;q<B.length;q++)B[q].enabled=!1;J=[[],[],[]];Y=!1;for(p=0;p<B.length;p++){B[p].enabled=!0;X=!1;B[p]._cacheShadowMap=!0;B[p]._type!==pc.LIGHTTYPE_DIRECTIONAL&&(B[p]._node.getWorldTransform(),B[p].getBoundingSphere(h),g.center=h.center,g.halfExtents.x=h.radius,g.halfExtents.y=h.radius,g.halfExtents.z=
...
d.y+=f.halfExtents.y,c._node.setPosition(d),c._node.setEulerAngles(-90,0,0),q=Math.max(f.halfExtents.x,f.halfExtents.z),c.projection=pc.PROJECTION_ORTHOGRAPHIC,c.nearClip=0,c.farClip=2*f.halfExtents.y,c.aspectRatio=1,c.orthoHeight=q;else if(!g.intersects(f))continue;if(B[p]._type===pc.LIGHTTYPE_SPOT){x=!1;for(q=0;q<N.length;q++)if(this.renderer._isVisible(ea,N[q])){x=!0;break}if(!x)continue}B[p]._type===pc.LIGHTTYPE_DIRECTIONAL?(J[pc.LIGHTTYPE_DIRECTIONAL][0]=B[p],J[pc.LIGHTTYPE_POINT].length=0,J[pc.LIGHTTYPE_SPOT].length=
...
U),this.renderer.renderShadows(J[pc.LIGHTTYPE_SPOT]),X=!0)));for(q=0;q<N.length;q++)fa[q]=N[q].material;for(x=0;x<y;x++){T=D[x][K];ca=M[x][K];P=z[T.width];da=P.colorBuffer;0===x?Y=w.updateShaders:Y&&(w.updateShaders=!0);for(q=0;q<N.length;q++)N[q].material=l[x];1<y&&this.renderer.updateShaders(N);this.renderer.setCamera(c,P,!0);1===x&&L.setValue(B[p].bakeDir?1:0);this.renderer._forwardTime=0;this.renderer._shadowMapTime=0;this.renderer.renderForward(c,N,N.length,J,pc.SHADER_FORWARDHDR);D[x][K]=da;
M[x][K]=P;z[T.width]=ca;for(q=0;q<N.length;q++)P=N[q],P.setParameter(n[x],da),P._shaderDefs|=pc.SHADERDEF_LM}ka[K]++;for(q=0;q<N.length;q++)N[q].material=fa[q]}B[p].enabled=!1;B[p]._cacheShadowMap=!1;B[p]._isCachedShadowMap&&B[p]._destroyShadowMap()}for(K=0;K<k.length;K++){N=v[K];ea=[];for(x=0;x<y;x++){T=D[x][K];ca=M[x][K];P=z[T.width];da=P.colorBuffer;Z.set(1/T.width,1/T.height);Q.setValue(Z.data);for(p=0;4>p;p++)V.setValue(T),pc.drawQuadWithShader(r,P,I),V.setValue(da),pc.drawQuadWithShader(r,ca,
I);for(p=0;p<N.length;p++)P=N[p],P.mask=2,N[p].setParameter(n[x],T),1===x&&(N[p]._shaderDefs|=pc.SHADERDEF_DIRLM);ea[x]=T;x===y-1&&ca.destroy()}a.push(ea);b.push(k[K])}for(var ha in z)z.hasOwnProperty(ha)&&(z[ha].colorBuffer.destroy(),z[ha].destroy());for(p=0;p<a.length;p++)for(q=0;q<a[p].length;q++)I=a[p][q],I.minFilter=pc.FILTER_LINEAR,I.magFilter=pc.FILTER_LINEAR;for(K=0;K<u.length;K++)u[K].model.castShadows=O[K];for(p=0;p<ba.length;p++)if(ba[p])for(N=b[p].model.model.meshInstances,q=0;q<N.length;q++)N[q]._shaderDefs|=
ba[p][q]&(pc.SHADERDEF_LM|pc.SHADERDEF_DIRLM);for(p=0;p<B.length;p++)B[p]._mask=E[p],B[p].shadowUpdateMode=G[p];for(p=0;p<F.length;p++)F[p].enabled=C[p];w.fog=H;w.ambientLight.data[0]=S;w.ambientLight.data[1]=R;w.ambientLight.data[2]=aa;A&&(w._needsStaticPrepare=!0)}}};return{Lightmapper:m}}());pc.extend(pc,function(){function e(a,b){if(a&&!b||!a&&b)return!1;a=a.data;b=b.data;if(a===b)return!0;if(a instanceof Float32Array&&b instanceof Float32Array){if(a.length!==b.length)return!1;for(var c=0;c<a.length;c++)if(a[c]!==b[c])return!1;return!0}return!1}var a=function(a,b,e){this.device=a;this.rootNode=e;this._dirty=!0;this.bones=b;b=b.length;a.supportsBoneTextures?(b=256<b?64:64<b?32:16<b?16:8,this.boneTexture=new pc.Texture(a,{width:b,height:b,format:pc.PIXELFORMAT_RGBA32F,mipmaps:!1,minFilter:pc.FILTER_NEAREST,
...
e,a);if(a===this._dirtyGroups)this._dirtyGroups.length=0;else{c=[];for(b=0;b<this._dirtyGroups.length;b++)0>a.indexOf(this._dirtyGroups[b])&&c.push(this._dirtyGroups[b]);this._dirtyGroups=c}}else{for(b=0;b<this._batchList.length;b++)this.destroy(this._batchList[b]);this._batchList.length=0;this._collectAndRemoveModels(this.rootNode,e);this._dirtyGroups.length=0}var h,n,l;for(l in e)if(e.hasOwnProperty(l)&&(b=e[l],a=this._batchGroups[l]))for(h=this.prepare(b,a.dynamic,a.maxAabbSize),b=0;b<h.length;b++){n=
this.create(h[b],a.dynamic,parseInt(l,10));for(c=0;c<a.layers.length;c++)this.scene.layers.getLayerById(a.layers[c]).addMeshInstances(n.model.meshInstances);this._registerEntities(n,h[b])}};b.prototype.getGroupByName=function(a){var b=this._batchGroups,c;for(c in b)if(b.hasOwnProperty(c)&&b[c].name===a)return b[c];return null};b.prototype.prepare=function(a,b,f){if(0===a.length)return[];void 0===f&&(f=Number.POSITIVE_INFINITY);f*=.5;for(var c=this.device.supportsBoneTextures?1024:this.device.boneLimit,
d,n,l,m,k,r,p,q,t,w=new pc.BoundingBox,y=new pc.BoundingBox,x=[],u=0,v=a,A,B;0<v.length;){x[u]=[];A=[];d=v[0].material;n=v[0].layer;t=v[0]._shaderDefs;m=v[0].parameters;q=v[0]._staticLightList;l=v[0].mesh.vertexBuffer.getNumVertices();w.copy(v[0].aabb);for(a=0;a<v.length;a++){if(0<a){if(d!==v[a].material){A.push(v[a]);continue}if(n!==v[a].layer){A.push(v[a]);continue}if(t!==v[a]._shaderDefs){A.push(v[a]);continue}if(65535<l+v[a].mesh.vertexBuffer.getNumVertices()){A.push(v[a]);continue}y.copy(w);
y.add(v[a].aabb);if(y.halfExtents.x>f||y.halfExtents.y>f||y.halfExtents.z>f){A.push(v[a]);continue}k=v[a].parameters;p=!1;for(r in m)if(m.hasOwnProperty(r)&&!e(m[r],k[r])){p=!0;break}if(!p)for(r in k)if(k.hasOwnProperty(r)&&!e(k[r],m[r])){p=!0;break}if(p){A.push(v[a]);continue}k=v[a]._staticLightList;if(q&&!k||!q&&k){A.push(v[a]);continue}if(q&&k){p=!1;for(B=0;B<q.length;B++)if(0>k.indexOf(q[B])){p=!0;break}for(B=0;B<k.length;B++)if(0>q.indexOf(k[B])){p=!0;break}if(p){A.push(v[a]);continue}}}w.add(v[a].aabb);
l+=v[a].mesh.vertexBuffer.getNumVertices();x[u].push(v[a]);if(b&&x[u].length===c){A=a===v.length?[]:v.slice(a+1);break}}u++;v=A}return x};b.prototype.create=function(b,d,e){this._init||(this.transformVS="#define BONE_LIMIT "+this.device.getBoneLimit()+"\n#define DYNAMICBATCH\n"+pc.shaderChunks.transformVS,this.skinTexVS=pc.shaderChunks.skinBatchTexVS,this.skinConstVS=pc.shaderChunks.skinBatchConstVS,this.vertexFormats={},this._init=!0);var c,f;e=new pc.Batch(b,d,e);this._batchList.push(e);var n=null,
l,m,k,r,p,q,t,w,y,x=0,u=0;for(c=0;c<b.length;c++){if(!n)n=b[c].material;else if(n!==b[c].material)return;l=b[c].mesh;m=l.vertexBuffer.format.elements;k=l.vertexBuffer.numVertices;x+=k;for(f=0;f<m.length;f++)m[f].name===pc.SEMANTIC_POSITION?r=!0:m[f].name===pc.SEMANTIC_NORMAL?p=!0:m[f].name===pc.SEMANTIC_TEXCOORD0?q=!0:m[f].name===pc.SEMANTIC_TEXCOORD1?t=!0:m[f].name===pc.SEMANTIC_TANGENT?w=!0:m[f].name===pc.SEMANTIC_COLOR&&(y=!0);u+=l.primitive[0].count}if(r){var v=3+(p?3:0)+(q?2:0)+(t?2:0)+(w?4:
0)+(y?1:0)+(d?1:0),A=p?6:3,B=(p?6:3)+(q?2:0),D=(p?6:3)+(q?2:0)+(t?2:0),z=(p?6:3)+(q?2:0)+(t?2:0)+(w?4:0),E=(p?6:3)+(q?2:0)+(t?2:0)+(w?4:0)+(y?1:0),I=new ArrayBuffer(x*v*4);r=new Float32Array(I);var G=new Uint8Array(I),I=new pc.IndexBuffer(this.device,pc.INDEXFORMAT_UINT16,u,pc.BUFFER_STATIC),H=new Uint16Array(I.lock()),C,F,J,Y=0,X=0;J=0;var V,Q,L,Z,S,R,aa,K,T;d||(K=new pc.Vec3,T=K.data);for(c=0;c<b.length;c++){l=b[c].mesh;m=l.vertexBuffer.format.elements;k=l.vertexBuffer.numVertices;f=l.vertexBuffer.format.size;
C=f/4;for(f=0;f<m.length;f++)m[f].name===pc.SEMANTIC_POSITION?V=m[f].offset/4:m[f].name===pc.SEMANTIC_NORMAL?Q=m[f].offset/4:m[f].name===pc.SEMANTIC_TEXCOORD0?L=m[f].offset/4:m[f].name===pc.SEMANTIC_TEXCOORD1?Z=m[f].offset/4:m[f].name===pc.SEMANTIC_TANGENT?S=m[f].offset/4:m[f].name===pc.SEMANTIC_COLOR&&(R=m[f].offset/4);m=new Float32Array(l.vertexBuffer.storage);F=new Uint8Array(l.vertexBuffer.storage);if(d)for(f=0;f<k;f++)r[f*v+J]=m[f*C+V],r[f*v+J+1]=m[f*C+V+1],r[f*v+J+2]=m[f*C+V+2],p&&(r[f*v+J+
3]=m[f*C+Q],r[f*v+J+3+1]=m[f*C+Q+1],r[f*v+J+3+2]=m[f*C+Q+2]),q&&(r[f*v+J+A]=m[f*C+L],r[f*v+J+A+1]=m[f*C+L+1]),t&&(r[f*v+J+B]=m[f*C+Z],r[f*v+J+B+1]=m[f*C+Z+1]),w&&(r[f*v+J+D]=m[f*C+S],r[f*v+J+D+1]=m[f*C+S+1],r[f*v+J+D+2]=m[f*C+S+2],r[f*v+J+D+3]=m[f*C+S+3]),y&&(G[f*v*4+4*J+4*z]=F[f*C*4+4*R],G[f*v*4+4*J+4*z+1]=F[f*C*4+4*R+1],G[f*v*4+4*J+4*z+2]=F[f*C*4+4*R+2],G[f*v*4+4*J+4*z+3]=F[f*C*4+4*R+3]),r[f*v+E+J]=c;else for(aa=b[c].node.getWorldTransform(),f=0;f<k;f++)K.set(m[f*C+V],m[f*C+V+1],m[f*C+V+2]),aa.transformPoint(K,
K),r[f*v+J]=T[0],r[f*v+J+1]=T[1],r[f*v+J+2]=T[2],p&&(K.set(m[f*C+Q],m[f*C+Q+1],m[f*C+Q+2]),aa.transformVector(K,K),r[f*v+J+3]=T[0],r[f*v+J+3+1]=T[1],r[f*v+J+3+2]=T[2]),q&&(r[f*v+J+A]=m[f*C+L],r[f*v+J+A+1]=m[f*C+L+1]),t&&(r[f*v+J+B]=m[f*C+Z],r[f*v+J+B+1]=m[f*C+Z+1]),w&&(K.set(m[f*C+S],m[f*C+S+1],m[f*C+S+2]),aa.transformVector(K,K),r[f*v+J+D]=T[0],r[f*v+J+D+1]=T[1],r[f*v+J+D+2]=T[2],r[f*v+J+D+3]=m[f*C+S+3]),y&&(G[f*v*4+4*J+4*z]=F[f*C*4+4*R],G[f*v*4+4*J+4*z+1]=F[f*C*4+4*R+1],G[f*v*4+4*J+4*z+2]=F[f*C*
4+4*R+2],G[f*v*4+4*J+4*z+3]=F[f*C*4+4*R+3]);J=l.primitive[0].base;C=l.primitive[0].count;l=new Uint16Array(l.indexBuffer[0].storage);for(f=0;f<C;f++)H[f+X]=l[J+f]+Y;X+=C;Y+=k;J=Y*v}b=0;p&&(b|=2);q&&(b|=4);t&&(b|=8);w&&(b|=16);y&&(b|=32);d&&(b|=64);c=this.vertexFormats[b];c||(c=[],c.push({semantic:pc.SEMANTIC_POSITION,components:3,type:pc.ELEMENTTYPE_FLOAT32,normalize:!1}),p&&c.push({semantic:pc.SEMANTIC_NORMAL,components:3,type:pc.ELEMENTTYPE_FLOAT32,normalize:!1}),q&&c.push({semantic:pc.SEMANTIC_TEXCOORD0,
...
p=new pc.VertexBuffer(this.device,c,x,pc.BUFFER_STATIC,r.buffer);I.unlock();l=new pc.Mesh;l.vertexBuffer=p;l.indexBuffer[0]=I;l.primitive[0].type=e.origMeshInstances[0].mesh.primitive[0].type;l.primitive[0].base=0;l.primitive[0].count=u;l.primitive[0].indexed=!0;l.cull=!1;d&&(n=n.clone(),n.chunks.transformVS=this.transformVS,n.chunks.skinTexVS=this.skinTexVS,n.chunks.skinConstVS=this.skinConstVS,n.update());n=new pc.MeshInstance(this.rootNode,l,n);n.castShadow=e.origMeshInstances[0].castShadow;n.parameters=
e.origMeshInstances[0].parameters;n.isStatic=e.origMeshInstances[0].isStatic;n.cull=e.origMeshInstances[0].cull;n.layer=e.origMeshInstances[0].layer;n._staticLightList=e.origMeshInstances[0]._staticLightList;n._shaderDefs=e.origMeshInstances[0]._shaderDefs;if(d){d=[];for(c=0;c<e.origMeshInstances.length;c++)d.push(e.origMeshInstances[c].node);n.skinInstance=new a(this.device,d,this.rootNode)}n._updateAabb=!1;e.meshInstance=n;this.update(e);d=new pc.Model;d.meshInstances=[e.meshInstance];d.castShadows=
